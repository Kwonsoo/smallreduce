...
#line 281
  if ((unsigned long )ecasound_exec != (unsigned long )((void *)0)) {
    {
#line 281
    tmp___7 = pipe(cmd_receive_pipe);
    }
#line 281
    if (tmp___7 == 0) {
      {
#line 281
      tmp___8 = pipe(cmd_send_pipe);
      }
#line 281
      if (tmp___8 == 0) {
        {
...
#line 352
          sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_handler)),
                    (struct sigaction */* __restrict  */)((struct sigaction *)0));
#line 353
          sigaction(8, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_handler)),
                    (struct sigaction */* __restrict  */)((struct sigaction *)0));
#line 355
...
#line 537
  ...
  {
#line 543
  memcpy((void */* __restrict  */)((void *)(eci_rep->last_command_repp)), (void const   */* __restrict  */)((void const   *)command),
         (size_t )64);
#line 545
  eci_impl_clean_last_values(eci_rep->parser_repp);
#line 547
...
#line 864
  ...
  {
#line 866
  memcpy((void */* __restrict  */)((void *)(dst->d + at)), (void const   */* __restrict  */)((void const   *)src),
         (size_t )len);
#line 867
  *(dst->d + (at + len)) = (char)0;
  }
...
#line 1233
    len = tmp;
#line 1235
    memcpy((void */* __restrict  */)((void *)(parser->last_type_repp)), (void const   */* __restrict  */)((void const   *)parser->buffer_rep.d),
           (size_t )len);
#line 1236
...
#line 376
  tmp___0 = getenv("HOME");
#line 376
  strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)tmp___0),
          (size_t )4096);
#line 377
...
#line 377
  strncat((char */* __restrict  */)path, (char const   */* __restrict  */)"/.ecasound",
          (4096U - tmp___1) - 1U);
#line 380
  tmp___2 = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& statbuf));
  }
#line 380
  if (tmp___2 != 0) {
    {
...
#line 423
  ...
  {
#line 426
  f1 = fopen((char const   */* __restrict  */)((char const   *)path), (char const   */* __restrict  */)"rb");
  }
#line 427
...
#line 669
  path = get_playlist_path();
#line 672
  f1 = fopen((char const   */* __restrict  */)((char const   *)path), (char const   */* __restrict  */)"a+b");
  }
#line 673
  if ((unsigned long )f1 != (unsigned long )((void *)0)) {
#line 674
...
#line 685
            strcat((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)*(argv + i)));
#line 686
...
#line 687
            fwrite((void const   */* __restrict  */)((void const   *)tmp), (size_t )1,
                   tmp___2, (FILE */* __restrict  */)f1);
            }
          }
          {
#line 689
...
#line 693
          fwrite((void const   */* __restrict  */)((void const   *)*(argv + i)), (size_t )1,
                 tmp___4, (FILE */* __restrict  */)f1);
          }
        }
        {
#line 695
        fwrite((void const   */* __restrict  */)((void const   *)"\n"), (size_t )1,
...
#line 744
  ign_handler.sa_flags = 0;
#line 747
  sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& es_handler_int)),
            (struct sigaction */* __restrict  */)((struct sigaction *)0));
#line 750
  sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_handler)),
            (struct sigaction */* __restrict  */)((struct sigaction *)0));
