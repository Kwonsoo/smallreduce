...
#line 122
  *tmp = 0;
#line 123
  l = strtol((char const   */* __restrict  */)((char const   *)sz), (char **/* __restrict  */)(& endp),
             10);
#line 125
...
#line 145
      res = (char *)tmp___1;
#line 146
      strcpy((char */* __restrict  */)res, (char const   */* __restrict  */)((char const   *)l));
#line 147
      strcpy((char */* __restrict  */)(res + len_l), (char const   */* __restrict  */)((char const   *)(r + 1)));
      }
    } else {
      {
#line 149
...
#line 150
      strcpy((char */* __restrict  */)res, (char const   */* __restrict  */)((char const   *)l));
#line 151
      strcpy((char */* __restrict  */)(res + len_l), (char const   */* __restrict  */)((char const   *)r));
      }
    }
  } else
#line 154
...
#line 161
    *(res + len_l) = (char )'/';
#line 162
    strcpy((char */* __restrict  */)((res + len_l) + 1), (char const   */* __restrict  */)((char const   *)r));
    }
  }
#line 165
  return (res);
...
#line 191
        p1 = (char *)tmp___3;
#line 192
        strncpy((char */* __restrict  */)p1, (char const   */* __restrict  */)((char const   *)(sz + 1)),
                (size_t )((p - sz) - 1L));
#line 193
        *(p1 + ((p - sz) - 1L)) = (char )'\000';
#line 194
...
#line 198
        p1 = (char *)tmp___6;
#line 199
        strcpy((char */* __restrict  */)p1, (char const   */* __restrict  */)((char const   *)(sz + 1)));
#line 200
        entry = getpwnam((char const   *)p1);
#line 201
        free((void *)p1);
...
#line 206
    tmp___9 = strcpy((char */* __restrict  */)((char *)tmp___8), (char const   */* __restrict  */)((char const   *)sz));
    }
#line 206
    return (tmp___9);
  }
...
#line 45
  tmp = select(1024, (fd_set */* __restrict  */)(& set), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 62
  ...
  {
#line 77
  out_stat = getsockopt(s, 1, 4, (void */* __restrict  */)((void *)(& err)), (socklen_t */* __restrict  */)((socklen_t *)(& err_size)));
  }
#line 77
  if (out_stat == -1) {
    {
...
#line 111
    tmp = recvfrom(s, (void */* __restrict  */)((void *)buf), (size_t )len, 0, (struct sockaddr */* __restrict  */)from,
                   (socklen_t */* __restrict  */)((socklen_t *)(& size_from)));
#line 111
    in_stat = (int )tmp;
    }
#line 111
...
#line 82
    strcpy((char */* __restrict  */)(last_mesg), (char const   */* __restrict  */)((char const   *)(rmesg)));
#line 83
    bzero((void *)(rmesg), (size_t )64);
#line 86
    tmp = recvfrom(0, (void */* __restrict  */)((void *)(rmesg)), (size_t )63, 0,
                   (struct sockaddr */* __restrict  */)((struct sockaddr *)(& from)),
                   (socklen_t */* __restrict  */)((socklen_t *)(& size)));
    }
#line 86
    if (tmp == -1L) {
#line 92
...
#line 151
    bzero((void *)(rmesg), (size_t )64);
#line 154
    tmp___0 = recvfrom(sock, (void */* __restrict  */)((void *)(rmesg)), (size_t )63,
                       0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& from)),
                       (socklen_t */* __restrict  */)((socklen_t *)(& from_size)));
    }
#line 154
    if (tmp___0 == -1L) {
#line 160
...
#line 206
    strcpy((char */* __restrict  */)(ifr.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)interface));
#line 208
...
#line 260
    optind ++;
#line 260
    strncpy((char */* __restrict  */)(hname), (char const   */* __restrict  */)((char const   *)*(argv + tmp___1)),
            (size_t )63);
    }
  }
#line 262
...
#line 34
    aux = (char *)tmp___0;
#line 35
    strcpy((char */* __restrict  */)aux, (char const   */* __restrict  */)((char const   *)s));
#line 37
...
#line 50
        ...
        {
#line 51
        *(pp + n) = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" \t");
#line 50
        n ++;
        }
      }
...
#line 130
  ungetc(c, stdin);
#line 133
  strcpy((char */* __restrict  */)(buffer1), (char const   */* __restrict  */)((char const   *)buffer));
#line 136
...
#line 148
    strcpy((char */* __restrict  */)(buffer1), (char const   */* __restrict  */)((char const   *)p));
#line 149
...
#line 202
    ...
    {
#line 198
    s3 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" \t");
    }
#line 198
...
#line 233
  ...
  {
#line 240
  fp2 = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"w");
  }
#line 240
...
#line 244
    ...
    {
#line 245
    fputs((char const   */* __restrict  */)((char const   *)(buf)), (FILE */* __restrict  */)fp2);
#line 242
    tmp = feof(fp1);
    }
#line 242
...
#line 460
        *path = (char )'\000';
#line 461
        tmp___2 = strcat((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)home));
#line 461
...
#line 467
    path1 = (char *)tmp___5;
#line 468
    strcpy((char */* __restrict  */)path1, (char const   */* __restrict  */)((char const   *)path));
#line 469
    *(path1 + path_len) = (char )'/';
#line 470
...
#line 478
      ext1 = (char *)tmp___7;
#line 479
      strcpy((char */* __restrict  */)(ext1 + 1), (char const   */* __restrict  */)((char const   *)ext));
#line 480
      *ext1 = (char )'.';
#line 481
      ext = ext1;
...
#line 493
  if (ext_len == 0) {
    {
#line 494
    tmp___12 = strcat((char */* __restrict  */)in_file, (char const   */* __restrict  */)((char const   *)path));
#line 494
    strcat((char */* __restrict  */)tmp___12, (char const   */* __restrict  */)((char const   *)host));
    }
  } else {
    {
#line 495
    tmp___13 = strcat((char */* __restrict  */)in_file, (char const   */* __restrict  */)((char const   *)path));
#line 495
    tmp___14 = strcat((char */* __restrict  */)tmp___13, (char const   */* __restrict  */)((char const   *)host));
#line 495
    strcat((char */* __restrict  */)tmp___14, (char const   */* __restrict  */)((char const   *)ext));
    }
  }
  {
#line 497
...
#line 498
  free((void *)in_file);
#line 500
  tmp___17 = freopen((char const   */* __restrict  */)((char const   *)exp_in_file),
