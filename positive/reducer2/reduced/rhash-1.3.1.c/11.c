...
#line 278
    ...
    {
#line 278
    memcpy((void */* __restrict  */)((void *)((char *)(ctx->message) + index___0)),
           (void const   */* __restrict  */)((void const   *)msg), tmp);
    }
#line 279
    if (size < (size_t )left) {
#line 279
...
#line 291
      ...
      {
#line 293
      memcpy((void */* __restrict  */)((void *)(ctx->message + 0)), (void const   */* __restrict  */)((void const   *)msg),
             (size_t )64);
#line 294
...
#line 338
  rhash_ripemd160_process_block(ctx->hash, (unsigned int const   *)(ctx->message));
#line 340
  memcpy((void */* __restrict  */)((void *)(result + 0)), (void const   */* __restrict  */)((void const   *)(& ctx->hash)),
         (size_t )20);
  }
#line 341
  return;
...
#line 228
      ...
      {
#line 230
      memcpy((void */* __restrict  */)((void *)(ctx->message)), (void const   */* __restrict  */)((void const   *)msg),
             (size_t )64);
#line 231
      aligned_message_block = ctx->message;
      }
...
#line 232
    res = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& st));
#line 233
    free((void *)path);
    }
#line 238
...
#line 313
  tmp_file = (char *)tmp;
#line 314
  memcpy((void */* __restrict  */)((void *)tmp_file), (void const   */* __restrict  */)((void const   *)hash_file_path),
         len);
#line 315
  strcpy((char */* __restrict  */)(tmp_file + len), (char const   */* __restrict  */)".new");
#line 318
  out = fopen((char const   */* __restrict  */)((char const   *)tmp_file), (char const   */* __restrict  */)"w");
  }
#line 318
  if (! out) {
    {
...
#line 327
    if ((int )line[0] == 59) {
      {
#line 328
      tmp___0 = fputs((char const   */* __restrict  */)((char const   *)(line)), (FILE */* __restrict  */)out);
      }
#line 328
      if (tmp___0 < 0) {
#line 328
...
#line 335
        if ((int )line[0] != 59) {
          {
#line 336
          tmp___2 = fputs((char const   */* __restrict  */)((char const   *)(line)),
                          (FILE */* __restrict  */)out);
          }
#line 336
          if (tmp___2 < 0) {
...
#line 47
  ...
  {
#line 49
  memcpy((void */* __restrict  */)((void *)dst), (void const   */* __restrict  */)((void const   *)(p + 1)),
         len + 1UL);
  }
#line 50
  return;
...
#line 175
  res = (char *)tmp___1;
#line 178
  memcpy((void */* __restrict  */)((void *)res), (void const   */* __restrict  */)((void const   *)orig),
         len1);
#line 179
  memcpy((void */* __restrict  */)((void *)(res + len1)), (void const   */* __restrict  */)((void const   *)append),
         len2 + 1UL);
  }
#line 180
  return (res);
...
#line 254
    res = (char *)tmp___0;
#line 255
    memcpy((void */* __restrict  */)((void *)res), (void const   */* __restrict  */)((void const   *)path),
           (size_t )(p - path));
#line 256
    *(res + (p - path)) = (char)0;
    }
...
#line 428
  if (use_lstat) {
    {
#line 428
    tmp = lstat((char const   */* __restrict  */)((char const   *)file->path), (struct stat */* __restrict  */)(& st));
#line 428
    res = tmp;
    }
  } else {
    {
#line 428
    tmp___0 = stat((char const   */* __restrict  */)((char const   *)file->path),
...
#line 763
  ...
  {
#line 764
  memcpy((void */* __restrict  */)((void *)(str->str + str->len)), (void const   */* __restrict  */)((void const   *)text),
         length);
#line 765
  str->len += length;
#line 766
...
#line 118
    ...
    {
#line 122
    fd = fopen((char const   */* __restrict  */)((char const   *)info->full_path),
...
#line 280
  memcpy((void */* __restrict  */)((void *)new_path), (void const   */* __restrict  */)((void const   *)info->full_path),
...
#line 334
  if (fd) {
    {
#line 334
    tmp___2 = fwrite((void const   */* __restrict  */)((void const   *)str), (size_t )1,
                     text_len, (FILE */* __restrict  */)fd);
    }
#line 334
    if (text_len == tmp___2) {
      {
...
#line 616
          memcpy((void */* __restrict  */)((void *)info.full_path), (void const   */* __restrict  */)((void const   *)hash_file_path),
                 pos);
#line 617
...
#line 41 "/home/june/repo/benchmarks/collector/temp/rhash-1.3.1/rhash_main.h"
...
{ 
  ...
  {
#line 133
  tmp = fopen((char const   */* __restrict  */)((char const   *)opt.template_file),
              (char const   */* __restrict  */)"rb");
#line 133
  fd = tmp;
#line 136
...
#line 145
    ...
    {
#line 146
    len = fread((void */* __restrict  */)((void *)(buffer)), (size_t )1, (size_t )8192,
                (FILE */* __restrict  */)fd);
    }
#line 148
...
#line 83
      if ((int const   )*(*pformat) <= 57) {
#line 83
        tmp___0 = (int )((int const   )*(*pformat) & 15);
      } else {
#line 83
        tmp___0 = (int )(((int const   )*(*pformat) + 9) & 15);
      }
#line 83
      ch = 16 * ch + tmp___0;
#line 84
...
#line 378
        tmp___6 = fwrite((void const   */* __restrict  */)((void const   *)(buffer)),
                         (size_t )1, len, (FILE */* __restrict  */)out);
        }
#line 378
        if (tmp___6 != len) {
#line 378
...
#line 467
    tmp = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& st));
    }
#line 467
    if (tmp >= 0) {
      {
...
#line 474
  tmp___0 = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& st));
  }
#line 474
  if (tmp___0 >= 0) {
#line 475
...
#line 37
      tmp___5 = (int )((int const   )*(str + 0) & 15);
    } else {
#line 37
      tmp___5 = (int )((((int const   )*(str + 0) - 97) + 10) & 15);
    }
#line 37
    if ((int const   )*(str + 1) <= 57) {
#line 37
      tmp___6 = (int )((int const   )*(str + 1) & 15);
    } else {
#line 37
      tmp___6 = (int )((((int const   )*(str + 1) - 97) + 10) & 15);
    }
#line 37
...
#line 173
    ...
    {
#line 173
    memcpy((void */* __restrict  */)((void *)((unsigned char *)*(data->root_files.blocks.array + data->root_files.size / 256UL) + sizeof(file_t ) * (data->root_files.size % 256UL))),
           (void const   */* __restrict  */)((void const   *)(& file)), sizeof(file_t ));
#line 173
