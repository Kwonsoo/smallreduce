...
#line 338
    *(Dest + (int )tmp) = *(Source + (int )InvertCount);
#line 337
    if (! InvertCount) {
#line 337
      goto while_break;
...
#line 171
  if ((unsigned long )rtnVal != (unsigned long )((void *)0)) {
    {
#line 173
    strcpy((char */* __restrict  */)(rtnVal->semName), (char const   */* __restrict  */)((char const   *)name));
#line 174
    rtnVal->index = 0;
#line 182
    lock.l_type = (short)1;
...
#line 331
        strcat((char */* __restrict  */)(LocalSemaphoreName), (char const   */* __restrict  */)((char const   *)name));
#line 332
...
#line 473
  strcat((char */* __restrict  */)(temp), (char const   */* __restrict  */)((char const   *)name));
#line 475
...
#line 674
    oldAlarm = alarm(0U);
#line 675
    tmp = sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newSig)),
                    (struct sigaction */* __restrict  */)(& oldSig));
#line 675
    rtnVal = (uLONG )(tmp != 0);
    }
#line 677
...
#line 703
    if (resetAction) {
      {
#line 704
      sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& oldSig)),
...
#line 582
  if ((unsigned long )placeHolder->status != (unsigned long )((eataSP_S *)((void *)0))) {
    {
#line 583
    memcpy((void */* __restrict  */)((void *)placeHolder->status), (void const   */* __restrict  */)((void const   *)((void *)(& Status))),
           sizeof(eataSP_S ));
    }
  }
#line 591
...
#line 596
          ...
          {
#line 598
          memcpy((void */* __restrict  */)((void *)placeHolder->sense), (void const   */* __restrict  */)((void const   *)((void *)SenseP)),
                 (size_t )s);
          }
        }
      }
...
#line 1113
    memcpy((void */* __restrict  */)((void *)newCurrent), (void const   */* __restrict  */)((void const   *)((void *)current)),
           (size_t )current->size);
#line 1115
...
#line 2154
  ...
  {
#line 2160
  memcpy((void */* __restrict  */)((void *)(i2o_P->CDB)), (void const   */* __restrict  */)((void const   *)((void *)((unsigned char *)eata_P + 12))),
         (size_t )cdbLen);
#line 2161
...
#line 2998
          ...
          {
#line 3000
          memcpy((void */* __restrict  */)((void *)flash), (void const   */* __restrict  */)((void const   *)((void *)((unsigned char *)(SGA[Index] + SGOffset)))),
                 (size_t )TestLength);
#line 3001
          bp = buffer;
#line 3001
...
#line 3558
            memcpy((void */* __restrict  */)((void *)(DPTI_SpoofedInquiry)), (void const   */* __restrict  */)((void const   *)((void *)(buffer))),
                   (size_t )length);
            }
          }
        }
...
#line 3628
        if (Length == 0UL) {
          {
#line 3629
          memcpy((void */* __restrict  */)((void *)(buffer + 16)), (void const   */* __restrict  */)((void const   *)(Buffer.Info.ModuleName + 4)),
                 (size_t )8);
#line 3631
          memcpy((void */* __restrict  */)((void *)(buffer + 8)), (void const   */* __restrict  */)((void const   *)(Buffer.Info.ModuleName)),
                 (size_t )4);
#line 3633
          memcpy((void */* __restrict  */)((void *)(buffer + 32)), (void const   */* __restrict  */)((void const   *)(Buffer.Info.ModuleRevLevel)),
                 (size_t )4);
          }
        }
#line 3642
...
#line 3669
            if (*((unsigned char *)eata_P + 6)) {
              {
#line 3687
              memcpy((void */* __restrict  */)((void *)(& eata)), (void const   */* __restrict  */)((void const   *)((void *)eata_P)),
                     (size_t )44);
#line 3692
              tmp___11 = 0UL;
#line 3692
...
#line 3801
      unPacked___0 = unPacked___0;
#line 3804
      memcpy((void */* __restrict  */)((void *)unPacked___0), (void const   */* __restrict  */)((void const   *)((void *)(buffer))),
...
#line 3818
      memcpy((void */* __restrict  */)((void *)(buffer)), (void const   */* __restrict  */)((void const   *)(DPTI_SpoofedRdConfig)),
...
#line 3849
      unPacked___1 = unPacked___1;
#line 3851
      memcpy((void */* __restrict  */)((void *)unPacked___1), (void const   */* __restrict  */)((void const   *)((void *)(buffer))),
             (size_t )((unsigned short )Length));
      }
#line 3858
      goto switch_break;
...
#line 4103
      memcpy((void */* __restrict  */)((void *)(flashBuffers[(int )miniOffset >> 14] + ((int )miniOffset & 16383))),
             (void const   */* __restrict  */)((void const   *)Address), (size_t )count);
#line 4111
...
#line 4157
            ...
            {
#line 4160
            memcpy((void */* __restrict  */)((void *)Address___0), (void const   */* __restrict  */)((void const   *)((void *)(flashBuffers[(int )miniOffset___0 >> 14] + ((int )miniOffset___0 & 16383)))),
                   (size_t )count___0);
#line 4168
...
#line 4247
    memcpy((void */* __restrict  */)((void *)unPacked___6), (void const   */* __restrict  */)((void const   *)((void *)(& status))),
           (size_t )((unsigned short )Length));
    }
#line 4254
    goto switch_break___1;
...
#line 82
  ...
  {
#line 84
  sprintf((char */* __restrict  */)templateBuffer, (char const   */* __restrict  */)((char const   *)(Template)),
          Name);
#line 85
...
#line 92
  close(fd);
#line 93
  sprintf((char */* __restrict  */)lock, (char const   */* __restrict  */)((char const   *)(Lock)),
          Name);
#line 94
...
#line 91
    ...
    {
#line 92
    memcpy((void */* __restrict  */)dest_P, (void const   */* __restrict  */)((void const   *)(& bp->data[bp->readIndex])),
...
#line 132
    ...
    {
#line 133
    memcpy((void */* __restrict  */)((void *)(& bp->data[bp->writeIndex])), (void const   */* __restrict  */)((void const   *)src_P),
           (size_t )((uINT )numToCopy));
#line 134
...
#line 153
    ...
    {
#line 154
    memcpy((void */* __restrict  */)((void *)(& bp->data[bp->writeIndex])), (void const   */* __restrict  */)((void const   *)(& src)),
           (size_t )((uINT )numToCopy));
#line 155
    bp->writeIndex += numToCopy;
    }
...
#line 171
    if ((unsigned long )retVal != (unsigned long )((char *)((void *)0))) {
      {
#line 172
      tmp___0 = memcpy((void */* __restrict  */)((void *)retVal), (void const   */* __restrict  */)((void const   *)left),
                       (size_t )(size - 1U));
#line 172
...
#line 204
    if ((unsigned long )retVal != (unsigned long )((char *)((void *)0))) {
      {
#line 205
      tmp___0 = memcpy((void */* __restrict  */)((void *)retVal), (void const   */* __restrict  */)((void const   *)cp),
                       (size_t )(size - 1U));
#line 205
      *((char *)tmp___0 + (size - 1U)) = (char )'\000';
      }
...
#line 276
      ...
      {
#line 277
      memcpy((void */* __restrict  */)((void *)hold), (void const   */* __restrict  */)((void const   *)q),
...
#line 448
      tmp___1 = getpid();
#line 448
      sprintf((char */* __restrict  */)buffer, (char const   */* __restrict  */)((char const   *)(command)),
              ps, grep, tmp___1);
#line 449
...
#line 467
            ...
            {
#line 469
            cp = strcpy((char */* __restrict  */)buffer, (char const   */* __restrict  */)((char const   *)cp));
            }
            {
#line 470
            while (1) {
