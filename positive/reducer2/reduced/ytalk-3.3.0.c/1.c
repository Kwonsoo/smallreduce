...
#line 36
        if ((int )data == 56) {
          {
#line 37
          fill_term(user, 0, 0, (int )user->rows - 1, (int )user->cols - 1, (ychar )'E');
#line 38
          redraw_term(user, 0);
#line 39
...
#line 218
    if (user->x > 0) {
      {
#line 219
      fill_term(user, 0, 0, user->y - 1, (int )user->cols - 1, (ychar )' ');
      }
    }
    {
#line 220
    fill_term(user, user->y, 0, user->y, user->x, (ychar )' ');
#line 221
    redraw_term(user, 0);
    }
#line 222
    ...
    {
#line 224
    fill_term(user, 0, 0, (int )user->rows - 1, (int )user->cols - 1, (ychar )' ');
#line 225
    redraw_term(user, 0);
    }
#line 226
...
#line 242
    ...
    {
#line 244
    fill_term(user, user->y, 0, user->y, (int )user->cols - 1, (ychar )' ');
#line 245
    redraw_term(user, 0);
    }
#line 246
...
#line 91
  if (tmp___0 < 0) {
    {
#line 92
    show_error((char *)"tcgetattr failed");
#line 93
    bail(1);
    }
  }
...
#line 138
    end_term();
#line 139
    show_error((char *)"init_term: open_term() failed");
#line 140
    bail(0);
    }
  }
...
#line 174
  if (tmp___0 < 0) {
    {
#line 175
    show_error((char *)"tcsetattr failed");
    }
  }
#line 177
  return;
...
#line 237
    ...
    {
#line 239
    free_mem((yaddr )user->scr);
#line 240
    user->scr = (ychar **)((void *)0);
#line 241
    free_mem((yaddr )user->scr_tabs);
#line 242
...
#line 712
    c ++;
#line 712
    addch_curses(user, (ychar )((int )*tmp___1));
#line 711
    i --;
    }
  }
...
#line 743
    c ++;
#line 743
    addch_curses(user, (ychar )((int )*tmp___0));
#line 742
    i --;
    }
  }
...
#line 883
      ...
      {
#line 884
      tmp___3 = realloc_mem((yaddr )*(user->scr + i), (size_t )width);
#line 884
...
#line 883
    ...
    {
#line 889
    tmp___4 = realloc_mem((yaddr )user->scr_tabs, (unsigned long )width * sizeof(char ));
#line 889
...
{ 
  ...
  {
#line 154
  fp = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
  }
#line 154
...
#line 197
              if ((unsigned long )vhost != (unsigned long )((void *)0)) {
                {
#line 198
                strcpy((char */* __restrict  */)vhost, (char const   */* __restrict  */)((char const   *)arg1));
                }
              }
            }
          } else {
...
#line 210
                a->type = 2;
#line 211
                strncpy((char */* __restrict  */)(a->from), (char const   */* __restrict  */)((char const   *)(arg1 + 1)),
                        (size_t )255);
#line 212
                a->from[254] = (char)0;
                }
...
#line 213
                ...
                {
#line 213
                strncpy((char */* __restrict  */)(a->to), (char const   */* __restrict  */)((char const   *)tmp___6),
                        (size_t )255);
#line 214
                a->to[254] = (char)0;
                }
...
#line 217
                  *at___0 = (char)0;
#line 218
                  strncpy((char */* __restrict  */)(a->from), (char const   */* __restrict  */)((char const   *)arg1),
                          (size_t )255);
#line 219
                  a->from[254] = (char)0;
#line 220
                  strncpy((char */* __restrict  */)(a->to), (char const   */* __restrict  */)((char const   *)arg2),
                          (size_t )255);
#line 221
                  a->to[254] = (char)0;
#line 222
...
#line 261
  ...
  {
#line 265
  strncpy((char */* __restrict  */)(uh1), (char const   */* __restrict  */)((char const   *)uh),
          (size_t )255);
#line 266
  uh1[254] = (char)0;
#line 267
...
#line 271
        found = 1;
#line 272
        strncpy((char */* __restrict  */)(uh1), (char const   */* __restrict  */)((char const   *)(a->to)),
                (size_t )255);
#line 273
        uh1[254] = (char)0;
#line 274
...
#line 275
          if (tmp___1 + tmp___2 < 256UL) {
            {
#line 276
            strcat((char */* __restrict  */)(uh1), (char const   */* __restrict  */)((char const   *)at));
            }
          }
        }
#line 277
...
#line 291
            if (tmp___4 + (size_t )(at - uh1) < 255UL) {
              {
#line 292
              strcpy((char */* __restrict  */)at, (char const   */* __restrict  */)((char const   *)(a->to)));
              }
            }
#line 293
            goto while_break___1;
...
#line 78
  strcpy((char */* __restrict  */)out->title, (char const   */* __restrict  */)((char const   *)title));
  }
#line 79
  return (out);
}
...
#line 89
    if ((unsigned long )w->win != (unsigned long )((void *)0)) {
      {
#line 90
      show_error((char *)"make_win: newwin() failed");
      }
    }
    {
#line 91
...
#line 167
    *tmp___0 = 0;
#line 168
    show_error((char *)"curses_redraw: window size too small");
#line 169
    bail(4);
    }
  }
...
#line 327
    if ((unsigned long )p == (unsigned long )((void *)0)) {
      {
#line 328
      show_error((char *)"close_curses: user not found");
      }
#line 329
      return;
    }
...
#line 313 "/home/june/repo/benchmarks/collector/temp/ytalk-3.3.0/src/header.h"
...
#line 39
    if ((long )def_flags & 8192L) {
      {
#line 40
      tmp___0 = show_mesg((char *)"Press any key to quit.", (void (*)())((void *)0));
      }
#line 40
      if (tmp___0 == 0) {
        {
...
#line 103
  out = (char *)tmp___1;
#line 104
  memcpy((void */* __restrict  */)((void *)out), (void const   */* __restrict  */)((void const   *)str),
         len);
  }
#line 105
  return (out);
...
#line 223
    ...
    {
#line 225
    msg_term(me, (char *)"Waiting for connection...");
    }
  }
  {
#line 226
...
#line 51
  {      {(char *)"Main Menu", (void (*)())((void *)0), (ychar )' '}, 
        ...
        {(char *)"add a user", (void (*)())(& main_menu_sel), (ychar )'a'}, 
        {(char *)"delete a user", (void (*)())(& main_menu_sel), (ychar )'d'}, 
        {(char *)"kill all unconnected", (void (*)())(& main_menu_sel), (ychar )'k'}, 
        {(char *)"options",
      (void (*)())(& main_menu_sel), (ychar )'o'}, 
        {(char *)"rering all", (void (*)())(& main_menu_sel), (ychar )'r'}, 
        {(char *)"shell", (void (*)())(& main_menu_sel), (ychar )'s'}, 
        {(char *)"user list", (void (*)())(& main_menu_sel), (ychar )'u'}, 
        {(char *)"output user to file", (void (*)())(& main_menu_sel), (ychar )'w'}, 
        {(char *)"quit", (void (*)())(& main_menu_sel), (ychar )'q'}, 
...
#line 80
  {      {(char *)"Ytalk Error", (void (*)())((void *)0), (ychar )' '}, 
        {(char *)"", (void (*)())((void *)0), (ychar )' '}, 
        {(char *)((void *)0), (void (*)())(& show_error), (ychar )' '}, 
        {(char *)((void *)0), (void (*)())(& show_error), (ychar )' '}, 
        {(char *)"", (void (*)())((void *)0), (ychar )' '}, 
        {(char *)((void *)0), (void (*)())(& show_error), (ychar )' '}, 
        {(char *)((void *)0), (void (*)())(& show_error), (ychar )' '}, 
...
#line 125
    user->output_fd = 0;
#line 126
    tmp___0 = show_mesg((char *)"Output Terminated", (void (*)())((void *)0));
    }
#line 126
    if (tmp___0 >= 0) {
      {
...
#line 132
  output_user = user;
#line 133
  tmp___1 = show_text((char *)"Output filename?", (void (*)())(& do_output));
  }
#line 133
  if (tmp___1 >= 0) {
    {
...
#line 157
  ...
  {
#line 159
  tmp___0 = show_text((char *)"Add Which User?", (void (*)())(& do_invite));
  }
#line 159
  if (tmp___0 >= 0) {
    {
...
#line 161
  ...
  {
#line 163
  tmp___1 = show_user_menu((char *)"Delete Which User?", (void (*)())(& free_user),
                           0);
  }
#line 163
  if (tmp___1 >= 0) {
...
#line 185
  ...
  {
#line 187
  tmp___4 = show_user_menu((char *)"Output Which User?", (void (*)())(& do_output_user),
                           1);
  }
#line 187
  if (tmp___4 >= 0) {
...
#line 348
              if (text_ypos >= 0) {
                {
#line 349
                raw_term(me, text_ypos, text_xpos + text_pos, (ychar *)(text_str + text_pos),
                         1);
                }
              }
#line 351
...
#line 356
            if (text_ypos >= 0) {
              {
#line 357
              raw_term(me, text_ypos, text_xpos + text_pos, (ychar *)" ", 1);
              }
            }
          }
        } else
...
#line 364
            if (text_ypos > 0) {
              {
#line 365
              raw_term(me, text_ypos, text_xpos, (ychar *)"     ", menu_long);
              }
            }
          }
        } else
...
#line 381
      if (text_ypos >= 0) {
        {
#line 382
        raw_term(me, text_ypos, text_xpos + text_pos, (ychar *)((void *)0), 0);
#line 383
        flush_term(me);
        }
#line 384
...
#line 443
    buflen = menu_long + 64;
#line 444
    tmp___3 = realloc_mem((yaddr )buf___0, (size_t )(buflen + 7));
#line 444
...
#line 452
      y ++;
#line 452
      raw_term(me, tmp___4, x, (ychar *)"#####", menu_long + 7);
      }
    } else {
#line 454
      y = 0;
...
#line 476
        temp___0 = center(menu_long + 3, (int )tmp___9);
        }
        {
#line 477
        while (1) {
...
#line 494
    *tmp___19 = (ychar )'#';
#line 495
    raw_term(me, y, x, buf___0, (int )(c - buf___0));
#line 460
    i ++;
#line 460
    y ++;
...
#line 511
      raw_term(me, y, x, buf___0, (int )(c - buf___0));
#line 512
      raw_term(me, y, x + 12, (ychar *)((void *)0), 0);
      }
    } else {
      {
#line 514
      raw_term(me, y, x, (ychar *)"#####", menu_long + 7);
      }
#line 515
      if ((unsigned long )menu_ptr == (unsigned long )(text_menu)) {
        {
...
#line 517
      if ((unsigned long )menu_ptr == (unsigned long )(yes_no_menu)) {
        {
#line 518
        raw_term(me, y - 1, ((x + menu_long) + 7) - 2, (ychar *)((void *)0), 0);
        }
      } else {
        {
#line 520
        raw_term(me, y, (int )me->t_cols / 2, (ychar *)((void *)0), 0);
        }
      }
    }
  }
...
#line 536
  if ((int )me->t_rows < 2) {
    {
#line 537
    show_error((char *)"show_menu: window too small");
    }
#line 538
    return (-1);
  }
...
#line 546
    if ((int )(menu + i)->key < 32) {
      {
#line 547
      show_error((char *)"show_menu: invalid key");
      }
#line 548
      return (-1);
    } else
...
#line 551
  if (menu_long <= 0) {
    {
#line 552
    show_error((char *)"show_menu: menu too small");
    }
#line 553
    return (-1);
  }
...
#line 575
  if ((int )me->t_rows < 3) {
    {
#line 576
    show_error((char *)"show_text: window too small");
    }
#line 577
    return (-1);
  }
...
#line 723
      if ((int )u->key != 0) {
        {
#line 724
        strcpy((char */* __restrict  */)(user_buf[i]), (char const   */* __restrict  */)((char const   *)u->full_name));
#line 725
...
#line 833
    if ((unsigned long )error_menu[i].item == (unsigned long )((void *)0)) {
      {
#line 834
      strncpy((char */* __restrict  */)(err_str[got_error]), (char const   */* __restrict  */)((char const   *)str1),
              (size_t )132);
#line 835
...
#line 838
      if ((unsigned long )str2 != (unsigned long )((void *)0)) {
        {
#line 839
        strncpy((char */* __restrict  */)(err_str[got_error]), (char const   */* __restrict  */)((char const   *)str2),
                (size_t )132);
#line 840
        err_str[got_error][131] = (char )'\000';
#line 841
...
#line 71
  if (fd < 0) {
    {
#line 72
    show_error((char *)"add_fd: descriptor out of range");
    }
#line 73
    return;
  } else
...
#line 88
  if (fd < 0) {
    {
#line 89
    show_error((char *)"remove_fd: descriptor out of range");
    }
#line 90
    return;
  } else
...
#line 183
    rc = select(high_fd, (fd_set */* __restrict  */)(& sel), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 184
      if (*tmp___1 != 4) {
        {
#line 185
        show_error((char *)"main_loop: select failed");
        }
      }
    }
    {
...
#line 216
    ...
    {
#line 222
    sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& old_mask)),
...
#line 269
      if (*tmp___0 != 4) {
        {
#line 270
        show_error((char *)"input_loop: select failed");
        }
      }
    }
#line 274
...
#line 53
    if ((unsigned long )user->gt.version != (unsigned long )((void *)0)) {
      {
#line 54
      free_mem((yaddr )user->gt.version);
      }
    }
    {
#line 55
    user->gt.version = gtalk_parse_version(user->gt.buf, (ychar )((int )user->edit[1]));
#line 57
    user_winch = 1;
    }
#line 58
...
#line 74
    tmp___0 = realloc_mem((yaddr )user->dbuf, (size_t )user->dbuf_size);
#line 74
...
#line 106
    if (r >= 0) {
      {
#line 107
      show_error((char *)"send_oob: write failed");
      }
    } else {
      {
#line 106
...
#line 123
    strncpy((char */* __restrict  */)(v3p.name), (char const   */* __restrict  */)((char const   *)from->user_name),
            (size_t )16);
#line 124
    strncpy((char */* __restrict  */)(v3p.host), (char const   */* __restrict  */)((char const   *)from->host_fqdn),
            (size_t )64);
#line 125
...
#line 127
    v2p.code = (ychar )131;
#line 128
    strncpy((char */* __restrict  */)(v2p.name), (char const   */* __restrict  */)((char const   *)from->user_name),
            (size_t )12);
#line 129
    strncpy((char */* __restrict  */)(v2p.host), (char const   */* __restrict  */)((char const   *)from->host_fqdn),
            (size_t )64);
#line 130
...
{ 
  ...
  {
#line 168
  tmp___0 = get_mem((size_t )13);
#line 168
  name = (char *)tmp___0;
#line 169
  tmp___1 = get_mem((size_t )65);
#line 169
  host = (char *)tmp___1;
#line 175
  strncpy((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)(pack->name)),
          (size_t )12);
#line 176
  strncpy((char */* __restrict  */)host, (char const   */* __restrict  */)((char const   *)(pack->host)),
          (size_t )64);
#line 177
  *(name + 12) = (char )'\000';
#line 178
...
#line 186
    show_error(errstr);
#line 187
    show_error((char *)"port from ytalk V2.? failed");
#line 188
    free_mem((yaddr )host);
#line 189
    free_mem((yaddr )name);
...
{ 
  ...
  {
#line 261
  tmp___0 = get_mem((size_t )100);
#line 261
  estr___0 = (char *)tmp___0;
#line 262
  tmp___1 = get_mem((size_t )17);
#line 262
  name = (char *)tmp___1;
#line 263
  tmp___2 = get_mem((size_t )65);
#line 263
  host = (char *)tmp___2;
#line 265
  strncpy((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)(pack->name)),
...
#line 438
    remove_fd(fd);
#line 439
    show_error((char *)"read_user: unknown contact");
    }
#line 440
    return;
  }
...
#line 443
        if (*tmp___1 != 32) {
          {
#line 444
          show_error((char *)"read_user: read() failed");
          }
        }
      }
    }
...
#line 452
      if (rc < (ssize_t )user->drain) {
        {
#line 453
        memcpy((void */* __restrict  */)((void *)user->dptr), (void const   */* __restrict  */)((void const   *)c),
               (size_t )rc);
#line 454
        user->dptr += rc;
#line 455
...
#line 528
          if (tmp___4 <= 0L) {
            {
#line 529
            show_error((char *)"write to user output file failed");
#line 530
            close(user->output_fd);
#line 531
            user->output_fd = 0;
        ...
        {
#line 533
        show_input(user, buf___1, (int )(p - buf___1));
        }
      }
    }
  }
...
#line 550
    remove_fd(fd);
#line 551
    show_error((char *)"ytalk_user: unknown contact");
    }
#line 552
    return;
  }
...
#line 555
    free_user(user);
#line 556
    show_error((char *)"ytalk_user: bad ytalk contact");
    }
#line 557
    return;
  }
...
#line 579
  free_user(user);
#line 580
  show_error((char *)"ytalk_user: unsupported ytalk protocol");
  }
#line 581
  return;
  switch_break: 
...
#line 645
    remove_fd(fd);
#line 646
    show_error((char *)"connect_user: unknown contact");
    }
#line 647
    return;
  }
  {
#line 649
  tmp___0 = full_read(fd, (char *)(user->edit), (size_t )3);
  }
#line 649
  if (tmp___0 < 0) {
    {
#line 650
    free_user(user);
#line 651
    show_error((char *)"connect_user: bad read");
    }
#line 652
    return;
  }
...
#line 655
    free_user(user);
#line 656
    show_error((char *)"connect_user: open_term() failed");
    }
#line 657
    return;
  }
...
#line 710
  if ((unsigned long )user == (unsigned long )((void *)0)) {
    {
#line 711
    show_error((char *)"contact_user: unknown contact");
    }
#line 712
    return;
  }
...
#line 718
      if (*tmp___1 != 104) {
        {
#line 719
        show_error((char *)"connect_user: accept() failed");
        }
      }
    }
#line 720
...
#line 741
      show_error((char *)"Connection from unexpected host!");
      }
    }
  }
  {
...
#line 746
  add_fd(user->fd, (void (*)())(& connect_user));
#line 747
...
#line 770
    ...
    {
#line 771
    addch_term(user, (ychar )((int )temp[i]));
#line 770
    i --;
    }
  }
...
#line 804
    v2p.code = (ychar )133;
#line 805
    strncpy((char */* __restrict  */)(v2p.name), (char const   */* __restrict  */)((char const   *)me->user_name),
            (size_t )12);
#line 806
    strncpy((char */* __restrict  */)(v2p.host), (char const   */* __restrict  */)((char const   *)me->host_name),
            (size_t )64);
#line 807
...
#line 965
  ...
  {
#line 967
  add_fd(user->fd, (void (*)())(& contact_user));
  }
#line 968
  return (user);
}
...
#line 986
    last_auto = t;
#line 987
    tmp___1 = send_auto((u_char )0);
    }
#line 987
    if (tmp___1 != 0) {
      {
#line 988
      show_error((char *)"house_clean: send_auto() failed");
#line 989
      kill_auto();
      }
    }
...
{ 
  ...
  {
#line 1039
  tmp___0 = send_auto((u_char )0);
  }
#line 1039
  if (tmp___0 != 0) {
    {
#line 1040
    show_error((char *)"rering_all: send_auto() failed");
#line 1041
    kill_auto();
    }
  }
...
#line 1134
    o_len = (len << 1) + 512;
#line 1135
    tmp___0 = realloc_mem((yaddr )o_buf, (size_t )o_len);
#line 1135
    o_buf = (ychar *)tmp___0;
    }
  }
...
#line 1138
    o_clen = (clen << 1) + 512;
#line 1139
    tmp___1 = realloc_mem((yaddr )o_cbuf, (size_t )o_clen);
#line 1139
...
#line 1185
      ...
      {
#line 1186
      vt100_process(user, (char )((int )*buf___3));
      }
#line 1187
...
#line 1195
      ...
      {
#line 1196
      gtalk_process(user, (ychar )((int )*buf___3));
      }
#line 1197
...
#line 1211
              if (tmp___0 >= 0) {
                {
#line 1212
                addch_term(user, (ychar )((int )*buf___3));
                }
              } else {
                {
#line 1214
...
#line 1313
    nlen = (len << 1) + 512;
#line 1314
    tmp___0 = realloc_mem((yaddr )nbuf, (size_t )nlen);
#line 1314
    nbuf = (ychar *)tmp___0;
    }
  }
...
#line 210
  if ((unsigned long )out == (unsigned long )((void *)0)) {
    {
#line 211
    show_error((char *)"realloc() failed");
#line 212
    bail(2);
    }
  }
...
#line 143
  if (my_vhost) {
    {
#line 144
    strncpy((char */* __restrict  */)(my_host), (char const   */* __restrict  */)((char const   *)my_vhost),
            (size_t )99);
#line 145
...
#line 147
      if (tmp___5 < 0) {
        {
#line 148
        show_error((char *)"init_user: gethostname() failed");
#line 149
        bail(4);
        }
      } else {
...
#line 156
                if (tmp___3) {
                  {
#line 157
                  strncpy((char */* __restrict  */)(my_host), (char const   */* __restrict  */)((char const   *)name),
                          (size_t )99);
                  }
                }
              }
...
#line 162
  my_host[99] = (char)0;
#line 165
  me = new_user(my_name, my_host, (char *)((void *)0));
  }
#line 165
...
{ 
  ...
  {
#line 245
  free_mem((yaddr )user->user_name);
#line 246
  free_mem((yaddr )user->host_name);
#line 247
  free_mem((yaddr )user->host_fqdn);
#line 248
  free_mem((yaddr )user->tty_name);
#line 249
  free_mem((yaddr )user->full_name);
  }
#line 250
  if ((unsigned long )user->gt.buf != (unsigned long )((void *)0)) {
    {
#line 251
    free_mem((yaddr )user->gt.buf);
    }
  }
#line 252
  if ((unsigned long )user->gt.version != (unsigned long )((void *)0)) {
...
#line 84
  if (fd < 0) {
    {
#line 85
    show_error((char *)"init_dgram: socket() failed");
#line 86
    bail(4);
    }
  }
...
#line 89
    close(fd);
#line 90
    show_error((char *)"init_dgram: bind() failed");
#line 91
    bail(4);
    }
  }
...
#line 95
    close(fd);
#line 96
    show_error((char *)"init_dgram: getsockname() failed");
#line 97
    bail(4);
    }
  }
...
#line 116
  if (daemons >= 5) {
    {
#line 117
    show_error((char *)"init_daemon: too many daemons");
#line 118
    bail(4);
    }
  }
...
#line 149
  if (fd == -1) {
    {
#line 150
    show_error((char *)"read_autoport: accept() failed");
#line 151
    free_mem((yaddr )pack);
    }
#line 152
...
#line 158
  if (tmp___2 < 0) {
    {
#line 159
    show_error((char *)"read_autoport: unknown auto-invite connection");
#line 160
    close(fd);
#line 161
    free_mem((yaddr )pack);
...
#line 205
  if (autofd < 0) {
    {
#line 206
    show_error((char *)"init_autoport: socket() failed");
    }
#line 207
    return;
  }
...
#line 212
    autofd = -1;
#line 213
    show_error((char *)"init_autoport: bind() failed");
    }
#line 214
    return;
  }
...
#line 219
    autofd = -1;
#line 220
    show_error((char *)"init_autoport: getsockname() failed");
    }
#line 221
    return;
  }
...
#line 226
    autofd = -1;
#line 227
    show_error((char *)"init_autoport: listen() failed");
    }
#line 228
    return;
  }
...
#line 231
  add_fd(autofd, (void (*)())(& read_autoport));
  }
#line 232
  return;
}
...
#line 284
    omsg.pid = nmsg.pid;
#line 285
    strncpy((char */* __restrict  */)(omsg.l_name), (char const   */* __restrict  */)((char const   *)(nmsg.l_name)),
            (size_t )9);
#line 286
    strncpy((char */* __restrict  */)(omsg.r_name), (char const   */* __restrict  */)((char const   *)(nmsg.r_name)),
            (size_t )9);
#line 287
    strncpy((char */* __restrict  */)(omsg.r_tty), (char const   */* __restrict  */)((char const   *)(nmsg.r_tty)),
            (size_t )16);
#line 288
...
#line 314
    tmp___0 = select(talkd[d].fd + 1, (fd_set */* __restrict  */)(& sel___0), (fd_set */* __restrict  */)((fd_set *)0),
                     (fd_set */* __restrict  */)((fd_set *)0), (struct timeval */* __restrict  */)(& tv));
#line 314
    n = (ssize_t )tmp___0;
    }
#line 314
    if (n < 0L) {
      {
#line 315
      show_error((char *)"sendit: flush select() failed");
      }
#line 316
      return (-1);
    }
...
#line 320
    if (tmp___1 < 0L) {
      {
#line 321
      show_error((char *)"sendit: flush recv() failed");
      }
#line 322
      return (-1);
    }
...
#line 337
      if (n != (ssize_t )talkd[d].mlen) {
        {
#line 338
        show_error((char *)"sendit: sendto() failed");
        }
#line 339
        return (-1);
      }
...
#line 343
      sel___0.__fds_bits[talkd[d].fd / (8 * (int )sizeof(__fd_mask ))] |= 1L << talkd[d].fd % (8 * (int )sizeof(__fd_mask ));
#line 344
      tmp___2 = select(talkd[d].fd + 1, (fd_set */* __restrict  */)(& sel___0), (fd_set */* __restrict  */)((fd_set *)0),
                       (fd_set */* __restrict  */)((fd_set *)0), (struct timeval */* __restrict  */)(& tv));
#line 344
      n = (ssize_t )tmp___2;
      }
#line 344
      if (n < 0L) {
        {
#line 345
        show_error((char *)"sendit: first select() failed");
        }
#line 346
        return (-1);
      }
...
#line 352
      if (n < 0L) {
        {
#line 353
        show_error((char *)"sendit: recv() failed");
        }
#line 354
        return (-1);
      }
...
#line 361
      sel___0.__fds_bits[talkd[d].fd / (8 * (int )sizeof(__fd_mask ))] |= 1L << talkd[d].fd % (8 * (int )sizeof(__fd_mask ));
#line 362
      tmp___3 = select(talkd[d].fd + 1, (fd_set */* __restrict  */)(& sel___0), (fd_set */* __restrict  */)((fd_set *)0),
                       (fd_set */* __restrict  */)((fd_set *)0), (struct timeval */* __restrict  */)(& tv));
#line 362
      n = (ssize_t )tmp___3;
      }
#line 362
      if (n < 0L) {
        {
#line 363
        show_error((char *)"sendit: second select() failed");
        }
#line 364
        return (-1);
      }
...
#line 381
      if ((int )nrsp.answer == 0) {
        {
#line 383
        memcpy((void */* __restrict  */)((void *)((char *)(& t))), (void const   */* __restrict  */)((void const   *)((char *)(& orsp.addr.sin_family) - 2)),
               sizeof(t));
#line 384
        tmp___4 = ntohs(t);
        }
...
#line 434
  m2 = nmsg;
#line 436
  memcpy((void */* __restrict  */)((void *)(& m1.ctl_addr)), (void const   */* __restrict  */)((void const   *)(& talkd[otalk].sock)),
         sizeof(m1.ctl_addr));
#line 437
  place_my_address(& m1.ctl_addr, addr);
#line 439
  memcpy((void */* __restrict  */)((void *)(& m2.ctl_addr)), (void const   */* __restrict  */)((void const   *)(& talkd[ntalk].sock)),
         sizeof(m2.ctl_addr));
#line 440
...
#line 454
    if ((unsigned long )n != sizeof(m2)) {
      {
#line 455
      show_error((char *)"Warning: cannot write to new talk daemon");
      }
    }
    {
#line 457
...
#line 460
    if ((unsigned long )n != sizeof(m1)) {
      {
#line 461
      show_error((char *)"Warning: cannot write to old talk daemon");
      }
    }
#line 463
    tv.tv_sec = 4L;
...
#line 471
    ...
    {
#line 473
    n = select(1 + max, (fd_set */* __restrict  */)(& sel___0), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 473
    if (n < 0) {
      {
#line 474
      show_error((char *)"find_daemon: first select() failed");
      }
#line 475
      goto __Cont;
    }
...
#line 488
                ...
                {
#line 490
                show_error((char *)"find_daemon: recv() failed");
                }
              }
            }
          }
...
#line 500
      if (n < 0) {
        {
#line 501
        show_error((char *)"find_daemon: second select() failed");
        }
      }
#line 480
      if (! (n > 0)) {
...
#line 551
  strncpy((char */* __restrict  */)(nmsg.l_name), (char const   */* __restrict  */)((char const   *)me->user_name),
          (size_t )12);
#line 555
  memcpy((void */* __restrict  */)((void *)(& omsg.ctl_addr)), (void const   */* __restrict  */)((void const   *)(& talkd[otalk].sock)),
         sizeof(omsg.ctl_addr));
#line 556
  memcpy((void */* __restrict  */)((void *)(& nmsg.ctl_addr)), (void const   */* __restrict  */)((void const   *)(& talkd[ntalk].sock)),
...
#line 644
  *tmp___0 = 0;
#line 645
  show_error((char *)"send_dgram: unknown type");
  }
#line 646
  return (-1);
  switch_break: ;
...
#line 698
    strncpy((char */* __restrict  */)(nmsg.r_name), (char const   */* __restrict  */)((char const   *)user->user_name),
            (size_t )12);
#line 699
...
#line 701
    strncpy((char */* __restrict  */)(nmsg.r_name), (char const   */* __restrict  */)((char const   *)user->user_name),
            (size_t )12);
#line 702
    strncpy((char */* __restrict  */)(nmsg.r_tty), (char const   */* __restrict  */)((char const   *)user->tty_name),
            (size_t )16);
    }
  }
  {
#line 705
  memcpy((void */* __restrict  */)((void *)(& nmsg.addr)), (void const   */* __restrict  */)((void const   *)(& user->sock)),
         sizeof(nmsg.addr));
#line 706
...
#line 744
  nmsg.r_tty[0] = (char )'\000';
#line 746
  memcpy((void */* __restrict  */)((void *)(& nmsg.addr)), (void const   */* __restrict  */)((void const   *)(& autosock)),
         sizeof(nmsg.addr));
#line 747
  nmsg.addr.sin_family = htons((uint16_t )2);
#line 749
...
#line 794
  if (fd < 0) {
    {
#line 795
    show_error((char *)"newsock: socket() failed");
    }
#line 796
    return (-1);
  }
...
#line 799
    close(fd);
#line 800
    show_error((char *)"newsock: bind() failed");
    }
#line 801
    return (-1);
  }
...
#line 805
    close(fd);
#line 806
    show_error((char *)"newsock: getsockname() failed");
    }
#line 807
    return (-1);
  }
...
#line 811
    close(fd);
#line 812
    show_error((char *)"newsock: listen() failed");
    }
#line 813
    return (-1);
  }
...
#line 844
  if (fd < 0) {
    {
#line 845
    show_error((char *)"connect_to: socket() failed");
    }
#line 846
    return (-1);
  }
...
#line 852
    ...
    {
#line 854
    show_error((char *)"connect_to: connect() failed");
    }
#line 855
    return (-1);
  }
...
#line 859
    close(fd);
#line 860
    show_error((char *)"connect_to: getsockname() failed");
    }
#line 861
    return (-1);
  }
...
#line 891
    ...
    {
#line 893
    memcpy((void */* __restrict  */)((void *)(& addr)), (void const   */* __restrict  */)((void const   *)*(host->h_addr_list + 0)),
           sizeof(addr));
    }
  } else {
    {
...
#line 112
    *tmp___0 = 0;
#line 113
    show_error((char *)"command shell terminated");
    }
#line 114
    return;
  }
...
#line 160
    *tmp___0 = 0;
#line 161
    show_error((char *)"alternate mode already running");
    }
#line 162
    return;
  }
...
#line 165
  if (tmp___1 < 0) {
    {
#line 166
    msg_term(me, (char *)"cannot get pseudo terminal");
    }
#line 167
    return;
  }
...
#line 265
    ioctl(fd, 21518UL);
#line 269
    tmp___3 = stat((char const   */* __restrict  */)((char const   *)(name)), (struct stat */* __restrict  */)(& sbuf));
    }
#line 269
    if (tmp___3 == 0) {
#line 270
