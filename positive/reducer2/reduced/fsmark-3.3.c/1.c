...
#line 128
    ...
    {
#line 130
    strncpy((char */* __restrict  */)(child_tasks[num_dirs].test_dir), (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )4096);
#line 132
    num_dirs ++;
    }
...
#line 142
    ...
    {
#line 145
    strncpy((char */* __restrict  */)(log_file_name), (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )4096);
    }
#line 146
    goto switch_break;
...
#line 276
        strncpy((char */* __restrict  */)(child_tasks[i + j * num_dirs].test_dir),
                (char const   */* __restrict  */)((char const   *)(child_tasks[i].test_dir)),
                (size_t )4096);
#line 275
        j ++;
        }
...
#line 423
  if (skip > 0) {
    {
#line 424
    strncat((char */* __restrict  */)((names + file_index)->f_name), (char const   */* __restrict  */)((char const   *)(& seq_name[skip])),
            (size_t )seq_len);
    }
  } else {
    {
#line 426
    strncat((char */* __restrict  */)((names + file_index)->f_name), (char const   */* __restrict  */)((char const   *)(seq_name)),
            (size_t )seq_len);
    }
  }
  {
...
#line 429
  ...
  {
#line 431
  strncat((char */* __restrict  */)((names + file_index)->f_name), (char const   */* __restrict  */)((char const   *)(rand_name)),
          (size_t )rand_len);
  }
#line 433
  return;
...
#line 463
  sprintf((char */* __restrict  */)(thread_log_file_name), (char const   */* __restrict  */)"%s.%d",
          log_file_name, pid);
#line 464
  child_log_file_fp = fopen((char const   */* __restrict  */)((char const   *)(thread_log_file_name)),
...
#line 950
  thread_log_fp = fopen((char const   */* __restrict  */)((char const   *)(child_log_file_name)),
...
#line 1315
  log_file_fp = fopen((char const   */* __restrict  */)((char const   *)(log_file_name)),
