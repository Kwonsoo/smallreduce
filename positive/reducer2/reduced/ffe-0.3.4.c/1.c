...
#line 783
        r = (char *)tmp___2;
#line 784
        strcpy((char */* __restrict  */)r, (char const   */* __restrict  */)((char const   *)home));
#line 785
        strcat((char */* __restrict  */)r, (char const   */* __restrict  */)((char const   *)(path + 1)));
        }
      } else {
        {
#line 788
...
#line 891
            num[3] = *(s + 3);
#line 892
            sscanf((char const   */* __restrict  */)((char const   *)(num)), (char const   */* __restrict  */)"%i",
                   & c);
#line 893
            *w = (char )c;
#line 894
...
#line 1059
                                                              if (tmp) {
                                                                {
#line 1059
                                                                sscanf((char const   */* __restrict  */)((char const   *)(t + 7)),
...
#line 1416
        c_id->regexp = 0;
#line 1417
        tmp___30 = sscanf((char const   */* __restrict  */)((char const   *)values[1]),
                          (char const   */* __restrict  */)"%d", & c_id->position);
        }
#line 1417
        if (tmp___30 != 1) {
          {
...
#line 1428
        if (tmp___33 == 0) {
          {
#line 1434
          rc = regcomp((regex_t */* __restrict  */)(& c_id->reg), (char const   */* __restrict  */)((char const   *)c_id->key),
                       1 | (((1 << 1) << 1) << 1));
          }
#line 1435
          if (rc) {
            {
#line 1437
            tmp___31 = regerror(rc, (regex_t const   */* __restrict  */)((regex_t const   *)(& c_id->reg)),
                                (char */* __restrict  */)((char *)((void *)0)), (size_t )0);
#line 1437
            buflen = (int )tmp___31;
#line 1438
...
#line 1439
            regerror(rc, (regex_t const   */* __restrict  */)((regex_t const   *)(& c_id->reg)),
                     (char */* __restrict  */)errbuf, (size_t )buflen);
#line 1440
            error_in_line();
#line 1441
...
#line 1481
              if (tmp___36) {
                {
#line 1483
                sscanf((char const   */* __restrict  */)((char const   *)values[2]),
                       (char const   */* __restrict  */)"%d", & c_field->length);
                }
              } else {
                {
#line 1486
...
#line 201
    if ((int )*(ffe_open + 0) != 0) {
      {
#line 204
      sprintf((char */* __restrict  */)(command___0), (char const   */* __restrict  */)((char const   *)ffe_open),
              file);
#line 205
      tmp___1 = pipe(fds);
      }
...
#line 304
  ...
  {
#line 307
  tmp = fread((void */* __restrict  */)((void *)ptr), size, nmemb, (FILE */* __restrict  */)stream);
#line 307
  ret += tmp;
  }
#line 308
...
#line 331
  ...
  {
#line 334
  tmp___0 = fgets((char */* __restrict  */)((char *)s), size, (FILE */* __restrict  */)stream);
  }
#line 334
...
#line 626
    if (i->regexp) {
      {
#line 628
      tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& i->reg)),
                    (char const   */* __restrict  */)((char const   *)(buffer + (i->position - 1))),
...
#line 644
      tmp___4 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& i->reg)),
...
#line 654
    if (i->regexp) {
      {
#line 656
      tmp___7 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& i->reg)),
                        (char const   */* __restrict  */)((char const   *)(buffer + (i->position - 1))),
                        (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                        0);
      }
...
#line 902
  tmp = fwrite((void const   */* __restrict  */)((void const   *)write_buffer), (size_t )1,
               bytes, (FILE */* __restrict  */)output_fp);
  }
#line 902
  if (tmp != bytes) {
    {
...
{ 
  ...
  {
#line 911
  tmp = fwrite((void const   */* __restrict  */)((void const   *)buffer), (size_t )1,
               (size_t )size, (FILE */* __restrict  */)default_output_fp);
  }
#line 911
  if (tmp != (size_t )size) {
    {
...
#line 1297
  ...
  {
#line 1298
  sprintf((char */* __restrict  */)((char *)(pb)), (char const   */* __restrict  */)((char const   *)pf),
          (int )*((int8_t *)data));
  }
#line 1299
  goto switch_break___2;
...
#line 1336
  ...
  {
#line 1338
  sprintf((char */* __restrict  */)((char *)(pb)), (char const   */* __restrict  */)"%f",
          (double )*((float *)data));
#line 1339
  writes(pb);
  }
...
#line 1630
          ...
          {
#line 1632
          sprintf((char */* __restrict  */)((char *)(num)), (char const   */* __restrict  */)"%ld",
                  current_file_lineno);
#line 1633
          writes(num);
          }
...
#line 1638
          ...
          {
#line 1640
          sprintf((char */* __restrict  */)((char *)(num)), (char const   */* __restrict  */)"%lld",
                  current_offset);
#line 1641
          writes(num);
          }
...
#line 1650
            ...
            {
#line 1650
            sprintf((char */* __restrict  */)((char *)(num)), (char const   */* __restrict  */)"%d",
                    (pf->f)->position + tmp);
#line 1651
            writes(num);
            }
...
#line 1828
              ...
              {
#line 1828
              fputs((char const   */* __restrict  */)((char const   *)indent), (FILE */* __restrict  */)output_fp);
              }
            }
            while_break___17: /* CIL Label */ ;
            }
...
#line 1843
                fputs((char const   */* __restrict  */)((char const   *)(justify_string)),
                      (FILE */* __restrict  */)output_fp);
#line 1844
                i -= 127;
                }
              }
...
#line 1848
        ...
        {
#line 1851
        fputs((char const   */* __restrict  */)((char const   *)pf->data), (FILE */* __restrict  */)output_fp);
        }
      }
#line 1853
      if ((unsigned long )pf->next != (unsigned long )((void *)0)) {
#line 1853
        if ((unsigned long )separator != (unsigned long )((void *)0)) {
          {
#line 1853
          fputs((char const   */* __restrict  */)((char const   *)separator), (FILE */* __restrict  */)output_fp);
          }
        }
      }
    }
...
#line 2122
    ...
    {
#line 2125
    tmp___5 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& l->reg)),
                      (char const   */* __restrict  */)((char const   *)value), (size_t )0,
...
#line 2313
  if (stype == 98) {
    {
#line 2315
    fwrite((void const   */* __restrict  */)((void const   *)line), (size_t )len,
           (size_t )1, (FILE */* __restrict  */)debug_fp);
    }
  } else
#line 2316
  if ((unsigned long )line != (unsigned long )((void *)0)) {
    {
#line 2318
    fputs((char const   */* __restrict  */)((char const   *)line), (FILE */* __restrict  */)debug_fp);
#line 2319
...
{ 
  ...
  {
#line 61
  ret = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)((char const   *)mode));
  }
#line 62
  if ((unsigned long )ret == (unsigned long )((void *)0)) {
    {
...
#line 183
    result = (char *)tmp___2;
#line 184
    strcpy((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)home));
#line 185
    strcat((char */* __restrict  */)result, (char const   */* __restrict  */)"/");
#line 186
    strcat((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)file));
    }
  } else {
#line 189
    result = file;
...
#line 805
        if ((int )e->op == 63) {
          {
#line 807
          rc = regcomp((regex_t */* __restrict  */)(& l->reg), (char const   */* __restrict  */)((char const   *)l->value),
                       1 | (((1 << 1) << 1) << 1));
          }
#line 808
          if (rc) {
            {
#line 810
            buflen = regerror(rc, (regex_t const   */* __restrict  */)((regex_t const   *)(& l->reg)),
                              (char */* __restrict  */)((char *)((void *)0)), (size_t )0);
#line 811
...
#line 811
            errbuf = (char *)tmp___0;
#line 812
            regerror(rc, (regex_t const   */* __restrict  */)((regex_t const   *)(& l->reg)),
                     (char */* __restrict  */)errbuf, buflen);
#line 813
...
#line 871
    ...
    {
#line 873
    strcat((char */* __restrict  */)file_names, (char const   */* __restrict  */)((char const   *)f->name));
    }
#line 874
    if ((unsigned long )f->next != (unsigned long )((void *)0)) {
      {
...
#line 904
  act.sa_flags = 2;
#line 905
  sigaction(17, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& act)),
...
#line 149
    ...
    {
#line 151
    memcpy((void */* __restrict  */)((void *)target), (void const   */* __restrict  */)((void const   *)s),
           (size_t )bytes);
    }
#line 152
    return (target);
