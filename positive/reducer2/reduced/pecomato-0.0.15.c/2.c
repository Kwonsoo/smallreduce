...
#line 363
            ...
            {
#line 366
            (ifd_entries + (int )ifd_number)->tag = getrawword(ptr, 0UL);
#line 367
            (ifd_entries + (int )ifd_number)->type = getrawword(ptr, 2UL);
#line 368
            (ifd_entries + (int )ifd_number)->count = getrawlong(ptr, 4UL);
#line 369
            (ifd_entries + (int )ifd_number)->value_offset = getrawlong(ptr, 8UL);
#line 371
            tmp___9 = exif_match_tag((int const   )(ifd_entries + (int )ifd_number)->tag);
            }
#line 371
            if (tmp___9) {
              {
#line 375
              debug((char *)"Exif parser: IFD%u found (tag=0x%02x, type=%u, count=%lu)",
                    (int )ifd_number, (int )(ifd_entries + (int )ifd_number)->tag,
                    (int )(ifd_entries + (int )ifd_number)->type, (ifd_entries + (int )ifd_number)->count);
              }
            } else {
              {
#line 372
              warning((char *)"Exif parser: unknown Exif tag 0x%04x", (int )(ifd_entries + (int )ifd_number)->tag);
              }
            }
#line 381
            if (prefs.rewrite) {
...
#line 401
            ...
            {
#line 405
            tmp___12 = get_ifd_type_size((enum TIFF_TYPE  const  )(ifd_entries + (int )ifd_number)->type);
#line 405
            size = (unsigned long )tmp___12 * (ifd_entries + (int )ifd_number)->count;
            }
#line 407
            if (size > 4UL) {
              {
...
#line 419
                gap_size = (unsigned long )((base_offset + (ifd_entries + (int )ifd_number)->value_offset) - ptr);
#line 420
                if (gap_size) {
                  {
#line 422
...
#line 435
              first_value_offset = (ifd_entries + (int )ifd_number)->value_offset;
#line 439
...
#line 9 "/home/wheatley/newnew/temp/pecomato-0.0.15/iptc.c"
...
#line 249
          if ((int )*(iptc_datasets_history + (int )code) > 0) {
            {
#line 252
...
#line 360
    ...
    {
#line 363
    memcpy((void */* __restrict  */)((void *)value), (void const   */* __restrict  */)((void const   *)((((ptr + 1) + 2) + 2) + (int )extended_length)),
           (size_t )length);
    }
#line 365
    if (missing) {
...
#line 494
      ...
      {
#line 495
      memcpy((void */* __restrict  */)((void *)iptc_extract_buffer), (void const   */* __restrict  */)((void const   *)(rewrite_cache + (rewrite_cache_offset - iptc_extract_buffer_size))),
...
#line 507
      ...
      {
#line 508
      memcpy((void */* __restrict  */)((void *)iptc_extract_buffer), (void const   */* __restrict  */)((void const   *)buffer),
             iptc_extract_buffer_size);
#line 509
...
#line 714
  *(iptc_filter_table + (int )tmp___0) = iptc_filter;
#line 715
  return;
}
}
...
#line 1041
            if (code_descr) {
#line 1044
              if ((int )*(iptc_datasets_history + (int )edit_data->code) != 0) {
#line 1044
                if ((unsigned int )code_descr->repeatable == 1U) {
                  {
#line 1047
...
#line 30 "/home/wheatley/newnew/temp/pecomato-0.0.15/main.c"
unsigned long rewrite_cache_size  ;
#line 31 "/home/wheatley/newnew/temp/pecomato-0.0.15/main.c"
FILE *output_file  ;
#line 32 "/home/wheatley/newnew/temp/pecomato-0.0.15/main.c"
char *output_filename  ;
#line 33 "/home/wheatley/newnew/temp/pecomato-0.0.15/main.c"
size_t input_length  ;
...
#line 570
      filename ++;
#line 571
      list_file = fopen((char const   */* __restrict  */)((char const   *)filename),
...
#line 662
      include_file = fopen((char const   */* __restrict  */)((char const   *)include_filename),
                           (char const   */* __restrict  */)"r");
      }
#line 663
      if (! include_file) {
...
#line 690
      exclude_file = fopen((char const   */* __restrict  */)((char const   *)exclude_filename),
                           (char const   */* __restrict  */)"r");
      }
#line 691
      if (! exclude_file) {
...
#line 718
      edit_file = fopen((char const   */* __restrict  */)((char const   *)edit_filename),
                        (char const   */* __restrict  */)"r");
      }
#line 719
      if (! edit_file) {
...
#line 769
    input_file = fopen((char const   */* __restrict  */)((char const   *)input_filename),
...
#line 805
          if (*pathname) {
            {
#line 807
            strcat((char */* __restrict  */)output_filename, (char const   */* __restrict  */)((char const   *)pathname));
#line 808
        ...
        {
#line 810
        strcat((char */* __restrict  */)output_filename, (char const   */* __restrict  */)((char const   *)filename___0));
#line 813
...
#line 853
        if (*pathname___0) {
          {
#line 855
          strcat((char */* __restrict  */)iptc_filename, (char const   */* __restrict  */)((char const   *)pathname___0));
#line 856
      ...
      {
#line 858
      strcat((char */* __restrict  */)iptc_filename, (char const   */* __restrict  */)((char const   *)filename___1));
#line 859
      strcat((char */* __restrict  */)iptc_filename, (char const   */* __restrict  */)".");
#line 860
      strcat((char */* __restrict  */)iptc_filename, (char const   */* __restrict  */)((char const   *)extract_extension));
#line 862
...
#line 1073
          ...
          {
#line 1074
          strncpy((char */* __restrict  */)rewrite_filename, (char const   */* __restrict  */)((char const   *)output_filename),
                  len___0);
#line 1075
...
#line 1122
          ...
          {
#line 1125
          iptc_file = fopen((char const   */* __restrict  */)((char const   *)iptc_filename),
...
#line 1127
          ...
          {
#line 1129
          len___1 = fwrite((void const   */* __restrict  */)((void const   *)iptc_extract_buffer),
                           (size_t )1, iptc_extract_buffer_size, (FILE */* __restrict  */)iptc_file);
          }
#line 1130
...
{ 
  ...
  {
#line 475
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(ptr + offset)),
...
#line 819
  ...
  {
#line 820
  strcpy((char */* __restrict  */)filename, (char const   */* __restrict  */)((char const   *)output_filename));
#line 821
...
#line 878
      ...
      {
#line 882
      memcpy((void */* __restrict  */)((void *)(rewrite_cache + rewrite_cache_offset)),
             (void const   */* __restrict  */)((void const   *)buffer), length);
#line 883
...
#line 884
      ...
      {
#line 889
      len = fwrite((void const   */* __restrict  */)((void const   *)buffer), (size_t )1,
                   length, (FILE */* __restrict  */)output_file);
      }
#line 890
      if (len != length) {
        {
...
#line 929
      memcpy((void */* __restrict  */)((void *)(rewrite_cache + rewrite_cache_offset)),
             (void const   */* __restrict  */)((void const   *)(buffer + result->parsed_bytes)),
             len);
#line 930
    ...
    {
#line 933
    len = fwrite((void const   */* __restrict  */)((void const   *)rewrite_cache),
                 (size_t )1, rewrite_cache_offset, (FILE */* __restrict  */)output_file);
    }
#line 934
...
#line 1403
  ...
  {
#line 1404
  memcpy((void */* __restrict  */)((void *)buffer_copy), (void const   */* __restrict  */)((void const   *)buffer),
         buffer_length);
#line 1405
...
#line 1531
            ...
            {
#line 1532
            memcpy((void */* __restrict  */)((void *)stored_value), (void const   */* __restrict  */)((void const   *)value),
                   stored_value_length);
            }
          }
#line 1534
