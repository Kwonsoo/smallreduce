...
#line 189
  time(& now);
#line 190
  localtime_r((time_t const   */* __restrict  */)((time_t const   *)(& now)), (struct tm */* __restrict  */)(& tm));
#line 192
  snprintf((char */* __restrict  */)((char *)buffer), (size_t )buflen, (char const   */* __restrict  */)"%2.2d:%2.2d:%2.2d ",
...
#line 220
  vsnprintf((char */* __restrict  */)(buffer), sizeof(buffer), (char const   */* __restrict  */)((char const   *)fmt),
            ap);
#line 221
  __builtin_va_end(ap);
#line 223
...
#line 369
    ...
    {
#line 370
    stats_clear((stats_t */* const  */)((stats_t *)(stats + i)));
#line 369
    i ++;
    }
  }
...
#line 386
    if (tmp == 0) {
      {
#line 387
      sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*s %15lf %15lf %15lf %15lf %15lf %15lf %15lf",
...
#line 395
    if (tmp___0 == 0) {
      {
#line 396
      sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*s %15lf",
             & info->value[8]);
      }
    }
    {
...
#line 523
    fmt = (char *)tmp___0;
#line 526
    printf((char const   */* __restrict  */)((char const   *)fmt), prefix, s->value[0],
           s->value[1], s->value[2], s->value[3], s->value[4], s->value[9], s->value[8],
           s->value[7], s->value[12], s->value[13], s->value[14], buf);
    }
  } else {
#line 535
    if (summary) {
...
#line 538
    printf((char const   */* __restrict  */)((char const   *)fmt___0), prefix, s->value[0],
           s->value[1], s->value[2], s->value[3], s->value[4], s->value[9], s->value[8],
           s->value[7], buf);
    }
  }
...
#line 749
        data = file_get((char const   */* const  */)((char const   *)(path)));
        }
#line 749
...
#line 774
              if (tmp___2 > sizeof("POWER_SUPPLY_CHARGE_NOW=") - 1UL) {
                {
#line 776
                sscanf((char const   */* __restrict  */)((char const   *)((buffer + sizeof("POWER_SUPPLY_CHARGE_NOW=")) - 1)),
...
#line 780
              if (tmp___4 > sizeof("POWER_SUPPLY_ENERGY_NOW=") - 1UL) {
                {
#line 782
                sscanf((char const   */* __restrict  */)((char const   *)((buffer + sizeof("POWER_SUPPLY_ENERGY_NOW=")) - 1)),
                       (char const   */* __restrict  */)"%12d", & val);
#line 783
...
#line 786
              if (tmp___6 > sizeof("POWER_SUPPLY_CURRENT_NOW=") - 1UL) {
                {
#line 788
                sscanf((char const   */* __restrict  */)((char const   *)((buffer + sizeof("POWER_SUPPLY_CURRENT_NOW=")) - 1)),
                       (char const   */* __restrict  */)"%12d", & val);
#line 789
...
#line 792
              if (tmp___8 > sizeof("POWER_SUPPLY_POWER_NOW=") - 1UL) {
                {
#line 794
                sscanf((char const   */* __restrict  */)((char const   *)((buffer + sizeof("POWER_SUPPLY_POWER_NOW=")) - 1)),
                       (char const   */* __restrict  */)"%12d", & val);
#line 795
...
#line 798
              if (tmp___10 > sizeof("POWER_SUPPLY_VOLTAGE_NOW=") - 1UL) {
                {
#line 800
                sscanf((char const   */* __restrict  */)((char const   *)((buffer + sizeof("POWER_SUPPLY_VOLTAGE_NOW=")) - 1)),
                       (char const   */* __restrict  */)"%12d", & val);
#line 801
...
#line 873
    sprintf((char */* __restrict  */)(filename), (char const   */* __restrict  */)"/proc/acpi/battery/%s/state",
            dirent->d_name);
#line 874
    file = fopen((char const   */* __restrict  */)((char const   *)(filename)), (char const   */* __restrict  */)"r");
    }
#line 874
...
#line 890
        if (tmp___6) {
          {
#line 891
          tmp___5 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
...
#line 894
          if (tmp___8) {
            {
#line 895
            tmp___7 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
                               (char **/* __restrict  */)((char **)((void *)0)), 10);
#line 895
...
#line 896
          if (tmp___10) {
            {
#line 897
            tmp___9 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
                               (char **/* __restrict  */)((char **)((void *)0)), 10);
#line 897
...
#line 901
          if (tmp___13) {
            {
#line 902
            tmp___12 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
...
#line 903
          if (tmp___15) {
            {
#line 904
            tmp___14 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
                                (char **/* __restrict  */)((char **)((void *)0)),
                                10);
#line 904
...
#line 916
      sprintf((char */* __restrict  */)(filename), (char const   */* __restrict  */)"/proc/acpi/battery/%s/info",
              dirent->d_name);
#line 917
      file = fopen((char const   */* __restrict  */)((char const   *)(filename)),
...
#line 922
            if (tmp___19) {
              {
#line 923
              tmp___18 = strtoull((char const   */* __restrict  */)((char const   *)ptr),
                                  (char **/* __restrict  */)((char **)((void *)0)),
                                  10);
#line 923
...
#line 1003
  if ((unsigned long )fp != (unsigned long )((void *)0)) {
    {
#line 1004
    tmp = fread((void */* __restrict  */)((void *)cmdline), (size_t )size, (size_t )1,
                (FILE */* __restrict  */)fp);
#line 1004
    n = (int )tmp;
#line 1005
...
#line 1097
  ...
  {
#line 1099
  strcpy((char */* __restrict  */)info->cmdline, (char const   */* __restrict  */)((char const   *)(cmdline)));
#line 1100
  proc_info[i] = info;
  }
#line 1102
...
#line 1173
      ret = select((int )(sock + 1), (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                   (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv));
      }
    } else {
      {
#line 1175
      ret = select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                   (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv));
      }
    }
#line 1178
...
#line 1213
      tmp___7 = stats_gather((stats_t const   */* const  */)((stats_t const   *)(& s1)),
                             (stats_t const   */* const  */)((stats_t const   *)(& s2)),
...
#line 1242
      row_increment((int */* const  */)(& row));
#line 1243
      stats_print((char const   */* const  */)((char const   *)(tmbuffer)), (_Bool const   )0,
                  (stats_t const   */* const  */)((stats_t const   *)(stats + readings)));
#line 1244
      readings ++;
#line 1245
      s1 = s2;
...
#line 1328
  ...
  {
#line 1334
  stats_average_stddev_min_max((stats_t const   */* const  */)((stats_t const   *)stats),
                               (int const   )readings, (stats_t */* const  */)(& average),
                               (stats_t */* const  */)(& stddev), (stats_t */* const  */)(& min),
                               (stats_t */* const  */)(& max));
  }
#line 1335
  if (readings > 0) {
...
#line 1336
    stats_ruler();
#line 1337
    stats_print((char const   */* const  */)"Average", (_Bool const   )1, (stats_t const   */* const  */)((stats_t const   *)(& average)));
#line 1338
    stats_print((char const   */* const  */)"StdDev", (_Bool const   )1, (stats_t const   */* const  */)((stats_t const   *)(& stddev)));
#line 1339
    stats_ruler();
#line 1340
    stats_print((char const   */* const  */)"Minimum", (_Bool const   )1, (stats_t const   */* const  */)((stats_t const   *)(& min)));
#line 1341
    stats_print((char const   */* const  */)"Maximum", (_Bool const   )1, (stats_t const   */* const  */)((stats_t const   *)(& max)));
#line 1342
    stats_ruler();
    }
  }
