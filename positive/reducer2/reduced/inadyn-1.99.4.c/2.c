...
#line 83
  vsnprintf((char */* __restrict  */)(message), sizeof(message), (char const   */* __restrict  */)((char const   *)fmt),
            args);
#line 84
...
#line 294
    sha1((unsigned char const   *)((unsigned char *)(buffer)), tmp___0, digestbuf);
#line 295
    i = 0;
    }
    {
...
#line 565
      anychange ++;
#line 566
      strcpy((char */* __restrict  */)(info->my_ip_address.name), (char const   */* __restrict  */)((char const   *)new_ip_str));
      }
    }
#line 558
    i ++;
...
#line 663
    if ((unsigned long )p_ip != (unsigned long )((void *)0)) {
      {
#line 666
      count = sscanf((char const   */* __restrict  */)((char const   *)p_ip), (char const   */* __restrict  */)"%d.%d.%d.%d",
                     & ip1, & ip2, & ip3, & ip4);
      }
#line 667
      if (count != 4) {
...
#line 825
  code = -1;
#line 826
  sscanf((char const   */* __restrict  */)((char const   *)p_tr->p_rsp_body), (char const   */* __restrict  */)"%*s CODE=\"%d\" ",
         & code);
  }
#line 831
  if (code == 707) {
...
#line 839
  return ((enum __anonenum_RC_TYPE_59 )0);
}
}
...
#line 870
  code = -1;
#line 871
  sscanf((char const   */* __restrict  */)((char const   *)p_tr->p_rsp_body), (char const   */* __restrict  */)"%d ",
         & code);
  }
#line 875
  if (code == 304) {
...
#line 915
    tmp ++;
#line 915
    sscanf((char const   */* __restrict  */)((char const   *)tmp), (char const   */* __restrict  */)"%d=",
           & code);
    }
  }
#line 919
...
#line 1034
    if (tmp___1) {
      ...
      {
#line 1039
      fp = fopen((char const   */* __restrict  */)((char const   *)p_self->cache_file),
...
#line 1599
  fp = fopen((char const   */* __restrict  */)((char const   *)p_dyndns->pidfile),
             (char const   */* __restrict  */)"w");
  }
#line 1600
  if (! fp) {
...
#line 1608
  dyn_dns_print_hello();
#line 1615
  fp = fopen((char const   */* __restrict  */)((char const   *)p_dyndns->cache_file),
...
#line 1636
          hints.ai_protocol = 0;
#line 1638
          s = getaddrinfo((char const   */* __restrict  */)((char const   *)(p_dyndns->info[i].alias_info[0].names.name)),
...
#line 1650
            ...
            {
#line 1641
            tmp___5 = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)result___0->ai_addr),
                                  result___0->ai_addrlen, (char */* __restrict  */)(name),
                                  (socklen_t )sizeof(name), (char */* __restrict  */)((char *)((void *)0)),
                                  (socklen_t )0, 1);
            }
#line 1641
            if (! tmp___5) {
...
#line 1644
              strncpy((char */* __restrict  */)(p_dyndns->info[i].my_ip_address.name),
                      (char const   */* __restrict  */)((char const   *)(name)), sizeof(p_dyndns->info[i].my_ip_address.name));
#line 1645
...
#line 1662
        ...
        {
#line 1664
        strncpy((char */* __restrict  */)(p_dyndns->info[i].my_ip_address.name), (char const   */* __restrict  */)((char const   *)(name)),
...
#line 285
  ...
  {
#line 287
  tmp = sscanf((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
               (char const   */* __restrict  */)"%d", & p_self->dbg.level);
  }
#line 287
  if (tmp != 1) {
#line 288
...
#line 300
  tmp = sscanf((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
               (char const   */* __restrict  */)"%d", & p_self->total_iterations);
  }
#line 300
  if (tmp != 1) {
#line 301
...
#line 333
  ...
  {
#line 335
  strcpy((char */* __restrict  */)(p_self->dbg.p_logfilename), (char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)));
  }
#line 337
  return ((RC_TYPE )0);
}
...
#line 350
  strcpy((char */* __restrict  */)(p_self->info[curr_info].credentials.my_username),
         (char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)));
  }
#line 352
  return ((RC_TYPE )0);
}
...
#line 403
    memcpy((void */* __restrict  */)((void *)p_dest_name), (void const   */* __restrict  */)((void const   *)p_src),
           (size_t )len);
#line 404
    *(p_dest_name + len) = (char)0;
    ...
    {
#line 408
    strcpy((char */* __restrict  */)p_dest_name, (char const   */* __restrict  */)((char const   *)p_src));
    }
  }
#line 411
  return ((RC_TYPE )0);
...
#line 436
  ...
  {
#line 438
  strcpy((char */* __restrict  */)(p_self->info[curr_info].ip_server_url), (char const   */* __restrict  */)((char const   *)*(p_cmd->argv + (current_nr + 1))));
  }
#line 440
  return (rc);
}
...
#line 471
  ...
  {
#line 473
  strcpy((char */* __restrict  */)(p_self->info[curr_info].dyndns_server_url), (char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)));
  }
#line 475
  return ((RC_TYPE )0);
}
...
#line 509
  tmp = sscanf((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
               (char const   */* __restrict  */)"%d", & p_self->sleep_sec);
  }
#line 509
  if (tmp != 1) {
#line 510
...
#line 526
  tmp = sscanf((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
               (char const   */* __restrict  */)"%d", & p_self->normal_update_period_sec);
  }
#line 526
  if (tmp != 1) {
#line 527
...
#line 542
  tmp = sscanf((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
               (char const   */* __restrict  */)"%d", & p_self->forced_update_period_sec);
  }
#line 542
  if (tmp != 1) {
#line 543
...
#line 598
    if (tmp___1 > 0UL) {
      {
#line 598
      tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(p_gid + 1)),
                       (char const   */* __restrict  */)"%32[a-zA-Z-]", groupname);
      }
#line 598
      if (tmp___2 != 1) {
#line 600
...
#line 603
  snprintf((char */* __restrict  */)(fmt), sizeof(fmt), (char const   */* __restrict  */)"%%%ld[a-zA-Z-]",
           login_len_max);
#line 604
  tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)arg), (char const   */* __restrict  */)((char const   *)(fmt)),
                   username);
  }
#line 604
  if (tmp___3 != 1) {
...
#line 619
    ...
    {
#line 621
    s = getgrnam_r((char const   */* __restrict  */)((char const   *)(groupname)),
                   (struct group */* __restrict  */)(& grp), (char */* __restrict  */)buf,
                   (size_t )bufsize, (struct group **/* __restrict  */)(& grp_res));
    }
#line 622
...
#line 650
  ...
  {
#line 652
  s = getpwnam_r((char const   */* __restrict  */)((char const   *)username), (struct passwd */* __restrict  */)(& pwd),
...
#line 819
  ...
  {
#line 821
  memcpy((void */* __restrict  */)((void *)(p_buffer + *p_act_len)), (void const   */* __restrict  */)((void const   *)p_src),
         (size_t )src_len);
#line 822
  *p_act_len += src_len;
  }
...
#line 1041
    ...
    {
#line 1044
    p_file = fopen((char const   */* __restrict  */)((char const   *)*(p_cmd->argv + current_nr)),
                   (char const   */* __restrict  */)"r");
    }
#line 1045
    if (! p_file) {
...
#line 247
    if (ilen >= fill) {
      {
#line 249
      memcpy((void */* __restrict  */)((void *)(ctx->buffer + left)), (void const   */* __restrict  */)((void const   *)((void *)input)),
             fill);
#line 251
...
#line 146
    tmp___4 = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)(& p_self->super.remote_addr)),
                          p_self->super.remote_len, (char */* __restrict  */)(host),
                          (socklen_t )1025, (char */* __restrict  */)((char *)((void *)0)),
                          (socklen_t )0, 1);
    }
#line 146
    if (! tmp___4) {
...
#line 139
            ...
            {
#line 139
            tmp___4 = sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newact)),
...
#line 139
                  ...
                  {
#line 139
                  tmp___7 = sigaction(1, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newact)),
                                      (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
                  }
#line 139
                  if (tmp___7) {
#line 139
                    ...
                    {
#line 139
                    tmp___8 = sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newact)),
                                        (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
                    }
#line 139
                    if (tmp___8) {
#line 139
                      ...
                      {
#line 139
                      tmp___9 = sigaction(3, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newact)),
                                          (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
                      }
#line 139
                      if (tmp___9) {
#line 139
                        ...
                        {
#line 139
                        tmp___10 = sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newact)),
                                             (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
                        }
#line 139
                        if (tmp___10) {
...
#line 110
      memset((void *)(& ifr), 0, sizeof(struct ifreq ));
#line 111
      strncpy((char */* __restrict  */)(ifr.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)p_self->ifname),
              (size_t )16);
#line 112
...
#line 148
      s = getaddrinfo((char const   */* __restrict  */)p_self->p_remote_host_name,
                      (char const   */* __restrict  */)((char const   *)(port)), (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
                      (struct addrinfo **/* __restrict  */)(& result___0));
      }
#line 149
      if (s != 0) {
...
#line 154
  ...
  {
#line 156
  tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)p_tr->p_rsp),
                   (char const   */* __restrict  */)"HTTP/1.%*c %d %255[^\r\n]", & status,
                   p_tr->status_desc);
  }
#line 156
  if (tmp___2 == 2) {
...
#line 115
    ...
    {
#line 118
    strcpy((char */* __restrict  */)p, (char const   */* __restrict  */)((char const   *)p_val));
#line 119
