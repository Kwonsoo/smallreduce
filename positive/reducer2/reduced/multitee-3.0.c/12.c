...
#line 169
  ...
  {
#line 171
  tmp___0 = ralloc((unsigned int )sizeof(*s));
#line 171
  s = (schedlist )tmp___0;
  }
#line 172
...
#line 213
  tmp = ss_unschedv(os->sig, (ss_thread *)(& once), 0, 0, p);
#line 215
  (*(os->t))(os->i);
#line 216
  rfree((char *)os);
...
{ 
  ...
  {
#line 226
  tmp = ralloc((unsigned int )sizeof(struct oncestuff ));
#line 226
...
#line 534
        ...
        {
#line 536
        tmp___5 = ralloc((unsigned int )sizeof(*temp));
#line 536
...
#line 543
        if (sigs[(sp->data.sig)->u.n].r) {
          {
#line 545
          tmp___6 = ralloc((unsigned int )sizeof(*temp));
#line 545
...
#line 557
          tmp___7 = ralloc((unsigned int )sizeof(*temp));
#line 557
...
#line 569
          tmp___8 = ralloc((unsigned int )sizeof(*temp));
#line 569
...
#line 581
          tmp___9 = ralloc((unsigned int )sizeof(*temp));
#line 581
...
#line 67
  ...
  {
#line 68
  tmp = fmt_strncpy(mwre, (char *)"multitee: warning: cannot read descriptor ");
#line 68
  t = mwre + tmp;
#line 69
  tmp___0 = fmt_uint(t, (unsigned int )fd);
#line 69
  t += tmp___0;
#line 70
  *t = (char)0;
...
#line 79
  ...
  {
#line 80
  tmp = fmt_strncpy(mwwe, (char *)"multitee: warning: cannot write descriptor ");
#line 80
  t = mwwe + tmp;
#line 81
  tmp___0 = fmt_uint(t, (unsigned int )fd);
...
#line 217
  tmp = ss_sigread(fd);
#line 217
  ss_unsched(tmp, (ss_thread *)(& readit), fd);
  }
#line 218
  return;
}
...
#line 228
      tmp = ss_sigread(fd);
#line 228
      tmp___0 = ss_schedwait(tmp, (ss_thread *)(& readit), fd, 1);
      }
#line 228
      if (tmp___0 == -1) {
        {
...
#line 246
      tmp = ss_asap();
#line 246
      tmp___0 = ss_schedonce(tmp, (ss_thread *)(& readit), eof->data);
      }
#line 246
      if (tmp___0 == -1) {
        {
...
#line 258
  tmp___0 = ss_schedvwait(tmp, (ss_thread *)(& writeit), 0, 0, (ss_idptr )ioscp, 1);
  }
#line 258
  if (tmp___0 == -1) {
    {
...
#line 271
  tmp = ss_sigwrite(ioscp->out);
#line 271
  ss_unschedv(tmp, (ss_thread *)(& writeit), 0, 0, (ss_idptr )ioscp);
#line 272
  in = ioscp->in;
#line 273
  ioscp->flagsched = 0;
...
#line 305
  while (1) {
    ...
    {
#line 305
    opt = getoptmine(argc, argv, (char *)"b:vqQ");
    }
#line 305
    if (! (opt != getopteof)) {
#line 305
...
#line 322
    ...
    {
#line 309
    tmp = scan_uint(getoptarg, (unsigned int *)(& bufsize));
    }
#line 311
    goto switch_break;
    case_118: 
...
#line 328
    ...
    {
#line 330
    tmp___0 = ralloc((unsigned int )sizeof(*fdin));
#line 330
...
#line 333
    t = *argv;
#line 334
    tmp___1 = scan_uint(t, (unsigned int *)(& fdin->data));
#line 334
    t += tmp___1;
#line 335
    fdin->next = fdinhead;
...
#line 336
      ...
      {
#line 338
      tmp___2 = ralloc((unsigned int )sizeof(*op));
#line 338
      op = (opstack )tmp___2;
      }
#line 339
...
#line 343
      t ++;
#line 344
      tmp___3 = scan_uint(t, (unsigned int *)(& op->data.fd));
#line 344
      t += tmp___3;
      }
#line 347
...
#line 368
  ...
  {
#line 375
  tmp___4 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(ioscstack )));
#line 375
...
#line 377
  ...
  {
#line 378
  tmp___5 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(intstack )));
#line 378
...
#line 380
  ...
  {
#line 381
  tmp___6 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(int )));
#line 381
  fdlive = (int *)tmp___6;
  }
#line 382
...
#line 383
  ...
  {
#line 384
  tmp___7 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(int )));
#line 384
...
#line 386
  ...
  {
#line 387
  tmp___8 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(int )));
#line 387
...
#line 389
  ...
  {
#line 390
  tmp___9 = ralloc((unsigned int )((unsigned long )(fdinmax + 1) * sizeof(char *)));
#line 390
  fdbuf = (char **)tmp___9;
  }
#line 391
...
#line 402
    if (*(fdlive + fd)) {
      {
#line 403
      tmp___10 = ralloc((unsigned int )bufsize);
#line 403
      *(fdbuf + fd) = tmp___10;
      }
#line 403
...
#line 408
    iohead = iohead->next;
#line 409
    tmp___11 = ralloc((unsigned int )sizeof(*iosc));
#line 409
...
#line 425
    tmp___12 = ralloc((unsigned int )sizeof(*fdin));
#line 425
...
#line 435
      ss_schedwait(tmp___13, (ss_thread *)(& readit), fd, 1);
      }
    }
#line 433
    fd ++;
