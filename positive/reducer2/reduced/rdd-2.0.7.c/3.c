...
#line 138
  ...
  {
#line 141
  tmp = stat((char const   */* __restrict  */)((char const   *)state->path), (struct stat */* __restrict  */)(& statinfo));
  }
#line 141
  if (tmp < 0) {
#line 142
...
#line 91
  if ((unsigned long )logfp != (unsigned long )((void *)0)) {
    {
#line 95
    vfprintf((FILE */* __restrict  */)logfp, (char const   */* __restrict  */)((char const   *)fmt),
             ap);
    }
  } else
#line 96
...
#line 333
  *host = (char *)tmp___4;
#line 334
  memcpy((void */* __restrict  */)((void *)*host), (void const   */* __restrict  */)((void const   *)h),
         (size_t )hlen);
#line 335
  *(*host + hlen) = (char )'\000';
#line 337
...
#line 337
  *file = (char *)tmp___5;
#line 338
  memcpy((void */* __restrict  */)((void *)*file), (void const   */* __restrict  */)((void const   *)f),
         (size_t )flen);
#line 339
  *(*file + flen) = (char )'\000';
  }
...
#line 785
    nprinter ++;
#line 785
    airac_observe(printers, tmp___0);
#line 785
...
#line 175
  ...
  {
#line 178
  vsnprintf((char */* __restrict  */)(promptbuf), (size_t )256, (char const   */* __restrict  */)((char const   *)fmt),
            ap);
#line 179
...
#line 126
      tmp = stat((char const   */* __restrict  */)((char const   *)file->path), (struct stat */* __restrict  */)(& fileinfo));
      }
#line 126
      if (tmp < 0) {
#line 127
...
#line 138
  tmp = fwrite((void const   */* __restrict  */)((void const   *)(& checksum)), sizeof(checksum),
               (size_t )1, (FILE */* __restrict  */)state->fp);
  }
#line 138
  if (tmp < 1UL) {
#line 139
...
#line 147
    ...
    {
#line 149
    tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"%llu %lf",
                     & pos, & probability);
    }
#line 149
    if (tmp___0 != 2) {
...
#line 214
  if ((unsigned long )alignedbuf != (unsigned long )buf) {
    {
#line 215
    memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)alignedbuf),
           (size_t )*nread);
#line 216
