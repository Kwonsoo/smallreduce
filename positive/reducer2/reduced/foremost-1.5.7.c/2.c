...
#line 32
    strncat((char */* __restrict  */)s->invocation, (char const   */* __restrict  */)((char const   *)*argv_copy),
            1024UL - tmp___1);
#line 33
...
{ 
  ...
  {
#line 75
  realpath((char const   */* __restrict  */)((char const   *)fn), (char */* __restrict  */)(temp));
#line 78
...
#line 151
  snprintf((char */* __restrict  */)(fn), (size_t )1024, (char const   */* __restrict  */)"%s%c%s",
           tmp, '/', "audit.txt");
#line 158
  tmp___2 = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)"w");
#line 158
...
#line 193
  ...
  {
#line 196
  vfprintf((FILE */* __restrict  */)s->audit_file, (char const   */* __restrict  */)((char const   *)format),
           argp);
#line 197
  __builtin_va_end(argp);
#line 199
...
#line 206
  strncpy((char */* __restrict  */)s->input_file, (char const   */* __restrict  */)((char const   *)filename),
          tmp___1 + 1UL);
  }
#line 207
  return;
...
#line 219
  strcpy((char */* __restrict  */)search_spec[i].suffix, (char const   */* __restrict  */)((char const   *)suffix));
#line 221
...
#line 231
  memcpy((void */* __restrict  */)((void *)search_spec[i].header), (void const   */* __restrict  */)((void const   *)header),
         (size_t )search_spec[i].header_len);
#line 232
  memcpy((void */* __restrict  */)((void *)search_spec[i].footer), (void const   */* __restrict  */)((void const   *)footer),
         (size_t )search_spec[i].footer_len);
#line 234
  init_bm_table(search_spec[i].header, search_spec[i].header_bm_table, (size_t )search_spec[i].header_len,
                search_spec[i].case_sen, 0);
#line 239
  init_bm_table(search_spec[i].footer, search_spec[i].footer_bm_table, (size_t )search_spec[i].footer_len,
                search_spec[i].case_sen, 0);
#line 244
  (s->num_builtin) ++;
  }
...
#line 262
  memcpy((void */* __restrict  */)((void *)search_spec[index___0].markerlist[i].value),
         (void const   */* __restrict  */)((void const   *)marker___0), (size_t )search_spec[index___0].markerlist[i].len);
#line 263
  init_bm_table(search_spec[index___0].markerlist[i].value, search_spec[index___0].markerlist[i].marker_bm_table,
...
#line 770
    *(table + (int )*(needle + i)) = currentindex;
#line 771
    if (! casesensitive) {
      {
#line 778
...
#line 426
  temp = (char )'x';
#line 427
  tmp___0 = memcpy((void */* __restrict  */)((void *)bytes), (void const   */* __restrict  */)((void const   *)s),
                   sizeof(short ));
#line 427
...
#line 76
      temp[4] = (char )'\000';
#line 77
      tmp___13 = strtoul((char const   */* __restrict  */)((char const   *)(temp)),
...
#line 172
  memcpy((void */* __restrict  */)((void *)s->header), (void const   */* __restrict  */)((void const   *)*(tokenarray + 3)),
         (size_t )s->header_len);
#line 173
...
#line 174
  memcpy((void */* __restrict  */)((void *)s->footer), (void const   */* __restrict  */)((void const   *)*(tokenarray + 4)),
         (size_t )s->footer_len);
#line 176
  init_bm_table(s->header, s->header_bm_table, (size_t )s->header_len, s->case_sen,
                s->searchtype);
#line 177
  init_bm_table(s->footer, s->footer_bm_table, (size_t )s->footer_len, s->case_sen,
                s->searchtype);
  }
#line 179
  return (1);
...
#line 283
  f = fopen((char const   */* __restrict  */)((char const   *)tmp___4), (char const   */* __restrict  */)"r");
  }
#line 283
...
#line 293
    f = fopen((char const   */* __restrict  */)((char const   *)tmp___3), (char const   */* __restrict  */)"r");
    }
#line 293
    if ((unsigned long )f == (unsigned long )((void *)0)) {
      {
...
#line 41
  tmp___0 = fread((void */* __restrict  */)((void *)newbuf), (size_t )1, (size_t )length,
...
#line 95
        if (pos < haystack_len) {
#line 95
          shift = *(table + (int )*(haystack + ((haystack_len - pos) - 1UL)));
#line 95
          if (! (shift > 0UL)) {
#line 95
...
#line 406
        foundat = bm_search(needle->header, (size_t )needle->header_len, foundat,
                            (size_t )current_buflen, needle->header_bm_table, needle->case_sen,
                            0);
#line 414
        header_pos = foundat;
        }
...
#line 493
              memcpy((void */* __restrict  */)((void *)extractbuf), (void const   */* __restrict  */)((void const   *)header_pos),
                     (size_t )file_size);
#line 494
...
#line 577
  while (1) {
    ...
    {
#line 577
    tmp___1 = fread((void */* __restrict  */)((void *)buf), (size_t )1, (size_t )chunk_size,
                    (FILE */* __restrict  */)i->handle);
#line 577
...
#line 644
  i = (f_info *)tmp;
#line 647
  tmp___2 = realpath((char const   */* __restrict  */)((char const   *)s->input_file),
...
#line 655
  audit_start(s, i);
#line 662
  i->handle = fopen64((char const   */* __restrict  */)((char const   *)i->file_name),
...
#line 21
int dir_count ;
#line 22 "/home/june/repo/benchmarks/collector/temp/foremost-1.5.7/extract.c"
int block_list[512UL / sizeof(int )]  ;
#line 23 "/home/june/repo/benchmarks/collector/temp/foremost-1.5.7/extract.c"
int *FAT  ;
#line 26 "/home/june/repo/benchmarks/collector/temp/foremost-1.5.7/extract.c"
int FATblk  ;
#line 27
int highblk ;
...
#line 73
          strcat((char */* __restrict  */)(needle->comment), (char const   */* __restrict  */)((char const   *)(comment)));
#line 74
...
#line 224
  foundat = bm_search(needle->footer, (size_t )needle->footer_len, foundat, (size_t )bytes_to_search,
                      needle->footer_bm_table, needle->case_sen, 0);
  }
#line 235
  if (foundat) {
#line 242
...
#line 326
    foundat = bm_search(needle->markerlist[1].value, (size_t )needle->markerlist[1].len,
                        foundat, (size_t )100, needle->markerlist[1].marker_bm_table,
                        needle->case_sen, 0);
    }
#line 334
    if (! foundat) {
...
#line 345
    foundat = bm_search(needle->markerlist[2].value, (size_t )needle->markerlist[2].len,
                        foundat, (size_t )512, needle->markerlist[2].marker_bm_table,
                        needle->case_sen, 0);
    }
#line 353
    if (foundat) {
...
#line 355
      foundat = bm_search(needle->markerlist[0].value, (size_t )needle->markerlist[0].len,
                          foundat, (size_t )512, needle->markerlist[0].marker_bm_table,
                          needle->case_sen, 0);
      }
    }
  }
...
#line 378
    tmp___0 = memcpy((void */* __restrict  */)((void *)tempsize), (void const   */* __restrict  */)((void const   *)foundat),
                     (size_t )8);
#line 378
...
#line 520
  foundat = bm_search(needle->markerlist[0].value, (size_t )needle->markerlist[0].len,
                      header, (size_t )file_size, needle->markerlist[0].marker_bm_table,
                      1, 0);
  }
#line 527
  if (foundat) {
...
#line 767
  p = (unsigned char *)FAT;
#line 768
  memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)(h + 1)),
         (size_t )436);
  }
#line 769
  if (next_FAT_block > 0) {
...
#line 1510
    foundat = bm_search(needle->markerlist[0].value, (size_t )needle->markerlist[0].len,
                        foundat, (size_t )bytes_to_search, needle->markerlist[0].marker_bm_table,
                        needle->case_sen, 0);
    }
#line 1518
    if (foundat) {
...
#line 2146
  chop(ascii_time);
#line 2148
  sprintf((char */* __restrict  */)(comment), (char const   */* __restrict  */)((char const   *)(ascii_time)));
#line 2149
  strcat((char */* __restrict  */)(needle->comment), (char const   */* __restrict  */)((char const   *)(comment)));
#line 2150
...
#line 34
    strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___0));
#line 35
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 36
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(entry->d_name)));
#line 37
...
#line 118
    tmp = get_output_directory(s);
#line 118
    strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp));
#line 119
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"_");
#line 120
    tmp___0 = get_start_time(s);
#line 120
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___0));
#line 121
...
#line 182
    strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___4));
#line 183
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 184
    strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)search_spec[i].suffix));
#line 185
...
#line 195
        tmp___6 = get_output_directory(s);
#line 195
        strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___6));
#line 196
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 197
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(ole_types[j])));
#line 198
        make_new_directory(s, dir_name);
        }
        __Cont: 
...
#line 213
              tmp___8 = get_output_directory(s);
#line 213
              strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___8));
#line 214
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 215
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(ole_types[j])));
...
#line 227
      strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___11));
#line 228
      strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 229
...
#line 240
        strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___13));
#line 241
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 242
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(riff_types[j])));
#line 243
        make_new_directory(s, dir_name);
        }
        __Cont___1: 
...
#line 258
              strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___15));
#line 259
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 260
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(riff_types[j])));
...
#line 277
        strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___19));
#line 278
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 279
        strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(zip_types[j])));
#line 280
        make_new_directory(s, dir_name);
        }
        __Cont___3: 
...
#line 295
              strcpy((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)tmp___21));
#line 296
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)"/");
#line 297
              strcat((char */* __restrict  */)(dir_name), (char const   */* __restrict  */)((char const   *)(zip_types[j])));
...
#line 352
  test = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)"r");
  }
  {
#line 353
  while (1) {
...
#line 373
  ...
  {
#line 376
  tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)buf), sizeof(char ),
                   (size_t )len, (FILE */* __restrict  */)f);
#line 376
...
{ 
  ...
  {
#line 60
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)fmt),
          arg);
#line 61
  exit(1);
  }
...
#line 273
    ...
    {
#line 275
    testFile = fopen((char const   */* __restrict  */)((char const   *)*argv), (char const   */* __restrict  */)"rb");
    }
#line 276
    if (testFile) {
      {
