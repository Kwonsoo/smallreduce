...
#line 15
  caml__dummy_v_s = 0;
#line 17
  tmp = realpath((char const   */* __restrict  */)((char const   *)((char *)v_path)),
...
#line 70
  vret = caml_alloc_custom(& ssi_ops, sizeof(struct signalfd_siginfo ), (mlsize_t )0,
                           (mlsize_t )1);
#line 71
  memcpy((void */* __restrict  */)((void *)((value *)vret + 1)), (void const   */* __restrict  */)((void const   *)(& ssi)),
...
#line 58
  off = (size_t )(v_off >> 1);
#line 58
  memcpy((void */* __restrict  */)((void *)(& x)), (void const   */* __restrict  */)((void const   *)(str + off)),
         sizeof(x));
#line 58
  __x = x;
#line 58
...
#line 67
  x = __v;
#line 67
  memcpy((void */* __restrict  */)((void *)(str + off)), (void const   */* __restrict  */)((void const   *)(& x)),
         sizeof(x));
  }
#line 67
  return (1L);
...
#line 69
  flags &= 2304;
#line 71
  strcpy((char */* __restrict  */)p, (char const   */* __restrict  */)((char const   *)((char *)v_name)));
#line 72
  caml_enter_blocking_section();
#line 73
  ret = fstatat((int )(v_dirfd >> 1), (char const   */* __restrict  */)((char const   *)p),
                (struct stat */* __restrict  */)(& buf), flags);
#line 74
  caml_leave_blocking_section();
#line 75
...
#line 141
  p = (char *)tmp___0;
#line 142
  strcpy((char */* __restrict  */)p, (char const   */* __restrict  */)((char const   *)((char *)path)));
#line 144
  caml_enter_blocking_section();
#line 145
...
#line 188
    ...
    {
#line 190
    memcpy((void */* __restrict  */)((void *)((char *)v_buf + ofs)), (void const   */* __restrict  */)((void const   *)(iobuf)),
           (size_t )ret);
#line 191
...
#line 264
    numbytes = tmp;
#line 265
    memcpy((void */* __restrict  */)((void *)(iobuf)), (void const   */* __restrict  */)((void const   *)((char *)v_buf + ofs)),
           numbytes);
#line 266
    caml_enter_blocking_section();
#line 267
...
#line 49
  tmp = strptime((char const   */* __restrict  */)((char const   *)((char *)v_s)),
                 (char const   */* __restrict  */)((char const   *)((char *)v_fmt)),
                 & tm);
  }
#line 49
...
#line 61
  fill_tm(& tm, v_t);
#line 62
  tmp = asctime_r((struct tm  const  */* __restrict  */)((struct tm  const  *)(& tm)),
                  (char */* __restrict  */)(buf));
  }
#line 62
  if ((unsigned long )((void *)0) == (unsigned long )tmp) {
...
#line 72
  fill_tm(& tm, v_t);
#line 73
  tmp = strftime((char */* __restrict  */)(buf), sizeof(buf), (char const   */* __restrict  */)((char const   *)((char *)v_fmt)),
...
#line 14
  str = (char *)v_str;
#line 15
  memcpy((void */* __restrict  */)((void *)str), (void const   */* __restrict  */)((void const   *)(buf + off)),
         len);
  }
  {
#line 16
...
#line 25
  str = (char *)v_str;
#line 26
  memcpy((void */* __restrict  */)((void *)(buf + off)), (void const   */* __restrict  */)((void const   *)str),
         len);
  }
  {
#line 27
...
#line 15
  fd = (int )(fd_val >> 1);
#line 17
  tmp = getsockopt(fd, 1, 17, (void */* __restrict  */)((void *)(& crd)), (socklen_t */* __restrict  */)(& crdlen));
  }
#line 17
  if (tmp == -1) {
    {
...
#line 36
  off = (size_t )(v_off >> 1);
#line 36
  memcpy((void */* __restrict  */)((void *)(& x)), (void const   */* __restrict  */)((void const   *)(buf + off)),
         sizeof(x));
#line 36
  __x = x;
#line 36
...
#line 45
  x = __v;
#line 45
  memcpy((void */* __restrict  */)((void *)(buf + off)), (void const   */* __restrict  */)((void const   *)(& x)),
         sizeof(x));
  }
#line 45
  return (1L);
...
#line 30
  caml__dummy_v_path = 0;
#line 33
  tmp = statvfs((char const   */* __restrict  */)((char const   *)((char *)v_path)),
                (struct statvfs */* __restrict  */)(& s));
  }
#line 33
  if (0 != tmp) {
    {
...
#line 32
  if (sendfd_val != 1L) {
#line 33
    sendfd___1 = (int )(*((value *)sendfd_val + 0) >> 1);
#line 41
    msg.msg_control = (void *)(control_un.control);
#line 42
    msg.msg_controllen = (((sizeof(struct cmsghdr ) + sizeof(size_t )) - 1UL) & ~ (sizeof(size_t ) - 1UL)) + sizeof(sendfd___1);
#line 44
...
#line 45
    cmsgp->cmsg_len = (((sizeof(struct cmsghdr ) + sizeof(size_t )) - 1UL) & ~ (sizeof(size_t ) - 1UL)) + sizeof(sendfd___1);
#line 46
    cmsgp->cmsg_level = 1;
#line 47
    cmsgp->cmsg_type = 1;
#line 48
    *((int *)((unsigned char *)(cmsgp + 1))) = sendfd___1;
  }
  {
#line 55
...
#line 56
  buf = (char *)tmp;
#line 57
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)((char *)data_val)),
         datalen);
#line 58
...
#line 95
  msg.msg_control = (void *)(control_un.control);
#line 96
  msg.msg_controllen = (((sizeof(struct cmsghdr ) + sizeof(size_t )) - 1UL) & ~ (sizeof(size_t ) - 1UL)) + sizeof(recvfd___1);
#line 102
  iov[0].iov_base = (void *)(buf);
#line 103
...
#line 122
    if (cmsgp->cmsg_len != (((sizeof(struct cmsghdr ) + sizeof(size_t )) - 1UL) & ~ (sizeof(size_t ) - 1UL)) + sizeof(recvfd___1)) {
      {
#line 123
...
#line 41
  memcpy((void */* __restrict  */)((void *)((char *)v_s)), (void const   */* __restrict  */)((void const   *)buf),
         size);
#line 42
  free((void *)buf);
  }
