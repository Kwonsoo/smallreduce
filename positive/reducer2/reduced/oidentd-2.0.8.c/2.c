...
#line 53 "/home/wheatley/newnew/temp/oidentd-2.0.8/src/os.c"
...
#line 132
    ...
    {
#line 143
    ret = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*d: %8x%8x%8x%8x:%x %8x%8x%8x%8x:%x %*x %*X:%*X %*x:%*X %*x %d %*d %lu",
...
#line 220
    ...
    {
#line 229
    ret = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*d: %x:%x %x:%x %*x %*x:%*x %*x:%*x %*x %d %*d %u",
...
#line 330
    if (! netfilter) {
      {
#line 335
      ret = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%15s %X:%X %X:%X %X %*X %*d %*d %*u",
...
#line 344
      ...
      {
#line 354
      ret = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%15s %*d %*d ESTABLISHED src=%d.%d.%d.%d dst=%d.%d.%d.%d sport=%d dport=%d src=%d.%d.%d.%d dst=%d.%d.%d.%d sport=%d dport=%d",
...
#line 361
      if (ret != 21) {
        {
#line 362
        ret = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%15s %*d %*d ESTABLISHED src=%d.%d.%d.%d dst=%d.%d.%d.%d sport=%d dport=%d packets=%*d bytes=%*d src=%d.%d.%d.%d dst=%d.%d.%d.%d sport=%d dport=%d",
                     proto, & l1, & l2, & l3, & l4, & r1, & r2, & r3, & r4, & masq_lport_temp___0,
                     & masq_fport_temp___0, & nl1, & nl2, & nl3, & nl4, & nr1, & nr2,
                     & nr3, & nr4, & nport_temp, & mport_temp___0);
        }
...
#line 484
  memcpy((void */* __restrict  */)((void *)(& req.r.id.tcpdiag_dst)), (void const   */* __restrict  */)((void const   *)tmp___0),
         addr_len);
#line 485
  tmp___1 = sin_addr(src_addr);
#line 485
  memcpy((void */* __restrict  */)((void *)(& req.r.id.tcpdiag_src)), (void const   */* __restrict  */)((void const   *)tmp___1),
         addr_len);
#line 486
...
#line 155
    ret = select(*(listen_fds + (fdlen - 1UL)) + 1, (fd_set */* __restrict  */)(& rfds),
                 (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 160
        if ((rfds.fds_bits[*(listen_fds + i) / (8 * (int )sizeof(__fd_mask ))] & (1L << *(listen_fds + i) % (8 * (int )sizeof(__fd_mask )))) != 0L) {
          {
#line 163
          connectfd = accept(*(listen_fds + i), (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
...
#line 257
  ...
  {
#line 259
  len = sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"%d , %d",
...
#line 205
  ...
  {
#line 208
  fp = fopen((char const   */* __restrict  */)((char const   *)path), (char const   */* __restrict  */)"r");
  }
#line 209
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
...
#line 156
    ...
    {
#line 158
    tmp___2 = get_addr((char const   */* const  */)((char const   *)p), & stemp);
    }
#line 158
    if (tmp___2 == -1) {
      {
...
#line 165
      if ((unsigned long )temp != (unsigned long )((void *)0)) {
        {
#line 169
        tmp___3 = strtoul((char const   */* __restrict  */)((char const   *)temp),
...
#line 171
        if ((int )*end != 0) {
          {
#line 172
          tmp___4 = get_addr((char const   */* const  */)((char const   *)temp), & stemp);
          }
#line 172
          if (tmp___4 == -1) {
            {
...
#line 300
  get_ip(mrelay, ipbuf, sizeof(ipbuf));
#line 302
  tmp___5 = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*d , %*d : USERID :%*[^:]:%511s",
                   user);
  }
#line 302
  if (tmp___5 != 1) {
...
#line 223
    ...
    {
#line 227
    tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)(yytext + 1)),
...
#line 246
    ...
    {
#line 250
    tmp___5 = strtoul((char const   */* __restrict  */)((char const   *)(yytext + 2)),
...
#line 203
  tmp___7 = get_addr((char const   */* const  */)((char const   *)(yyvsp + 0)->string),
                     cur_cap->dest);
  }
#line 203
  if (tmp___7 == -1) {
...
#line 239
  tmp___11 = get_addr((char const   */* const  */)((char const   *)(yyvsp + 0)->string),
                      cur_cap->src);
  }
#line 239
  if (tmp___11 == -1) {
...
#line 74
  ...
  {
#line 77
  ret = bind(listenfd, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)ai->ai_addr),
...
#line 118
    memcpy((void */* __restrict  */)((void *)cur->ai_addr), (void const   */* __restrict  */)((void const   *)listen_addr),
...
#line 138
  hints.ai_socktype = 1;
#line 140
  snprintf((char */* __restrict  */)((char *)(listen_port_str)), sizeof(listen_port_str),
           (char const   */* __restrict  */)"%d", (int )listen_port___0);
#line 142
  ret = getaddrinfo((char const   */* __restrict  */)((char const   *)((void *)0)),
                    (char const   */* __restrict  */)((char const   *)(listen_port_str)),
...
{ 
  ...
  {
#line 269
  ret = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)addr___0)),
                    (socklen_t )sizeof(struct sockaddr_storage ), (char */* __restrict  */)hostbuf,
                    (socklen_t )len, (char */* __restrict  */)((char *)((void *)0)),
                    (socklen_t )0, 8);
  }
#line 272
  return (ret);
...
{ 
  ...
  {
#line 311
  tmp = getaddrinfo((char const   */* __restrict  */)((char const   *)hostname), (char const   */* __restrict  */)((char const   *)((void *)0)),
...
#line 328
  ...
  {
#line 330
  memcpy((void */* __restrict  */)((void *)addr___0), (void const   */* __restrict  */)((void const   *)res->ai_addr),
...
#line 362
  tmp = sin_addr(ss);
#line 362
  inet_ntop((int )ss->ss_family, (void const   */* __restrict  */)((void const   *)tmp),
...
#line 387
  memcpy((void */* __restrict  */)((void *)(& ((struct sockaddr_in *)ss)->sin_addr)),
         (void const   */* __restrict  */)((void const   *)(& addr___0)), sizeof(struct sockaddr_in ));
  }
#line 388
  return;
}
...
#line 406
  memcpy((void */* __restrict  */)((void *)(& ((struct sockaddr_in6 *)ss)->sin6_addr)),
         (void const   */* __restrict  */)((void const   *)sin6), sizeof(struct sockaddr_in6 ));
  }
#line 407
  return;
}
...
#line 446
  tmp = sin_len(ss2);
#line 446
  memcpy((void */* __restrict  */)((void *)ss1), (void const   */* __restrict  */)((void const   *)ss2),
         tmp);
  }
#line 447
  return;
...
{ 
  ...
  {
#line 497
  memcpy((void */* __restrict  */)((void *)in4), (void const   */* __restrict  */)((void const   *)((char *)in6 + 12)),
...
#line 154
    tmp___2 = get_addr((char const   */* const  */)((char const   *)optarg), temp_ss);
    }
#line 154
    if (tmp___2 == -1) {
      {
...
#line 206
    ...
    {
#line 211
    tmp___4 = get_addr((char const   */* const  */)((char const   *)optarg), & proxy);
    }
#line 211
    if (tmp___4 == -1) {
      {
...
#line 236
    ...
    {
#line 243
    tmp___6 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end),
                      10);
#line 243
...
#line 292
    ...
    {
#line 298
    tmp___8 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end___0),
                      10);
#line 298
