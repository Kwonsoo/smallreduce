...
#line 156
    strcpy((char */* __restrict  */)((char *)(object->op_or)), (char const   */* __restrict  */)"|");
#line 157
    strcpy((char */* __restrict  */)((char *)(object->op_nest_in)), (char const   */* __restrict  */)"(");
#line 158
    strcpy((char */* __restrict  */)((char *)(object->op_nest_out)), (char const   */* __restrict  */)")");
#line 159
    strcpy((char */* __restrict  */)((char *)(object->op_select_in)), (char const   */* __restrict  */)"[");
#line 160
    strcpy((char */* __restrict  */)((char *)(object->op_select_out)), (char const   */* __restrict  */)"]");
#line 161
    strcpy((char */* __restrict  */)((char *)(object->op_newline)), (char const   */* __restrict  */)"");
    }
  }
#line 163
  return (object);
...
#line 386
  ...
  {
#line 387
  strcpy((char */* __restrict  */)((char *)dest), (char const   */* __restrict  */)((char const   *)op));
  }
#line 389
  return (0);
}
...
#line 379
  fp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rt");
  }
#line 379
...
#line 185
      cache_ptr = cache;
#line 186
      tmp = fread((void */* __restrict  */)((void *)(cache)), (size_t )1, (size_t )16384,
                  (FILE */* __restrict  */)fp);
#line 186
...
#line 385
  ...
  {
#line 386
  memcpy((void */* __restrict  */)((void *)buf___1), (void const   */* __restrict  */)((void const   *)query),
         (size_t )len);
#line 387
...
#line 395
        if ((int )*(buf___1 + (len - 1)) == 110) {
          {
#line 398
          memcpy((void */* __restrict  */)((void *)(buf___1 + (len - 1))), (void const   */* __restrict  */)((void const   *)"xn"),
                 (size_t )2);
#line 399
...
#line 405
          memcpy((void */* __restrict  */)((void *)(buf___1 + (len - 1))), (void const   */* __restrict  */)((void const   *)"xtu"),
                 (size_t )3);
#line 406
...
#line 485
          *(lower + i) = (unsigned char )tmp___1;
          ...
          {
#line 487
          memcpy((void */* __restrict  */)((void *)(lower + i)), (void const   */* __restrict  */)((void const   *)(query + i)),
                 (size_t )step);
          }
        }
      } else {
...
#line 127
    ...
    {
#line 128
    memcpy((void */* __restrict  */)((void *)(p->buf + p->last)), (void const   */* __restrict  */)((void const   *)sz),
           (size_t )(len + 1));
#line 129
    p->last += len;
    }
...
#line 306
  if ((unsigned long )fp != (unsigned long )((void *)0)) {
    {
#line 309
    tmp = fread((void */* __restrict  */)((void *)(buf___1)), sizeof(buf___1[0]),
                sizeof(buf___1), (FILE */* __restrict  */)fp);
#line 309
    len = tmp;
#line 310
    fclose(fp);
...
#line 33
        memcpy((void */* __restrict  */)((void *)p->ptr), (void const   */* __restrict  */)((void const   *)ptr),
               (size_t )len);
#line 34
...
#line 32
    ...
    {
#line 34
    tmp = fgets((char */* __restrict  */)((char *)(buf___1)), (int )sizeof(buf___1),
