...
#line 163
          memcpy((void */* __restrict  */)((void *)recptr->u), (void const   */* __restrict  */)((void const   *)u),
                 sizeof(struct utmpx ));
#line 165
...
#line 240
          hname = (char *)tmp___1;
#line 241
          memcpy((void */* __restrict  */)((void *)hname), (void const   */* __restrict  */)((void const   *)((bud->u)->ut_host)),
                 (size_t )h_len);
#line 243
...
#line 258
            ...
            {
#line 260
            memcpy((void */* __restrict  */)((void *)(& in)), (void const   */* __restrict  */)((void const   *)*(hent->h_addr_list + 0)),
...
#line 8
  strncat((char */* __restrict  */)totalpath, (char const   */* __restrict  */)((char const   *)path),
          tmp___3 + 1UL);
#line 9
...
#line 151
        strncpy((char */* __restrict  */)conf->infile, (char const   */* __restrict  */)((char const   *)homedir),
                tmp___6 + 1UL);
#line 152
...
#line 285
    strncpy((char */* __restrict  */)g_config.whoami, (char const   */* __restrict  */)((char const   *)pwd->pw_name),
            tmp___5 + 1UL);
    }
  }
#line 287
