...
#line 429
  s.canonname_len = cnl;
#line 431
  memcpy((void */* __restrict  */)((void *)((uint8_t *)p)), (void const   */* __restrict  */)((void const   *)(& s)),
         sizeof(addrinfo_serialization_t ));
#line 432
  memcpy((void */* __restrict  */)((void *)((uint8_t *)p + sizeof(addrinfo_serialization_t ))),
         (void const   */* __restrict  */)((void const   *)ai->ai_addr), (size_t )ai->ai_addrlen);
  }
#line 434
  if (ai->ai_canonname) {
    {
#line 435
    strcpy((char */* __restrict  */)(((char *)p + sizeof(addrinfo_serialization_t )) + ai->ai_addrlen),
           (char const   */* __restrict  */)((char const   *)ai->ai_canonname));
    }
  }
#line 437
  *length += l;
...
#line 495
  if (host) {
    {
#line 496
    memcpy((void */* __restrict  */)((void *)((uint8_t *)(data) + sizeof(nameinfo_response_t ))),
           (void const   */* __restrict  */)((void const   *)host), hl);
    }
  }
#line 498
  if (serv) {
    {
#line 499
    memcpy((void */* __restrict  */)((void *)(((uint8_t *)(data) + sizeof(nameinfo_response_t )) + hl)),
           (void const   */* __restrict  */)((void const   *)serv), sl);
    }
  }
  {
#line 501
...
#line 520
  if (ret > 0) {
    {
#line 521
    memcpy((void */* __restrict  */)((void *)((uint8_t *)(data) + sizeof(res_response_t ))),
           (void const   */* __restrict  */)((void const   *)answer), (size_t )ret);
    }
  }
  {
#line 523
...
#line 555
  ret = getaddrinfo((char const   */* __restrict  */)node, (char const   */* __restrict  */)service,
                    (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)tmp),
...
#line 570
  ...
  {
#line 572
  memcpy((void */* __restrict  */)((void *)(& sa)), (void const   */* __restrict  */)((void const   *)((uint8_t const   *)ni_req + sizeof(nameinfo_request_t ))),
...
#line 574
  ...
  {
#line 574
  ret___0 = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& sa))),
...
#line 733
  sigfillset(& fullset);
#line 734
  pthread_sigmask(0, (__sigset_t const   */* __restrict  */)((__sigset_t const   *)(& fullset)),
...
#line 784
  tmp___1 = socketpair(1, 2, 0, asyncns->fds);
  }
#line 784
  if (tmp___1 < 0) {
#line 786
    ...
    {
#line 784
    tmp___2 = socketpair(1, 2, 0, asyncns->fds + 2);
    }
#line 784
    if (tmp___2 < 0) {
#line 786
...
#line 809
    r = pthread_create((pthread_t */* __restrict  */)(& asyncns->workers[asyncns->valid_workers]),
                       ...
                       & thread_worker, (void */* __restrict  */)((void *)asyncns));
    }
#line 809
    if (r != 0) {
      {
...
#line 931
  ...
  {
#line 933
  memcpy((void */* __restrict  */)((void *)(& s)), (void const   */* __restrict  */)p,
         sizeof(s));
#line 935
...
#line 958
  if (ai->ai_addr) {
    {
#line 959
    memcpy((void */* __restrict  */)((void *)ai->ai_addr), (void const   */* __restrict  */)((void const   *)((uint8_t const   *)p + sizeof(addrinfo_serialization_t ))),
           s.ai_addrlen);
    }
  }
#line 961
  if (ai->ai_canonname) {
    {
#line 962
    memcpy((void */* __restrict  */)((void *)ai->ai_canonname), (void const   */* __restrict  */)((void const   *)(((uint8_t const   *)p + sizeof(addrinfo_serialization_t )) + s.ai_addrlen)),
           s.canonname_len);
    }
  }
#line 964
...
#line 1066
    if (tmp___1) {
      {
#line 1070
      memcpy((void */* __restrict  */)((void *)q->serv), (void const   */* __restrict  */)((void const   *)((char const   *)resp + sizeof(res_response_t ))),
             (size_t )res_resp->ret);
      }
    } else {
#line 1067
...
#line 1109
      tmp___1 = select(asyncns->fds[2] + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 1277
  req->getserv = getserv;
#line 1279
  memcpy((void */* __restrict  */)((void *)((uint8_t *)req + sizeof(nameinfo_request_t ))),
         (void const   */* __restrict  */)((void const   *)sa), (size_t )salen);
#line 1281
...
#line 1310
    if (q->host) {
      {
#line 1311
      strncpy((char */* __restrict  */)ret_host, (char const   */* __restrict  */)((char const   *)q->host),
              hostlen);
#line 1312
...
#line 1315
    if (q->serv) {
      {
#line 1316
      strncpy((char */* __restrict  */)ret_serv, (char const   */* __restrict  */)((char const   *)q->serv),
              servlen);
#line 1317
