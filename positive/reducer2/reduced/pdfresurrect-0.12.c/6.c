...
#line 75
  new_fp = fopen((char const   */* __restrict  */)((char const   *)new_fname), (char const   */* __restrict  */)"w");
  }
#line 75
  if (! new_fp) {
    {
...
#line 85
  while (1) {
    ...
    {
#line 85
    tmp___4 = fread((void */* __restrict  */)((void *)(& data)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)fp);
    }
#line 85
    if (! tmp___4) {
...
#line 100
  tmp___7 = fread((void */* __restrict  */)((void *)xref_buf), (size_t )(end - xref->start),
...
#line 113
  tmp___8 = fwrite((void const   */* __restrict  */)((void const   *)xref_buf), (size_t )(end - xref->start),
                   (size_t )1, (FILE */* __restrict  */)new_fp);
  }
#line 113
  if (! tmp___8) {
...
#line 140
  ...
  {
#line 143
  strcpy((char */* __restrict  */)new_name, (char const   */* __restrict  */)((char const   *)pdf->name));
#line 144
...
#line 148
  new_fp = fopen((char const   */* __restrict  */)((char const   *)new_name), (char const   */* __restrict  */)"r");
  }
#line 148
  if (new_fp) {
    {
...
#line 153
  ...
  {
#line 156
  new_fp = fopen((char const   */* __restrict  */)((char const   *)new_name), (char const   */* __restrict  */)"w+");
  }
#line 156
  if (! new_fp) {
    {
...
#line 214
    fread((void */* __restrict  */)((void *)(buf___0)), (size_t )1, (size_t )pos_count,
          (FILE */* __restrict  */)fp);
#line 215
    c = buf___0;
    }
...
#line 289
        fread((void */* __restrict  */)((void *)buf___0), (size_t )1, (size_t )sz,
              (FILE */* __restrict  */)fp);
#line 290
        *(buf___0 + sz) = (char )'\000';
#line 291
...
#line 425
    dst = fopen((char const   */* __restrict  */)((char const   *)dst_name), (char const   */* __restrict  */)"w");
    }
#line 425
    if (! dst) {
      {
...
#line 610
  ...
  {
#line 612
  fread((void */* __restrict  */)((void *)(buf___0)), (size_t )1, (size_t )21, (FILE */* __restrict  */)fp);
#line 613
  tmp___4 = strlen("ize ");
#line 613
...
#line 698
      ...
      {
#line 698
      tmp___4 = fread((void */* __restrict  */)((void *)(buf___0)), (size_t )1, (size_t )8,
                      (FILE */* __restrict  */)fp);
      }
#line 698
      if (! tmp___4) {
...
#line 771
  memcpy((void */* __restrict  */)((void *)daddy), (void const   */* __restrict  */)((void const   *)(creator_template)),
...
#line 956
    ...
    {
#line 957
    strncpy((char */* __restrict  */)((info + i)->value), (char const   */* __restrict  */)((char const   *)start),
            (size_t )length);
#line 958
...
#line 973
      strncpy((char */* __restrict  */)((info + i)->value), (char const   */* __restrict  */)((char const   *)ascii),
              tmp___2);
#line 974
      free((void *)ascii);
      }
...
#line 997
  fread((void */* __restrict  */)((void *)(buf___0)), (size_t )255, (size_t )1, (FILE */* __restrict  */)fp);
#line 998
  obj_id = atoi((char const   *)(buf___0));
  }
#line 998
...
#line 1065
  while (1) {
    ...
    {
#line 1065
    tmp___5 = fread((void */* __restrict  */)((void *)(data + total_sz)), (size_t )1,
                    (size_t )(blk_sz - 1), (FILE */* __restrict  */)fp);
#line 1065
    read_sz = (int )tmp___5;
    }
#line 1065
...
#line 1198
  ...
  {
#line 1198
  memcpy((void */* __restrict  */)((void *)(buf)), (void const   */* __restrict  */)((void const   *)c),
         tmp___3);
#line 1199
  c = buf;
  }
...
#line 1235
  fseek(fp, 0L, 0);
#line 1236
  fread((void */* __restrict  */)((void *)header), (size_t )1023, (size_t )1, (FILE */* __restrict  */)fp);
#line 1237
  fseek(fp, start, 0);
  }
#line 1239
...
#line 1282
    ascii_idx ++;
#line 1282
    tmp___8 = strtol((char const   */* __restrict  */)((char const   *)(hex_buf)),
