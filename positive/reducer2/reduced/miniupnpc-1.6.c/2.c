...
#line 20
  ...
  {
#line 21
  memcpy((void */* __restrict  */)((void *)(data___2->curelt)), (void const   */* __restrict  */)((void const   *)name),
         (size_t )l);
#line 22
...
#line 37
    ...
    {
#line 39
    memcpy((void */* __restrict  */)((void *)data___2->portListing), (void const   */* __restrict  */)((void const   *)datas),
           (size_t )l);
#line 40
...
#line 48
    ...
    {
#line 49
    strncpy((char */* __restrict  */)(nv->name), (char const   */* __restrict  */)((char const   *)(data___2->curelt)),
            (size_t )64);
#line 50
    nv->name[63] = (char )'\000';
#line 51
    memcpy((void */* __restrict  */)((void *)(nv->value)), (void const   */* __restrict  */)((void const   *)datas),
           (size_t )l);
#line 52
    nv->value[l] = (char )'\000';
    }
...
#line 19
  ...
  {
#line 20
  memcpy((void */* __restrict  */)((void *)(datas->cureltname)), (void const   */* __restrict  */)((void const   *)name),
         (size_t )l);
#line 21
...
#line 48
      if (0 == tmp___2) {
        {
#line 50
        memcpy((void */* __restrict  */)((void *)(& datas->CIF)), (void const   */* __restrict  */)((void const   *)(& datas->tmp)),
...
#line 51
        if (0 == tmp___1) {
          {
#line 53
          memcpy((void */* __restrict  */)((void *)(& datas->IPv6FC)), (void const   */* __restrict  */)((void const   *)(& datas->tmp)),
                 sizeof(struct IGDdatas_service ));
          }
        } else {
          {
...
#line 58
              if ((int )datas->first.servicetype[0] == 0) {
                {
#line 59
                memcpy((void */* __restrict  */)((void *)(& datas->first)), (void const   */* __restrict  */)((void const   *)(& datas->tmp)),
                       sizeof(struct IGDdatas_service ));
                }
              } else {
                {
#line 61
                memcpy((void */* __restrict  */)((void *)(& datas->second)), (void const   */* __restrict  */)((void const   *)(& datas->tmp)),
                       sizeof(struct IGDdatas_service ));
                }
              }
            }
...
#line 92
    ...
    {
#line 93
    memcpy((void */* __restrict  */)((void *)dstmember), (void const   */* __restrict  */)((void const   *)data___2),
           (size_t )l);
#line 94
...
#line 81
  ...
  {
#line 83
  memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)devtype),
         (size_t )stsize);
#line 84
  p += stsize;
#line 85
...
#line 116
    memcpy((void */* __restrict  */)((void *)(tmp->buffer)), (void const   */* __restrict  */)((void const   *)url),
           (size_t )urlsize);
#line 117
    tmp->buffer[urlsize] = (char )'\000';
#line 118
    memcpy((void */* __restrict  */)((void *)((tmp->buffer + urlsize) + 1)), (void const   */* __restrict  */)((void const   *)p),
           (size_t )stsize);
#line 119
    p += stsize;
#line 120
...
#line 569
      rv = getaddrinfo((char const   */* __restrict  */)tmp___12, (char const   */* __restrict  */)"1900",
                       ...
                       (struct addrinfo **/* __restrict  */)(& servinfo));
      }
#line 569
      if (rv != 0) {
#line 573
...
#line 653
          tmp->st = (tmp->buffer + 1) + urlsize;
#line 654
          memcpy((void */* __restrict  */)((void *)(tmp->buffer)), (void const   */* __restrict  */)((void const   *)descURL),
                 (size_t )urlsize);
#line 655
          tmp->buffer[urlsize] = (char )'\000';
#line 656
          memcpy((void */* __restrict  */)((void *)((tmp->buffer + urlsize) + 1)),
                 (void const   */* __restrict  */)((void const   *)st), (size_t )stsize);
#line 657
...
#line 724
  if ((int )data___2->urlbase[0] != 0) {
    {
#line 725
    strncpy((char */* __restrict  */)urls->ipcondescURL, (char const   */* __restrict  */)((char const   *)(data___2->urlbase)),
            (size_t )n1);
    }
  } else {
    {
...
#line 729
  ...
  {
#line 730
  strncpy((char */* __restrict  */)urls->controlURL, (char const   */* __restrict  */)((char const   *)urls->ipcondescURL),
          (size_t )n2);
#line 731
  strncpy((char */* __restrict  */)urls->controlURL_CIF, (char const   */* __restrict  */)((char const   *)urls->ipcondescURL),
          (size_t )n3);
#line 732
  strncpy((char */* __restrict  */)urls->controlURL_6FC, (char const   */* __restrict  */)((char const   *)urls->ipcondescURL),
          (size_t )n4);
#line 734
...
#line 846
          if ((int )data___2->second.servicetype[0] != 0) {
            {
#line 852
            memcpy((void */* __restrict  */)((void *)(& data___2->tmp)), (void const   */* __restrict  */)((void const   *)(& data___2->first)),
                   sizeof(struct IGDdatas_service ));
#line 853
            memcpy((void */* __restrict  */)((void *)(& data___2->first)), (void const   */* __restrict  */)((void const   *)(& data___2->second)),
                   sizeof(struct IGDdatas_service ));
#line 854
            memcpy((void */* __restrict  */)((void *)(& data___2->second)), (void const   */* __restrict  */)((void const   *)(& data___2->tmp)),
                   sizeof(struct IGDdatas_service ));
#line 855
            GetUPNPUrls(urls, data___2, (char const   *)dev->descURL);
            }
...
#line 13 "/home/wheatley/newnew/temp/miniupnpc-1.6/portlistingparse.c"
  {      {(portMappingElt const   )1, (char const   */* const  */)"PortMappingEntry"}, 
      ...
      (char const   */* const  */)"NewEnabled"}, 
        ...
        {(portMappingElt const   )0, (char const   */* const  */)((char const   *)((void *)0))}};
...
#line 120
  ...
  {
#line 91
  memcpy((void */* __restrict  */)((void *)(pm->remoteHost)), (void const   */* __restrict  */)((void const   *)data___2),
         (size_t )l);
#line 92
...
#line 99
  ...
  {
#line 100
  memcpy((void */* __restrict  */)((void *)(pm->protocol)), (void const   */* __restrict  */)((void const   *)data___2),
         (size_t )l);
#line 101
...
#line 105
  ...
  {
#line 107
  memcpy((void */* __restrict  */)((void *)(pm->internalClient)), (void const   */* __restrict  */)((void const   *)data___2),
         (size_t )l);
#line 108
...
#line 112
  ...
  {
#line 114
  memcpy((void */* __restrict  */)((void *)(pm->description)), (void const   */* __restrict  */)((void const   *)data___2),
         (size_t )l);
#line 115
...
#line 18
  if (s) {
    {
#line 18
    tmp = strtoul((char const   */* __restrict  */)s, (char **/* __restrict  */)((char **)((void *)0)),
                  0);
#line 18
...
#line 151
    if (p) {
      {
#line 152
      strncpy((char */* __restrict  */)status, (char const   */* __restrict  */)((char const   *)p),
              (size_t )64);
#line 153
      *(status + 63) = (char )'\000';
      }
...
#line 159
    if (up) {
      {
#line 160
      sscanf((char const   */* __restrict  */)((char const   *)up), (char const   */* __restrict  */)"%u",
             uptime);
      }
    } else {
#line 162
...
#line 166
    if (err) {
      {
#line 167
      strncpy((char */* __restrict  */)lastconnerror, (char const   */* __restrict  */)((char const   *)err),
              (size_t )64);
#line 168
...
#line 207
  if (p) {
    {
#line 208
    strncpy((char */* __restrict  */)connectionType, (char const   */* __restrict  */)((char const   *)p),
            (size_t )64);
#line 209
...
#line 263
    if (down) {
      {
#line 264
      sscanf((char const   */* __restrict  */)((char const   *)down), (char const   */* __restrict  */)"%u",
             bitrateDown);
      }
    } else {
#line 266
...
#line 319
  if (p) {
    {
#line 320
    strncpy((char */* __restrict  */)extIpAdd, (char const   */* __restrict  */)((char const   *)p),
            (size_t )16);
#line 321
...
#line 477
    if (rHost) {
      {
#line 479
      strncpy((char */* __restrict  */)rHost, (char const   */* __restrict  */)((char const   *)p),
              (size_t )64);
#line 480
      *(rHost + 63) = (char )'\000';
      }
...
#line 483
    if (extPort) {
      {
#line 485
      strncpy((char */* __restrict  */)extPort, (char const   */* __restrict  */)((char const   *)p),
              (size_t )6);
#line 486
      *(extPort + 5) = (char )'\000';
#line 487
...
#line 490
    if (protocol) {
      {
#line 492
      strncpy((char */* __restrict  */)protocol, (char const   */* __restrict  */)((char const   *)p),
              (size_t )4);
#line 493
      *(protocol + 3) = (char )'\000';
      }
...
#line 496
    if (intClient) {
      {
#line 498
      strncpy((char */* __restrict  */)intClient, (char const   */* __restrict  */)((char const   *)p),
              (size_t )16);
#line 499
...
#line 503
    if (intPort) {
      {
#line 505
      strncpy((char */* __restrict  */)intPort, (char const   */* __restrict  */)((char const   *)p),
              (size_t )6);
#line 506
      *(intPort + 5) = (char )'\000';
      }
...
#line 509
    if (enabled) {
      {
#line 511
      strncpy((char */* __restrict  */)enabled, (char const   */* __restrict  */)((char const   *)p),
              (size_t )4);
#line 512
      *(enabled + 3) = (char )'\000';
      }
...
#line 515
    if (desc) {
      {
#line 517
      strncpy((char */* __restrict  */)desc, (char const   */* __restrict  */)((char const   *)p),
              (size_t )80);
#line 518
      *(desc + 79) = (char )'\000';
      }
...
#line 521
    if (duration) {
      {
#line 523
      strncpy((char */* __restrict  */)duration, (char const   */* __restrict  */)((char const   *)p),
              (size_t )16);
#line 524
...
#line 559
      *numEntries = 0U;
#line 560
      sscanf((char const   */* __restrict  */)((char const   *)p), (char const   */* __restrict  */)"%u",
             numEntries);
#line 561
      ret = 0;
      }
...
#line 643
    if (leaseDuration) {
      {
#line 645
      strncpy((char */* __restrict  */)leaseDuration, (char const   */* __restrict  */)((char const   *)p),
              (size_t )16);
#line 646
...
#line 907
  if (p) {
    {
#line 909
    strncpy((char */* __restrict  */)uniqueID, (char const   */* __restrict  */)((char const   *)p),
            (size_t )8);
#line 910
    *(uniqueID + 7) = (char )'\000';
    }
...
#line 49
  ...
  {
#line 50
  memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)headers),
         (size_t )headerssize);
#line 51
  memcpy((void */* __restrict  */)((void *)(p + headerssize)), (void const   */* __restrict  */)((void const   *)body),
         (size_t )bodysize);
#line 53
...
#line 93
      ...
      {
#line 95
      memcpy((void */* __restrict  */)((void *)(header_buf + header_buf_used)), (void const   */* __restrict  */)((void const   *)(buf)),
             (size_t )n);
#line 96
      header_buf_used += n;
#line 99
...
#line 167
      memcpy((void */* __restrict  */)((void *)(buf)), (void const   */* __restrict  */)((void const   *)(header_buf + endofheaders)),
             (size_t )n);
      }
    }
#line 170
...
#line 232
          ...
          {
#line 235
          memcpy((void */* __restrict  */)((void *)(content_buf + content_buf_used)),
                 (void const   */* __restrict  */)((void const   *)(buf + i___0)),
                 (size_t )bytestocopy);
#line 236
...
#line 259
        memcpy((void */* __restrict  */)((void *)(content_buf + content_buf_used)),
               (void const   */* __restrict  */)((void const   *)(buf)), (size_t )n);
#line 260
        content_buf_used += n;
        }
      }
...
#line 341
      n = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)(& saddr)),
                      ...
                      (char */* __restrict  */)((char *)((void *)0)), (socklen_t )0,
                      3);
      }
#line 345
      if (n != 0) {
...
#line 446
        ...
        {
#line 446
        strncpy((char */* __restrict  */)hostname, (char const   */* __restrict  */)((char const   *)p1),
                (size_t )tmp);
        }
#line 447
        if ((int )*p2 == 58) {
...
#line 160
  n = getaddrinfo((char const   */* __restrict  */)((char const   *)(tmp_host)), (char const   */* __restrict  */)((char const   *)(port_str)),
                  (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
...
#line 200
      n = select(s + 1, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)(& wset),
...
#line 205
      tmp___3 = getsockopt(s, 1, 4, (void */* __restrict  */)((void *)(& err)), (socklen_t */* __restrict  */)(& len));
      }
#line 205
      if (tmp___3 < 0) {
        {
