...
#line 31
  ...
  {
#line 34
  sprintf((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)format),
          name, value);
  }
#line 36
  return (result);
...
#line 77
  ...
  {
#line 82
  strncpy((char */* __restrict  */)(piface), (char const   */* __restrict  */)((char const   *)iface->real_iface),
          sizeof(piface));
#line 83
...
#line 258
    tmp = fopen((char const   */* __restrict  */)((char const   *)(pidfilename)),
...
#line 73
  ...
  {
#line 75
  memcpy((void */* __restrict  */)newptr, (void const   */* __restrict  */)((void const   *)ptr),
         (size_t )size);
#line 76
  free(ptr);
  }
...
{ 
  ...
  {
#line 46
  strncpy((char */* __restrict  */)(_iface), (char const   */* __restrict  */)((char const   *)iface),
          sizeof(_iface));
#line 47
  _iface[sizeof(_iface) - 1UL] = (char)0;
#line 48
  strtok((char */* __restrict  */)(_iface), (char const   */* __restrict  */)((char const   *)delims));
#line 49
  tmp = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)((char const   *)delims));
#line 49
  token = (void *)tmp;
  }
#line 50
...
{ 
  ...
  {
#line 57
  tmp = stat((char const   */* __restrict  */)((char const   *)program), (struct stat */* __restrict  */)(& buf));
  }
#line 57
  if (0 == tmp) {
#line 58
...
#line 85
  maxlen = (int )tmp;
#line 87
  tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)*pparam), (char const   */* __restrict  */)"%3hhu.%3hhu.%3hhu.%3hhu",
...
{ 
  ...
  {
#line 104
  strncpy((char */* __restrict  */)(s), (char const   */* __restrict  */)((char const   *)*pparam),
          sizeof(s));
#line 105
...
#line 113
  ...
  {
#line 114
  strcpy((char */* __restrict  */)*pparam, (char const   */* __restrict  */)((char const   *)token));
  }
#line 115
  return;
}
...
#line 125
  ...
  {
#line 129
  tmp___0 = inet_pton(2, (char const   */* __restrict  */)((char const   *)token),
                      (void */* __restrict  */)((void *)(& addr)));
  }
#line 129
  if (tmp___0 != 1) {
#line 130
...
#line 141
    ...
    {
#line 144
    tmp___1 = inet_pton(2, (char const   */* __restrict  */)((char const   *)token),
                        (void */* __restrict  */)((void *)(& mask)));
    }
#line 145
    if (tmp___1 == -1) {
#line 145
...
#line 146
    ...
    {
#line 149
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)token), (char const   */* __restrict  */)"%d",
                     & maskwidth);
    }
#line 149
    if (tmp___2 != 1) {
...
#line 154
  ...
  {
#line 157
  tmp___3 = inet_ntop(2, (void const   */* __restrict  */)((void const   *)(& mask)),
                      (char */* __restrict  */)(s), (socklen_t )sizeof(s));
  }
#line 157
...
#line 161
  ...
  {
#line 162
  strcpy((char */* __restrict  */)*pparam, (char const   */* __restrict  */)((char const   *)(s)));
  }
#line 163
  return;
}
...
#line 176
  ...
  {
#line 177
  tmp___3 = inet_pton(2, (char const   */* __restrict  */)((char const   *)s), (void */* __restrict  */)((void *)(& addr)));
#line 177
  r = tmp___3;
#line 178
  free((void *)s);
...
#line 184
  ...
  {
#line 185
  r = inet_pton(2, (char const   */* __restrict  */)((char const   *)s), (void */* __restrict  */)((void *)(& mask)));
#line 186
  free((void *)s);
  }
#line 187
...
#line 204
  ...
  {
#line 209
  tmp___10 = inet_ntop(2, (void const   */* __restrict  */)((void const   *)(& addr)),
...
#line 213
  ...
  {
#line 214
  strcpy((char */* __restrict  */)*pparam, (char const   */* __restrict  */)((char const   *)(buffer)));
  }
#line 215
  return;
}
...
#line 242
  s = tmp;
#line 243
  tmp___0 = strtok((char */* __restrict  */)s, (char const   */* __restrict  */)((char const   *)*(argv + 0)));
#line 243
  token = tmp___0;
  }
  {
...
#line 244
    ...
    {
#line 245
    token = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)((char const   *)*(argv + 0)));
#line 246
    token_no --;
    }
  }
...
#line 254
    ...
    {
#line 255
    strcpy((char */* __restrict  */)*pparam, (char const   */* __restrict  */)((char const   *)*(argv + 2)));
    }
  }
  {
#line 258
...
#line 266
  ...
  {
#line 270
  tmp = strtol((char const   */* __restrict  */)((char const   *)*pparam), (char **/* __restrict  */)(& result),
               base);
#line 270
  value = tmp;
  }
...
#line 289
      ...
      {
#line 290
      strcpy((char */* __restrict  */)*pparam, (char const   */* __restrict  */)((char const   *)*(argv + value)));
      }
    } else {
#line 286
      goto _L;
...
#line 264
          *(pattern + 0) = (char )'\000';
#line 265
          strcat((char */* __restrict  */)pattern, (char const   */* __restrict  */)((char const   *)dir));
#line 266
        ...
        {
#line 268
        strcat((char */* __restrict  */)pattern, (char const   */* __restrict  */)((char const   *)rest));
#line 273
        tmp___11 = wordexp((char const   */* __restrict  */)((char const   *)pattern),
                           (wordexp_t */* __restrict  */)(& p), 4);
#line 273
        fail = tmp___11;
        }
#line 274
...
#line 317
            *(pattern___0 + 0) = (char )'\000';
#line 318
            strcat((char */* __restrict  */)pattern___0, (char const   */* __restrict  */)((char const   *)dir___0));
#line 319
          ...
          {
#line 321
          strcat((char */* __restrict  */)pattern___0, (char const   */* __restrict  */)((char const   *)rest));
#line 326
          tmp___20 = wordexp((char const   */* __restrict  */)((char const   *)pattern___0),
                             (wordexp_t */* __restrict  */)(& p___0), 4);
#line 326
          fail___0 = tmp___20;
          }
#line 327
...
#line 329
              ...
              {
#line 331
              tmp___21 = scandir((char const   */* __restrict  */)((char const   *)*(w___0 + i___0)),
...
#line 346
                  *(name + 0) = (char )'\000';
#line 347
                  strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)*(w___0 + i___0)));
#line 348
                  strcat((char */* __restrict  */)name, (char const   */* __restrict  */)"/");
#line 349
                  strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)((*(namelist + j))->d_name)));
                  }
#line 351
                  if (verbose) {
                    {
...
#line 472
                            strcpy((char */* __restrict  */)((currif->option + i___1)->value + (l___3 + 1UL)),
                                   (char const   */* __restrict  */)((char const   *)rest));
#line 473
...
{ 
  ...
  {
#line 15
  tmp___0 = strcmp((char const   *)ifd->logical_iface, "lo");
  }
#line 15
  if (tmp___0) {
    _L: 
...
#line 51
  ...
  {
#line 54
  tmp___2 = strcmp((char const   *)ifd->logical_iface, "lo");
  }
#line 54
  if (tmp___2) {
    _L___0: 
...
#line 112
  strcpy((char */* __restrict  */)(l___0), (char const   */* __restrict  */)((char const   *)s));
#line 113
...
#line 335
  ...
  {
#line 336
  tmp = strtol((char const   */* __restrict  */)((char const   *)str), (char **/* __restrict  */)((char **)((void *)0)),
               0);
  }
#line 336
  return ((int )tmp);
...
#line 487
  strcpy((char */* __restrict  */)(line), (char const   */* __restrict  */)((char const   *)tmp));
#line 488
...
#line 497
    if ((int )line[len - 1] == 93) {
      {
#line 499
      sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"[%[^]]",
             section);
#line 500
      tmp___1 = strstrip(section);
#line 500
      strcpy((char */* __restrict  */)section, (char const   */* __restrict  */)((char const   *)tmp___1));
#line 501
      tmp___2 = strlwc((char const   *)section);
#line 501
      strcpy((char */* __restrict  */)section, (char const   */* __restrict  */)((char const   *)tmp___2));
#line 502
      sta = (line_status )4;
      }
    } else {
#line 497
    ...
    {
#line 503
    tmp___12 = sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"%[^=] = \"%[^\"]\"",
                      key, value);
    }
#line 503
    if (tmp___12 == 2) {
#line 503
      ...
      {
#line 503
      tmp___13 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
...
#line 503
        ...
        {
#line 503
        tmp___14 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
                          (char const   */* __restrict  */)"%[^=] = %[^;#]", key,
                          value);
        }
#line 503
...
#line 507
          strcpy((char */* __restrict  */)key, (char const   */* __restrict  */)((char const   *)tmp___3));
#line 508
          tmp___4 = strlwc((char const   *)key);
#line 508
          strcpy((char */* __restrict  */)key, (char const   */* __restrict  */)((char const   *)tmp___4));
#line 509
          tmp___5 = strstrip(value);
#line 509
          strcpy((char */* __restrict  */)value, (char const   */* __restrict  */)((char const   *)tmp___5));
#line 514
...
#line 517
          ...
          {
#line 518
          tmp___10 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
                            (char const   */* __restrict  */)"%[^=] = %[;#]", key,
                            value);
          }
#line 518
...
#line 518
            ...
            {
#line 518
            tmp___11 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
                              (char const   */* __restrict  */)"%[^=] %[=]", key,
                              value);
            }
#line 518
...
#line 526
              strcpy((char */* __restrict  */)key, (char const   */* __restrict  */)((char const   *)tmp___8));
#line 527
              tmp___9 = strlwc((char const   *)key);
#line 527
              strcpy((char */* __restrict  */)key, (char const   */* __restrict  */)((char const   *)tmp___9));
#line 528
              *(value + 0) = (char)0;
#line 529
              sta = (line_status )5;
...
#line 131
  ...
  {
#line 131
  lock_fp = fopen((char const   */* __restrict  */)((char const   *)(lockfile)), (char const   */* __restrict  */)tmp);
  }
#line 132
...
#line 173
  ...
  {
#line 173
  tmp___2 = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)tmp___1);
#line 173
  lock_fp = tmp___2;
  }
#line 175
...
#line 296
  ...
  {
#line 296
  state_fp = fopen((char const   */* __restrict  */)((char const   *)(statefile)),
...
#line 395
  ...
  {
#line 397
  tmp_fp = fopen((char const   */* __restrict  */)((char const   *)(tmpstatefile)),
...
#line 772
    strncpy((char */* __restrict  */)(iface), (char const   */* __restrict  */)((char const   *)*(target_iface + i___1)),
            sizeof(iface));
#line 773
...
#line 777
      *pch = (char )'\000';
#line 778
      strncpy((char */* __restrict  */)(liface), (char const   */* __restrict  */)((char const   *)(pch + 1)),
              sizeof(liface));
#line 779
      ...
      {
#line 781
      strncpy((char */* __restrict  */)(liface), (char const   */* __restrict  */)((char const   *)(iface)),
              sizeof(liface));
#line 782
      liface[sizeof(liface) - 1UL] = (char )'\000';
      }
...
#line 792
    ...
    {
#line 798
    strncpy((char */* __restrict  */)(piface), (char const   */* __restrict  */)((char const   *)(iface)),
            sizeof(piface));
#line 799
...
#line 827
        ...
        {
#line 829
        strncpy((char */* __restrict  */)(liface), (char const   */* __restrict  */)((char const   *)current_state),
                (size_t )80);
#line 830
        liface[79] = (char)0;
        }
...
#line 1033
        if (! no_act) {
          {
#line 1034
          tmp___34 = fopen((char const   */* __restrict  */)((char const   *)(pidfilename)),
                           (char const   */* __restrict  */)"w");
#line 1034
          pidfile = tmp___34;
          }
