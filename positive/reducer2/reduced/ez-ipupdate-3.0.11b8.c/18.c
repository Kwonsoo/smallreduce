...
#line 38
  seteuid(tmp___0);
#line 42
  fp = fopen((char const   */* __restrict  */)((char const   *)pid_file___0), (char const   */* __restrict  */)"r");
  }
#line 42
...
#line 58
  ...
  {
#line 63
  fp = fopen((char const   */* __restrict  */)((char const   *)pid_file___0), (char const   */* __restrict  */)"w");
  }
#line 63
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
...
#line 86
    ...
    {
#line 90
    in = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
    }
#line 90
...
#line 151
        fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"  %-14s usage: ",
                cmd->name);
#line 152
        fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)cmd->help),
                cmd->name);
#line 153
...
#line 94
  *ipaddr = (char *)((void *)0);
#line 97
  tmp___0 = stat((char const   */* __restrict  */)((char const   *)file), (struct stat */* __restrict  */)(& st));
  }
#line 97
  if (tmp___0 != 0) {
    {
...
#line 133
    ipstr = p;
#line 135
    tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)datestr),
...
#line 746
  *multchar = (char )'\000';
#line 747
  tmp___0 = strtol((char const   */* __restrict  */)((char const   *)str), (char **/* __restrict  */)((char **)((void *)0)),
                   0);
#line 747
...
#line 791
    if (! (options & 16)) {
      {
#line 796
      vsnprintf((char */* __restrict  */)(buf___0), sizeof(buf___0), (char const   */* __restrict  */)((char const   *)fmt),
                args);
#line 801
...
{ 
  ...
  {
#line 825
  tmp = sscanf((char const   */* __restrict  */)((char const   *)addr), (char const   */* __restrict  */)"%d.%d.%d.%d",
               & q[0], & q[1], & q[2], & q[3]);
  }
#line 825
  if (tmp != 4) {
...
#line 1047
  ...
  {
#line 1050
  strncpy((char */* __restrict  */)(user), (char const   */* __restrict  */)((char const   *)optarg___0),
          sizeof(user));
#line 1051
...
#line 1527
  memcpy((void */* __restrict  */)((void *)(& tv)), (void const   */* __restrict  */)((void const   *)(& timeout)),
         sizeof(struct timeval ));
#line 1529
  ret = select(max_fd + 1, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)(& writefds),
...
#line 1569
  memcpy((void */* __restrict  */)((void *)(& tv)), (void const   */* __restrict  */)((void const   *)(& timeout)),
         sizeof(struct timeval ));
#line 1571
  ret = select(max_fd + 1, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
               (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv));
  }
#line 1574
  if (! (ret == -1)) {
...
#line 1611
  strcpy((char */* __restrict  */)(ifr.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)name));
#line 1613
...
#line 1628
  if ((int )ifr.ifr_ifru.ifru_addr.sa_family == 2) {
    {
#line 1630
    memcpy((void */* __restrict  */)((void *)sin), (void const   */* __restrict  */)((void const   *)(& ifr.ifr_ifru.ifru_addr)),
...
#line 1786
  tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %3d",
                   & ret);
  }
#line 1786
  if (tmp___2 != 1) {
...
#line 1820
    auth[0] = (char )'\000';
#line 1821
    sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %*3d %255[^\r\n]",
           auth);
#line 1822
...
#line 1965
  buf___0[btot] = (char )'\000';
#line 1969
  tmp___4 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %3d",
                   & ret);
  }
#line 1969
  if (tmp___4 != 1) {
...
#line 2077
                                if (tmp___9 >= 2UL) {
                                  {
#line 2079
                                  sscanf((char const   */* __restrict  */)((char const   *)p___0),
                                         (char const   */* __restrict  */)"%d%c %255[^\r\n]",
                                         & howlong, & mult, reason);
                                  }
#line 2080
                                  if ((int )mult == 104) {
...
#line 2505
  buf___0[btot] = (char )'\000';
#line 2509
  tmp___25 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)),
                    (char const   */* __restrict  */)" HTTP/1.%*c %3d", & ret);
  }
#line 2509
  if (tmp___25 != 1) {
#line 2511
...
#line 2642
    buf___0[btot] = (char )'\000';
#line 2646
    tmp___53 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)),
                      (char const   */* __restrict  */)" HTTP/1.%*c %3d", & ret);
    }
#line 2646
    if (tmp___53 != 1) {
...
#line 2904
  buf___0[btot] = (char )'\000';
#line 2908
  tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %3d",
                   & ret);
  }
#line 2908
  if (tmp___1 != 1) {
...
#line 2939
    if ((unsigned long )bp < (unsigned long )tmp___3) {
      {
#line 2939
      tmp___4 = sscanf((char const   */* __restrict  */)((char const   *)bp), (char const   */* __restrict  */)"Location: http://%*[^/]%255[^\r\n]",
                       auth);
      }
#line 2939
      if (tmp___4 == 1) {
...
#line 3079
  buf___0[btot] = (char )'\000';
#line 3083
  tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %3d",
                   & ret);
  }
#line 3083
  if (tmp___3 != 1) {
...
#line 3435
  strncat((char */* __restrict  */)(auth), (char const   */* __restrict  */)((char const   *)(buf___0)),
          255UL - tmp___4);
#line 3437
...
#line 3438
  ...
  {
#line 3442
  strcpy((char */* __restrict  */)(auth), (char const   */* __restrict  */)((char const   *)(buf___0)));
#line 3446
...
#line 3461
  close((int )client_sockfd);
#line 3463
  tmp___6 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)"%d",
                   & ret);
  }
#line 3463
  if (tmp___6 != 1) {
...
#line 3915
  if ((unsigned long )p != (unsigned long )((void *)0)) {
    {
#line 3917
    sscanf((char const   */* __restrict  */)((char const   *)p), (char const   */* __restrict  */)"DDNS_Response_%*code=%3d",
           & ret);
    }
  }
#line 3930
...
#line 4076
  buf___0[btot] = (char )'\000';
#line 4080
  tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)" HTTP/1.%*c %3d",
                   & ret);
  }
#line 4080
  if (tmp___0 != 1) {
...
#line 4453
  if ((int )user[0] != 0) {
    {
#line 4455
    sscanf((char const   */* __restrict  */)((char const   *)(user)), (char const   */* __restrict  */)"%127[^:]:%127[^\n]",
           user_name, password);
    }
  }
#line 4459
...
#line 4467
    strncpy((char */* __restrict  */)(password), (char const   */* __restrict  */)((char const   *)tmp___1),
            sizeof(password));
    }
  }
  {
...
#line 4590
          if ((time_t )tmp___33 - last_update > (time_t )max_interval) {
            ...
            {
#line 4596
            memcpy((void */* __restrict  */)((void *)(& sin)), (void const   */* __restrict  */)((void const   *)(& sin2)),
                   sizeof(sin));
            }
#line 4599
            if (address) {
