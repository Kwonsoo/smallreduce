...
#line 136
  pt ++;
#line 137
  strncpy((char */* __restrict  */)txt, (char const   */* __restrict  */)((char const   *)((char *)pt)),
          (size_t )txtlen);
#line 138
  *(txt + txtlen) = (char)0;
  }
...
#line 221
    ...
    {
#line 227
    memcpy((void */* __restrict  */)((void *)(buff)), (void const   */* __restrict  */)((void const   *)addr),
           (size_t )4);
#line 228
...
#line 282
  ...
  {
#line 282
  snprintf((char */* __restrict  */)(fmtinfo), sizeof(fmtinfo), (char const   */* __restrict  */)((char const   *)(fmt)),
           tmp___2);
  }
#line 283
  return (fmtinfo);
...
#line 251
    if (tmp___22 > 0UL) {
      {
#line 251
      strcpy((char */* __restrict  */)((char *)(fld_active)), (char const   */* __restrict  */)((char const   *)(buf)));
      }
    }
#line 253
    return (0);
...
#line 256
    if (tmp___24) {
      {
#line 257
      strcpy((char */* __restrict  */)((char *)(fld_active)), (char const   */* __restrict  */)"DR AGJMXI");
      }
    } else {
      {
#line 259
      strcpy((char */* __restrict  */)((char *)(fld_active)), (char const   */* __restrict  */)"LS NABWV");
      }
    }
#line 261
    return (0);
...
#line 630
      sprintf((char */* __restrict  */)(buf + hd_len), (char const   */* __restrict  */)((char const   *)(fmt)),
              data_fields[j].title);
#line 631
      hd_len += data_fields[j].length;
      }
...
#line 126
  snprintf((char */* __restrict  */)(fmt), sizeof(fmt), (char const   */* __restrict  */)"HOST: %%-%ds",
           len_tmp);
#line 130
  snprintf((char */* __restrict  */)(buf), sizeof(buf), (char const   */* __restrict  */)((char const   *)(fmt)),
           LocalHostname);
  }
#line 131
  if (reportwide) {
...
#line 136
    snprintf((char */* __restrict  */)(fmt), sizeof(fmt), (char const   */* __restrict  */)"%%%ds",
             data_fields[j].length);
#line 137
    snprintf((char */* __restrict  */)(buf + len), sizeof(buf), (char const   */* __restrict  */)((char const   *)(fmt)),
             data_fields[j].title);
#line 138
...
#line 304
        printf((char const   */* __restrict  */)((char const   *)(name)), data_fields[j].title,
               (double )tmp / 1000.0, data_fields[j].title);
        }
      } else {
        {
#line 309
...
#line 398
    ...
    {
#line 404
    strcpy((char */* __restrict  */)((char *)(fld_active)), (char const   */* __restrict  */)((char const   *)optarg));
    }
#line 405
    goto switch_break;
    case_66: 
...
#line 606
    hints.ai_socktype = 2;
#line 607
    error = getaddrinfo((char const   */* __restrict  */)((char const   *)Hostname),
...
#line 109
        rv = select(maxfd, (fd_set */* __restrict  */)((fd_set *)((void *)(& readfd))),
                    (fd_set */* __restrict  */)(& writefd), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                    (struct timeval */* __restrict  */)(& selecttime));
        }
      } else
#line 105
      if (paused) {
...
#line 124
      fflush(stdout);
#line 125
      strcpy((char */* __restrict  */)(Lines[at]), (char const   */* __restrict  */)((char const   *)(newLine)));
      }
#line 126
      if (LineCount < at + 1) {
#line 127
...
#line 719
  ...
  {
#line 723
  tmp = recvfrom(recvsock, (void */* __restrict  */)((void *)(packet)), (size_t )4470,
                 0, (struct sockaddr */* __restrict  */)fromsockaddr, (socklen_t */* __restrict  */)(& fromsockaddrsize));
#line 723
  num = (int )tmp;
  }
#line 727
...
#line 1328
  tmp___0 = inet_pton(af, (char const   */* __restrict  */)((char const   *)InterfaceAddress___0),
                      (void */* __restrict  */)((void *)(& ssa6->sin6_addr)));
  }
#line 1328
  if (tmp___0 < 1) {
    {
...
#line 1412
  strncpy((char */* __restrict  */)strptr, (char const   */* __restrict  */)((char const   *)tmp),
          len - 1UL);
#line 1413
...
#line 1418
  inet_ntop((int )sa6->sin6_family, (void const   */* __restrict  */)((void const   *)(& sa6->sin6_addr)),
...
#line 1449
  ...
  {
#line 1451
  memcpy((void */* __restrict  */)((void *)a), (void const   */* __restrict  */)((void const   *)b),
...
#line 1562
  net_add_fds(& writefd, & maxfd);
#line 1563
  select(maxfd, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)(& writefd),
...
{ 
  ...
  {
#line 471
  tmp = inet_ntop(af, (void const   */* __restrict  */)((void const   *)ip), (char */* __restrict  */)(addrstr),
...
{ 
  ...
  {
#line 481
  tmp = inet_pton(af___0, (char const   */* __restrict  */)((char const   *)s), (void */* __restrict  */)((void *)dst));
  }
#line 481
  return (tmp);
}
...
{ 
  ...
  {
#line 917
  fputs((char const   */* __restrict  */)((char const   *)s), (FILE */* __restrict  */)stderr);
#line 918
...
#line 1211
            strcat((char */* __restrict  */)(tempstring), (char const   */* __restrict  */)((char const   *)tmp___9));
#line 1212
            restell(tempstring);
#line 1213
            res_hostipmismatch ++;
...
#line 1241
          if ((int )datatype == 5) {
            {
#line 1242
            strcpy((char */* __restrict  */)(stackstring), (char const   */* __restrict  */)((char const   *)(namestring)));
            }
#line 1243
            goto switch_break___3;
          }
...
#line 1249
            ...
            {
#line 1251
            strcpy((char */* __restrict  */)rp->hostname, (char const   */* __restrict  */)((char const   *)(namestring)));
#line 1252
            linkresolvehost(rp);
#line 1253
            passrp(rp, ttl);
...
{ 
  ...
  {
#line 1296
  tmp = recvfrom(resfd, (void */* __restrict  */)((void *)((byte *)(resrecvbuf))),
                 (size_t )512, 0, (struct sockaddr */* __restrict  */)from, (socklen_t */* __restrict  */)(& fromlen));
#line 1296
  r = (int )tmp;
  }
#line 1298
...
{ 
  ...
  {
#line 1330
  tmp = recvfrom(resfd6, (void */* __restrict  */)((void *)((byte *)(resrecvbuf))),
                 (size_t )512, 0, (struct sockaddr */* __restrict  */)from, (socklen_t */* __restrict  */)(& fromlen));
#line 1330
  r = (int )tmp;
  }
...
#line 1354
    if (i == (int )myres._u._ext.nscount6) {
      {
#line 1355
      tmp___4 = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& from6->sin6_addr)),
