...
#line 130
  if ((rset->__fds_bits[lsock / (8 * (int )sizeof(__fd_mask ))] & (1L << lsock % (8 * (int )sizeof(__fd_mask )))) != 0L) {
    {
#line 134
    s = accept(lsock, (struct sockaddr */* __restrict  */)((struct sockaddr *)0),
...
#line 145
    while (1) {
      ...
      {
#line 146
      ret = select(max_fd + 1, (fd_set */* __restrict  */)(& rset), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 189
  dup(1);
#line 191
  setvbuf((FILE */* __restrict  */)stdout, (char */* __restrict  */)((char *)0), 1,
          (size_t )0);
#line 192
  setvbuf((FILE */* __restrict  */)stderr, (char */* __restrict  */)((char *)0), 2,
          (size_t )0);
  }
#line 193
  return;
...
#line 80
    ...
    {
#line 82
    val_str = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" :=\n\t\r");
    }
#line 82
    if (! val_str) {
      {
...
#line 173
                    if (tmp___25 == 0) {
                      {
#line 174
                      strncpy((char */* __restrict  */)(cfg___0->serial_dev), (char const   */* __restrict  */)((char const   *)val_str),
                              (size_t )4096);
                      }
                    } else {
                      {
