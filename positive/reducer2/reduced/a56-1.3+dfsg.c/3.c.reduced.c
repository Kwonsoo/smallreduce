...
{ 
  ...
  {
#line 62
  fp = fopen((char const   */* __restrict  */)((char const   *)file), (char const   */* __restrict  */)"a");
  }
#line 62
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
...
{ 
  ...
  {
#line 72
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)c),
...
#line 94
  b = tabbuf;
#line 96
  strncpy((char */* __restrict  */)b, (char const   */* __restrict  */)((char const   *)s),
          (size_t )256);
  }
  {
#line 100
...
#line 77
    tmp___2 = strcpy((char */* __restrict  */)((char *)tmp___1), (char const   */* __restrict  */)((char const   *)actions));
#line 77
    unew->action = tmp___2;
    }
  } else {
...
#line 85
  if ((unsigned long )stop == (unsigned long )((void *)0)) {
    {
#line 86
    new_state((char *)((void *)0));
    }
  }
  {
#line 88
  tmp___3 = follow((char )((int )*tok), tok + 1, stop);
  }
#line 88
  if (tmp___3 == -1) {
#line 89
...
#line 152
  if (tp) {
    {
#line 153
    strncpy((char */* __restrict  */)(tmp___0), (char const   */* __restrict  */)((char const   *)(buf)),
            (size_t )(tp - buf));
#line 154
...
#line 158
    tmp___4 = strcpy((char */* __restrict  */)((char *)tmp___3), (char const   */* __restrict  */)((char const   *)(tmp___0)));
#line 158
    snew->seen = tmp___4;
    }
  } else {
