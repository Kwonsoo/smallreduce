...
#line 569
            if (tmp___42) {
              {
#line 573
              bindPortS = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
              }
#line 574
              if (! bindPortS) {
                {
...
#line 588
              ...
              {
#line 590
              connectAddress = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
              }
#line 591
              if (! connectAddress) {
                {
...
#line 594
              ...
              {
#line 596
              connectPortS = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
              }
#line 597
              if (! connectPortS) {
                {
...
#line 634
              memcpy((void */* __restrict  */)((void *)(& saddr.sin_addr)), (void const   */* __restrict  */)((void const   *)(& iaddr)),
                     sizeof(iaddr));
#line 635
...
#line 673
              ...
              {
#line 675
              strcpy((char */* __restrict  */)*(seFromHosts + i), (char const   */* __restrict  */)((char const   *)bindAddress));
#line 676
...
#line 679
              ...
              {
#line 681
              strcpy((char */* __restrict  */)*(seToHosts + i), (char const   */* __restrict  */)((char const   *)connectAddress));
#line 682
...
#line 566
            ...
            {
#line 568
            strcpy((char */* __restrict  */)pidLogFileName, (char const   */* __restrict  */)((char const   *)nt___0));
            }
          }
        } else {
          {
#line 546
          tmp___26 = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
#line 546
          nt = tmp___26;
          }
#line 547
...
#line 554
          ...
          {
#line 556
          strcpy((char */* __restrict  */)logFileName, (char const   */* __restrict  */)((char const   *)nt));
          }
        }
      } else {
        {
#line 525
        tmp___23 = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
#line 525
...
#line 533
        ...
        {
#line 535
        strcpy((char */* __restrict  */)*(denyRules + di), (char const   */* __restrict  */)((char const   *)pattern___0));
        }
#line 536
        if (i > 0) {
#line 537
...
#line 544
      ...
      {
#line 494
      tmp___19 = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)" \t\r\n");
#line 494
      pattern = tmp___19;
      }
#line 495
...
#line 512
      ...
      {
#line 514
      strcpy((char */* __restrict  */)*(allowRules + ai), (char const   */* __restrict  */)((char const   *)pattern));
      }
#line 515
      if (i > 0) {
#line 516
...
#line 696
  if (logFileName) {
    {
#line 697
    logFile = fopen((char const   */* __restrict  */)((char const   *)logFileName),
...
#line 698
    if (logFile) {
      {
#line 699
      setvbuf((FILE */* __restrict  */)logFile, (char */* __restrict  */)((char *)((void *)0)),
              2, (size_t )0);
      }
    } else {
      {
...
#line 1056
  nfd = accept(*(seFds + i), (struct sockaddr */* __restrict  */)(& addr), (socklen_t */* __restrict  */)((socklen_t *)(& addrlen)));
  }
#line 1057
  if (nfd == -1) {
    {
...
#line 1312
  saddr.sin_family = (sa_family_t )2;
#line 1313
  memcpy((void */* __restrict  */)((void *)(& saddr.sin_addr)), (void const   */* __restrict  */)((void const   *)(seLocalAddrs + se)),
...
#line 1376
    ...
    {
#line 1378
    memcpy((void */* __restrict  */)((void *)(& iaddr->s_addr)), (void const   */* __restrict  */)((void const   *)((void *)*(h->h_addr_list + 0))),
           (size_t )4);
    }
#line 1382
    return (1);
...
#line 1416
  if (newsize < oldsize) {
    {
#line 1417
    memcpy((void */* __restrict  */)newData, (void const   */* __restrict  */)((void const   *)*data),
           (size_t )newsize);
    }
  } else {
    {
...
#line 1475
  strftime((char */* __restrict  */)(tstr), sizeof(tstr), (char const   */* __restrict  */)"%d/%b/%Y:%H:%M:%S ",
           (struct tm  const  */* __restrict  */)((struct tm  const  *)t));
  }
#line 1477
  if (i != -1) {
#line 1478
