...
#line 368
          ...
          {
#line 372
          tmp___0 = stat((char const   */* __restrict  */)((char const   *)(buf)),
...
#line 882
        ...
        {
#line 885
        tmp___10 = sscanf((char const   */* __restrict  */)((char const   *)x), (char const   */* __restrict  */)"if %128s",
                          file___0);
        }
#line 885
        if (tmp___10 != 1) {
          {
#line 885
          tmp___11 = sscanf((char const   */* __restrict  */)((char const   *)x),
                            (char const   */* __restrict  */)"%128s", file___0);
          }
#line 885
          if (tmp___11 != 1) {
#line 888
...
#line 1575
  sscanf((char const   */* __restrict  */)m->type, (char const   */* __restrict  */)"%128[^:]",
         mimetype);
#line 1576
  sscanf((char const   */* __restrict  */)((char const   *)(mimetype)), (char const   */* __restrict  */)"%s",
         mimetype);
#line 1579
...
#line 1730
      memcpy((void */* __restrict  */)((void *)y), (void const   */* __restrict  */)((void const   *)m->type),
             tmp___1);
#line 1731
...
#line 2555
  ...
  {
#line 2558
  tmp___2 = socketpair(1, 1, 0, commsPipe);
  }
#line 2558
  if (tmp___2 < 0) {
    {
...
#line 2565
  sigfillset(& set);
#line 2566
  sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& set)),
...
#line 811
    ...
    {
#line 814
    memcpy((void */* __restrict  */)((void *)(& gNetscapeFuncs)), (void const   */* __restrict  */)((void const   *)nsTable),
           (size_t )size);
#line 815
...
#line 859
    ...
    {
#line 863
    memcpy((void */* __restrict  */)((void *)pluginFuncs), (void const   */* __restrict  */)((void const   *)(& funcs)),
           (size_t )funcs.size);
    }
  } else {
#line 867
...
{ 
  ...
  {
#line 72
  tmp = NPN_GetValue((NPP )((void *)0), 14, (void *)(& value));
#line 72
  err = tmp;
  }
#line 73
...
{ 
  ...
  {
#line 94
  tmp = NPN_GetValue(instance, 13, (void *)(& value));
#line 94
  err = tmp;
  }
#line 95
...
{ 
  ...
  {
#line 125
  tmp = NPN_GetValue(instance, 21, (void *)(& value));
#line 125
  err = tmp;
  }
#line 127
...
#line 159
  tmp___2 = scale(5);
#line 159
  points[0] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& base)),
                       tmp___2 - s, tmp___1 - s);
#line 160
  tmp___3 = scale(2);
#line 160
  points[1] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& points[0])),
                       tmp___3, 0);
#line 161
  tmp___4 = scale(5);
#line 161
  tmp___5 = scale(5);
#line 161
  points[2] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& points[1])),
                       tmp___5, tmp___4);
#line 163
  tmp___6 = scale(13);
#line 163
  tmp___7 = scale(5);
#line 163
  points[5] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& base)),
                       tmp___7 - s, tmp___6 - s);
#line 164
  tmp___8 = scale(2);
#line 164
  points[4] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& points[5])),
                       tmp___8, 0);
#line 165
  tmp___9 = scale(5);
#line 165
  tmp___10 = scale(5);
#line 165
  points[3] = coordAdd((XPoint const   */* const  */)((XPoint const   *)(& points[4])),
                       tmp___10, - tmp___9);
  }
#line 167
  if (! buttonDown) {
...
#line 262
  ...
  {
#line 265
  pid = spawn_app(command___0, (int const   )flags___0, (int )((int const   )maxFd));
  }
#line 266
  if (pid == -1) {
#line 268
...
#line 570
  ...
  {
#line 573
  i = sscanf((char const   */* __restrict  */)((char const   *)*(argv + 1)), (char const   */* __restrict  */)"%d,%d,%d,%lu,%d,%d,%d,%d",
...
#line 733
    tmp___3 = select(maxFd + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                     (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)((struct timeval *)0));
    }
#line 733
    if (tmp___3 > 0) {
#line 735
