...
#line 119
    dest_ip = gateway_ip;
#line 122
    tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)(buff)), (char const   */* __restrict  */)"%s %8lx %8lx %4x %d %d %d %8lx %d %d %d",
...
#line 129
            if ((ip & mask) == dest_ip) {
              {
#line 135
              strcpy((char */* __restrict  */)intf, (char const   */* __restrict  */)((char const   *)(iface)));
#line 136
              *gateway = gateway_ip;
#line 137
              fclose(id);
...
#line 160
    ...
    {
#line 161
    tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)(buff)), (char const   */* __restrict  */)"%s 0x%x 0x%x %x:%x:%x:%x:%x:%x %s %s",
...
#line 324
  strncpy((char */* __restrict  */)(ifr.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)(interf)),
...
#line 338
    ...
    {
#line 340
    memcpy((void */* __restrict  */)((void *)(mac)), (void const   */* __restrict  */)((void const   *)(ifr.ifr_ifru.ifru_hwaddr.sa_data)),
           (size_t )6);
    }
  }
  {
...
#line 362
  memcpy((void */* __restrict  */)((void *)(hisaddr.sll_addr)), (void const   */* __restrict  */)((void const   *)(mac)),
         (size_t )6);
#line 366
...
#line 390
    tmp___9 = select(raw_sock + 1, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 391
    ...
    {
#line 393
    memcpy((void */* __restrict  */)((void *)(& gotaddr)), (void const   */* __restrict  */)((void const   *)(& hisaddr)),
           (size_t )addrlen);
#line 394
    memset((void *)(& rpack), 0, sizeof(rpack));
#line 395
    tmp___10 = recvfrom(raw_sock, (void */* __restrict  */)((void *)(& rpack)), sizeof(rpack),
                        0, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)(& gotaddr))),
