...
#line 161
      ...
      {
#line 163
      strcpy((char */* __restrict  */)(lastword), (char const   */* __restrict  */)((char const   *)tp));
      }
    }
    }
    {
...
#line 224
  t = (char *)tmp___2;
#line 225
  memcpy((void */* __restrict  */)((void *)t), (void const   */* __restrict  */)((void const   *)(tmp)),
         (size_t )(ct + 1));
  }
#line 226
  return (t);
...
{ 
  ...
  {
#line 425
  strcpy((char */* __restrict  */)(block), (char const   */* __restrict  */)((char const   *)a));
#line 426
  OutBuf(block);
  }
#line 427
...
#line 460
  r = Rooms + (int )GameHeader.PlayerRoom;
#line 461
  if ((int )*(r->Text) == 42) {
    {
#line 462
...
#line 611
      OutReset();
#line 612
      num = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%9s %9s",
                   verb, noun);
      }
#line 606
      if (! (num == 0)) {
...
#line 604
  ...
  {
#line 650
  strcpy((char */* __restrict  */)(NounText), (char const   */* __restrict  */)((char const   *)(noun)));
  }
#line 651
  return;
}
...
#line 660
  Output((char *)"\n");
#line 661
  f = fopen((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"w");
  }
#line 662
...
#line 1112
        nl___0 = (int )(Rooms + (int )GameHeader.PlayerRoom)->Exits[no - 1];
#line 1113
        if (nl___0 != 0) {
          {
#line 1115
