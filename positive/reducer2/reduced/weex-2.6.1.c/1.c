...
#line 156
    ptr = (char *)tmp___2;
#line 157
    strcat((char */* __restrict  */)ptr, (char const   */* __restrict  */)((char const   *)temp));
    }
  }
...
#line 249
        ...
        {
#line 251
        tmp___21 = __builtin_va_arg(args, char *);
#line 251
        tmp___4 = tmp___21;
#line 251
        string_arg = tmp___4;
...
#line 274
          ...
          {
#line 276
          tmp___23 = __builtin_va_arg(args, int );
#line 276
          tmp___9 = tmp___23;
          }
        }
...
#line 280
        ...
        {
#line 284
        tmp___24 = __builtin_va_arg(args, long );
#line 284
        tmp___12 = tmp___24;
#line 285
        len += 32U;
...
#line 287
        ...
        {
#line 297
        tmp___25 = __builtin_va_arg(args, double );
#line 297
        tmp___14 = tmp___25;
        }
#line 298
...
#line 300
        ...
        {
#line 302
        tmp___26 = __builtin_va_arg(args, int );
#line 302
        tmp___17 = tmp___26;
#line 303
        len ++;
...
#line 305
        ...
        {
#line 308
        tmp___27 = __builtin_va_arg(args, void *);
#line 308
        tmp___19 = tmp___27;
#line 309
        len += 32U;
...
#line 149
    strncpy((char */* __restrict  */)(ret + 2), (char const   */* __restrict  */)((char const   *)opt->longName),
            (size_t )28);
    }
  } else {
#line 151
...
#line 226
  ...
  {
#line 233
  tmp = strtol((char const   */* __restrict  */)((char const   *)arg), (char **/* __restrict  */)(& e),
               10);
  }
#line 234
  if (*e) {
...
#line 251
  ...
  {
#line 259
  tmp___4 = strtoul((char const   */* __restrict  */)((char const   *)arg), (char **/* __restrict  */)(& e___0),
                    10);
  }
#line 260
  if (*e___0) {
...
#line 107
  printf((char const   */* __restrict  */)((char const   *)tmp___1), "2.6.1");
#line 125
  exit(0);
  }
}
...
#line 54
  temp = (char *)tmp;
#line 55
  strncpy((char */* __restrict  */)temp, (char const   */* __restrict  */)((char const   *)str),
          (size_t )n);
#line 56
  *(temp + n) = (char )'\000';
#line 58
...
#line 80
  tmp___0 = regcomp((regex_t */* __restrict  */)(& re), (char const   */* __restrict  */)((char const   *)temp),
                    1);
  }
#line 80
  if (tmp___0 != 0) {
...
#line 82
  ...
  {
#line 84
  res = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& re)), (char const   */* __restrict  */)((char const   *)real_name),
...
#line 101
  close(fd);
#line 103
  fp = fopen((char const   */* __restrict  */)((char const   *)log_file), (char const   */* __restrict  */)"a");
  }
#line 104
...
{ 
  ...
  {
#line 162
  tmp___0 = stat((char const   */* __restrict  */)((char const   *)file), (struct stat */* __restrict  */)(& s));
  }
#line 162
  if (tmp___0 != 0) {
    {
...
#line 405
  ...
  {
#line 407
  strncpy((char */* __restrict  */)*word, (char const   */* __restrict  */)((char const   *)ptr),
          (size_t )len);
#line 408
  *(*word + len) = (char )'\000';
  }
...
#line 491
      ...
      {
#line 493
      strcpy((char */* __restrict  */)strptr, (char const   */* __restrict  */)((char const   *)value));
      }
#line 494
      if ((unsigned int )type == 1U) {
#line 495
...
#line 499
      ...
      {
#line 502
      tmp = strtol((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& endptr),
                   10);
      }
#line 503
      if (*endptr) {
...
#line 514
      ...
      {
#line 517
      utmp = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& endptr),
                     10);
      }
#line 518
      if (*endptr) {
...
#line 65
    ...
    {
#line 67
    lstat((char const   */* __restrict  */)((char const   *)(ent->d_name)), (struct stat */* __restrict  */)(& file_stat));
    }
#line 70
...
#line 70
      if ((file_stat.st_mode & 40960U) == 40960U) {
        {
#line 74
        tmp___3 = realpath((char const   */* __restrict  */)((char const   *)(ent->d_name)),
                           (char */* __restrict  */)(realfname));
        }
#line 74
        if ((unsigned long )tmp___3 == (unsigned long )((void *)0)) {
          {
...
#line 81
        ...
        {
#line 83
        stat((char const   */* __restrict  */)((char const   *)(realfname)), (struct stat */* __restrict  */)(& file_stat));
        }
      }
    }
    {
...
#line 302
          ...
          {
#line 303
          ptr = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
          }
#line 303
          if ((unsigned long )ptr == (unsigned long )((void *)0)) {
            {
...
#line 64
  ...
  {
#line 67
  fp = fopen((char const   */* __restrict  */)((char const   *)temp), (char const   */* __restrict  */)"r");
  }
#line 68
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
...
#line 81
    time___0 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
    }
#line 82
...
#line 285
  temp = str_concat((char const   *)tmp___0, "/.weex/weex.cache.", tmp, (void *)0);
#line 286
  fp = fopen((char const   */* __restrict  */)((char const   *)temp), (char const   */* __restrict  */)"w");
  }
#line 287
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
...
#line 281
    strcat((char */* __restrict  */)current_dir[side], (char const   */* __restrict  */)((char const   *)path));
#line 282
...
#line 432
                if (tmp___4) {
                  {
#line 435
                  stat((char const   */* __restrict  */)((char const   *)file_name),
                       (struct stat */* __restrict  */)(& local_file_stat));
#line 436
...
#line 194
      strncpy((char */* __restrict  */)((ctl->ctrl)->response), (char const   */* __restrict  */)((char const   *)tmp___0),
...
#line 227
      ...
      {
#line 228
      tmp = memccpy((void */* __restrict  */)((void *)bp), (void const   */* __restrict  */)((void const   *)ctl->cget),
                    '\n', (size_t )x);
#line 228
      end = (char *)tmp;
      }
...
#line 360
  if ((int )nControl->response[3] == 45) {
    {
#line 362
    strncpy((char */* __restrict  */)(match), (char const   */* __restrict  */)((char const   *)(nControl->response)),
            (size_t )3);
#line 363
    match[3] = (char )' ';
#line 364
...
#line 464
    ...
    {
#line 466
    memcpy((void */* __restrict  */)((void *)((char *)(& sin.sin_addr))), (void const   */* __restrict  */)((void const   *)*(phe->h_addr_list + 0)),
           (size_t )phe->h_length);
    }
  }
  {
...
#line 630
  ...
  {
#line 632
  fputs((char const   */* __restrict  */)((char const   *)(nControl->response)), (FILE */* __restrict  */)stderr);
#line 633
  respbuf[0] = (char )'\000';
#line 634
...
#line 687
    cp ++;
#line 688
    sscanf((char const   */* __restrict  */)((char const   *)cp), (char const   */* __restrict  */)"%u,%u,%u,%u,%u,%u",
...
#line 815
  ...
  {
#line 816
  i = select(i + 1, (fd_set */* __restrict  */)(& mask), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
             (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv));
  }
#line 817
  if (i == -1) {
...
#line 819
    tmp___0 = strerror(*tmp);
#line 819
    strncpy((char */* __restrict  */)(nControl->response), (char const   */* __restrict  */)((char const   *)tmp___0),
...
#line 848
      tmp___2 = strerror(i);
#line 848
      strncpy((char */* __restrict  */)(nControl->response), (char const   */* __restrict  */)((char const   *)tmp___2),
              sizeof(nControl->response));
#line 850
      nData->handle = 0;
#line 851
...
#line 1189
      strncpy((char */* __restrict  */)(nControl->response), (char const   */* __restrict  */)((char const   *)tmp___1),
              sizeof(nControl->response));
      }
#line 1191
      return (0);
...
#line 1203
    while (1) {
      ...
      {
#line 1203
      tmp___6 = fread((void */* __restrict  */)((void *)dbuf), (size_t )1, (size_t )8192,
...
#line 1221
        printf((char const   */* __restrict  */)((char const   *)tmp___5), sent_size,
               file_size, rate);
#line 1222
        i = 0;
        }
...
#line 1235
      ...
      {
#line 1236
      tmp___7 = fwrite((void const   */* __restrict  */)((void const   *)dbuf), (size_t )1,
                       (size_t )l, (FILE */* __restrict  */)local);
      }
#line 1236
      if (tmp___7 <= 0UL) {
#line 1239
...
#line 1292
  if (tmp___2) {
    {
#line 1296
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(nControl->response)),
                     (char const   */* __restrict  */)"%d %d", & resp, & sz);
    }
#line 1296
    if (tmp___1 == 2) {
#line 1297
...
#line 1317
  if (tmp___0) {
    {
#line 1320
    strncpy((char */* __restrict  */)dt, (char const   */* __restrict  */)((char const   *)(& nControl->response[4])),
            (size_t )max);
    }
  } else {
#line 1318
