...
#line 243
    ...
    {
#line 245
    strncpy((char */* __restrict  */)(PROTOCOL), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(PROTOCOL) - 1UL);
    }
#line 246
    goto switch_break;
    ...
    {
#line 248
    strncpy((char */* __restrict  */)(SRC_IP), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(SRC_IP) - 1UL);
#line 249
...
#line 250
    ...
    {
#line 252
    strncpy((char */* __restrict  */)(DST_IP), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(DST_IP) - 1UL);
#line 253
...
#line 441
      strncat((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)*(*(pa + index___0) + 1)),
              29UL - tmp___20);
#line 442
...
#line 450
      strncat((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)*(*(pa + index___0) + 2)),
              29UL - tmp___23);
#line 451
...
#line 460
        strncat((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)*(*(pa + index___0) + 6)),
                29UL - tmp___26);
#line 461
...
#line 528
  ...
  {
#line 530
  tmp___6 = string_search(line, (char *)"tcp");
  }
#line 530
  if (tmp___6) {
    {
#line 531
    memcpy((void */* __restrict  */)((void *)protocol), (void const   */* __restrict  */)((void const   *)"tcp"),
           (size_t )3);
    }
  } else {
    {
#line 533
    tmp___5 = string_search(line, (char *)"udp");
    }
#line 533
    if (tmp___5) {
      {
#line 534
      memcpy((void */* __restrict  */)((void *)protocol), (void const   */* __restrict  */)((void const   *)"udp"),
             (size_t )3);
      }
    } else {
      {
#line 536
      tmp___4 = string_search(line, (char *)"icmp");
      }
#line 536
      if (tmp___4) {
        {
#line 537
        memcpy((void */* __restrict  */)((void *)protocol), (void const   */* __restrict  */)((void const   *)"icmp"),
               (size_t )4);
        }
      } else {
#line 541
...
#line 546
              ...
              {
#line 548
              strncat((char */* __restrict  */)(protocol_raw), (char const   */* __restrict  */)((char const   *)(line + j)),
                      (size_t )1);
#line 544
              j ++;
              }
...
#line 552
            memcpy((void */* __restrict  */)((void *)protocol), (void const   */* __restrict  */)((void const   *)(protocol_name)),
                   (size_t )5);
            }
#line 553
            goto while_break___1;
...
{ 
  ...
  {
#line 565
  tmp___7 = string_search(line, (char *)"ESTABLISHED");
  }
#line 565
  if (tmp___7) {
    {
#line 566
    memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"ESTABLISHED"),
           (size_t )11);
    }
  } else {
    {
#line 568
    tmp___6 = string_search(line, (char *)"TIME_WAIT");
    }
#line 568
    if (tmp___6) {
      {
#line 569
      memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"TIME_WAIT"),
             (size_t )9);
      }
    } else {
      {
#line 571
      tmp___5 = string_search(line, (char *)"FIN_WAIT");
      }
#line 571
      if (tmp___5) {
        {
#line 572
        memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"FIN_WAIT"),
               (size_t )8);
        }
      } else {
        {
#line 574
        tmp___4 = string_search(line, (char *)"SYN_RECV");
        }
#line 574
        if (tmp___4) {
          {
#line 575
          memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"SYN_RECV"),
                 (size_t )8);
          }
        } else {
          {
#line 577
          tmp___3 = string_search(line, (char *)"SYN_SENT");
          }
#line 577
          if (tmp___3) {
            {
#line 578
            memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"SYN_SENT"),
                   (size_t )8);
            }
          } else {
            {
#line 580
            tmp___2 = string_search(line, (char *)"UNREPLIED");
            }
#line 580
            if (tmp___2) {
              {
#line 581
              memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"UNREPLIED"),
                     (size_t )9);
              }
            } else {
              {
#line 583
              tmp___1 = string_search(line, (char *)"CLOSE");
              }
#line 583
              if (tmp___1) {
                {
#line 584
                memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"CLOSE"),
                       (size_t )5);
                }
              } else {
                {
#line 586
                tmp___0 = string_search(line, (char *)"ASSURED");
                }
#line 586
                if (tmp___0) {
                  {
#line 587
                  memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)"ASSURED"),
                         (size_t )7);
                  }
                } else {
                  {
#line 590
                  tmp = string_search(line, (char *)"udp");
                  }
#line 590
                  if (tmp) {
                    {
#line 591
                    ...
                    {
#line 594
                    memcpy((void */* __restrict  */)((void *)state), (void const   */* __restrict  */)((void const   *)" "),
                           (size_t )1);
                    }
                  }
                }
...
#line 613
  ...
  {
#line 615
  search_first_hit((char *)"src=", line, srcip_f);
#line 616
  search_first_hit((char *)"dst=", line, dstip_f);
#line 617
  search_sec_hit((char *)"src=", line, srcip_s);
#line 618
  search_sec_hit((char *)"dst=", line, dstip_s);
#line 619
  search_first_hit((char *)"sport=", line, srcport);
#line 620
  search_first_hit((char *)"dport=", line, dstport);
#line 621
  search_sec_hit((char *)"sport=", line, srcport_s);
#line 622
  search_sec_hit((char *)"dport=", line, dstport_s);
#line 624
...
{ 
  ...
  {
#line 719
  strncpy((char */* __restrict  */)(buf_port), (char const   */* __restrict  */)((char const   *)*port),
          sizeof(buf_port) - 1UL);
#line 720
...
#line 722
  if (service) {
    {
#line 725
    strncpy((char */* __restrict  */)*port, (char const   */* __restrict  */)((char const   *)service->s_name),
            (size_t )19);
    }
  }
#line 727
...
#line 733
  split = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"=");
#line 734
  strcpy((char */* __restrict  */)gen_buffer, (char const   */* __restrict  */)((char const   *)split));
  }
#line 735
  return;
}
...
#line 748
    ...
    {
#line 750
    memcpy((void */* __restrict  */)((void *)(& in.s_addr)), (void const   */* __restrict  */)((void const   *)*p),
           sizeof(in.s_addr));
#line 753
    strncpy((char */* __restrict  */)*r_host, (char const   */* __restrict  */)((char const   *)hp->h_name),
            (size_t )59);
#line 748
    p ++;
    }
...
#line 772
  strncpy((char */* __restrict  */)hostname, (char const   */* __restrict  */)((char const   *)ip),
          hostname_size - 1UL);
  }
#line 773
  return (1);
...
#line 935
  ...
  {
#line 943
  memcpy((void */* __restrict  */)((void *)ret), (void const   */* __restrict  */)((void const   *)(line + (i + searchLen))),
...
#line 988
  if ((unsigned long )proto_struct != (unsigned long )((void *)0)) {
    {
#line 989
    memcpy((void */* __restrict  */)((void *)protocol_name), (void const   */* __restrict  */)((void const   *)proto_struct->p_name),
           (size_t )5);
    }
  } else {
    {
#line 992
    snprintf((char */* __restrict  */)(strconvers), (size_t )6, (char const   */* __restrict  */)"%d",
             protocol_nr);
#line 993
    memcpy((void */* __restrict  */)((void *)protocol_name), (void const   */* __restrict  */)((void const   *)(strconvers)),
           (size_t )5);
    }
  }
#line 995
