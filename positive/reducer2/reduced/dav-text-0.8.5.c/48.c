...
#line 429
      ...
      {
#line 429
      strcpy((char */* __restrict  */)answer, (char const   */* __restrict  */)((char const   *)tmp___5));
      }
#line 430
      if ((int )focus == 0) {
#line 430
...
int numberOfBuffers ;
#line 26 "/home/june/repo/benchmarks/collector/temp/dav-text-0.8.5/buffers.c"
...
#line 199
    strcat((char */* __restrict  */)(c), (char const   */* __restrict  */)((char const   *)(currentBuffer->fname)));
#line 200
...
#line 201
    if (currentBufferNum >= 10) {
      {
#line 202
      strcat((char */* __restrict  */)(c), (char const   */* __restrict  */)((char const   *)(temp)));
      }
    } else {
      {
#line 204
      strcat((char */* __restrict  */)(c), (char const   */* __restrict  */)((char const   *)(temp + 1)));
      }
    }
    {
#line 206
...
#line 52
  ptr = (char *)tmp___0;
#line 53
  strcpy((char */* __restrict  */)ptr, (char const   */* __restrict  */)((char const   *)(currentBuffer->fname)));
#line 54
  tmp___1 = doSave((char *)".");
#line 54
...
#line 54
  if (! tmp___2) {
    {
#line 55
    strcpy((char */* __restrict  */)(currentBuffer->fname), (char const   */* __restrict  */)((char const   *)ptr));
    }
  }
  {
#line 57
...
#line 73
  ...
  {
#line 75
  stat((char const   */* __restrict  */)((char const   *)filename), (struct stat */* __restrict  */)(& s));
  }
#line 77
...
#line 95
        sprintf((char */* __restrict  */)*(choices + (n - 1)), (char const   */* __restrict  */)((char const   *)(d->d_name)));
        }
      }
      while_break___5: /* CIL Label */ ;
      }
...
#line 145
  ...
  {
#line 146
  strcpy((char */* __restrict  */)(currentBuffer->fname), (char const   */* __restrict  */)((char const   *)filename));
#line 147
  currentBuffer->updated = (char)0;
  }
#line 148
...
#line 339
  tmp = getenv("HOME");
#line 339
  strcpy((char */* __restrict  */)(home), (char const   */* __restrict  */)((char const   *)tmp));
#line 340
  strcat((char */* __restrict  */)(home), (char const   */* __restrict  */)"/.davrc");
#line 341
  fp = fopen((char const   */* __restrict  */)((char const   *)(home)), (char const   */* __restrict  */)"r");
  }
#line 342
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
    {
#line 344
    fp = fopen((char const   */* __restrict  */)((char const   *)(home)), (char const   */* __restrict  */)"w");
    }
#line 345
    if ((unsigned long )fp == (unsigned long )((void *)0)) {
#line 345
...
#line 355
    c = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" =");
    }
#line 356
...
#line 548
  strcpy((char */* __restrict  */)((char *)newLine->data), (char const   */* __restrict  */)((char const   *)data));
#line 549
...
#line 725
      while (1) {
        ...
        {
#line 725
        airac_observe(numberInBuckets, i);
#line 725
