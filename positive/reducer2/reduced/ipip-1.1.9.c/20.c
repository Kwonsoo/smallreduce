...
#line 159
  ...
  {
#line 164
  tmp___13 = __sigsetjmp(restart_env, 1);
  }
#line 164
  if (tmp___13 == 0) {
    {
...
#line 250
    ...
    {
#line 253
    n = assemble_slip(s, (unsigned char )((int )s->buffer[s->bnext]));
#line 254
    (s->bnext) ++;
    }
#line 256
    if (n > 0) {
      {
#line 257
      memcpy((void */* __restrict  */)((void *)((char *)(m->msg))), (void const   */* __restrict  */)((void const   *)((char *)(s->ipacket))),
             (size_t )n);
#line 258
      m->length = n;
      }
...
#line 266
  ...
  {
#line 269
  memcpy((void */* __restrict  */)((void *)((char *)(& d))), (void const   */* __restrict  */)((void const   *)((char *)(m->msg) + 16)),
         (size_t )4);
#line 271
  i = 0;
  }
...
#line 40
  init_config();
#line 43
  cf = fopen((char const   */* __restrict  */)((char const   *)f), (char const   */* __restrict  */)"r");
  }
#line 43
...
#line 53
      ...
      {
#line 55
      cerr((char *)"Unrecognized command: %s", p);
      }
    }
  }
  while_break___0: /* CIL Label */ ;
...
#line 58
  if (ifs_top == 0) {
    {
#line 58
    cerr((char *)"No interfaces defined", (char *)"");
    }
  }
#line 60
  if (debugd) {
...
#line 182
      ifs[ifs_top].type = 4;
#line 183
      ifs[ifs_top].ifopen = (int (*)())(& tun_open);
#line 184
      ifs[ifs_top].ifread = (int (*)())(& tun_read);
#line 185
      ifs[ifs_top].ifsend = (int (*)())(& tun_send);
    } else {
      {
#line 186
...
#line 187
        ifs[ifs_top].type = 3;
#line 188
        ifs[ifs_top].ifopen = (int (*)())(& slip_open);
#line 189
        ifs[ifs_top].ifread = (int (*)())(& slip_read);
#line 190
        ifs[ifs_top].ifsend = (int (*)())(& slip_send);
      } else {
        {
#line 191
...
#line 192
          ifs[ifs_top].type = 1;
#line 193
          ifs[ifs_top].ifopen = (int (*)())(& ip_open);
#line 194
          ifs[ifs_top].ifread = (int (*)())(& ip_read);
#line 195
          ifs[ifs_top].ifsend = (int (*)())(& ip_send);
        } else {
          {
#line 196
...
#line 60
      ...
      {
#line 62
      rerr((char *)"Unrecognized command: %s", p);
      }
    }
  }
  while_break___0: /* CIL Label */ ;
...
#line 65
  if (rts_top == 0) {
    {
#line 65
    rerr((char *)"No routes defined", (char *)"");
    }
  }
#line 67
  if (debugd) {
...
#line 178
    if (he) {
      {
#line 179
      memcpy((void */* __restrict  */)((void *)((char *)(& rts[rts_top].ipaddr))),
...
#line 187
  if (q) {
    {
#line 188
    tmp___1 = strtoul((char const   */* __restrict  */)((char const   *)q), (char **/* __restrict  */)((char **)((void *)0)),
                      0);
#line 188
...
#line 200
    if (he) {
      {
#line 201
      memcpy((void */* __restrict  */)((void *)((char *)(& rts[rts_top].destaddr))),
             (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + 0)),
             (size_t )4);
      }
    } else {
...
#line 110
  tmp = recvfrom(ifp->fd, (void */* __restrict  */)((void *)((char *)(buf))), (size_t )2048,
...
#line 132
  ...
  {
#line 135
  memcpy((void */* __restrict  */)((void *)((char *)(m->msg))), (void const   */* __restrict  */)((void const   *)((char *)p)),
         (size_t )n);
#line 136
  m->length = n;
#line 137
  memcpy((void */* __restrict  */)((void *)((char *)(& m->fip))), (void const   */* __restrict  */)((void const   *)((char *)(& ip_from.sin_addr))),
         (size_t )4);
#line 138
...
#line 175
  memcpy((void */* __restrict  */)((void *)((char *)(& ip_to.sin_addr))), (void const   */* __restrict  */)((void const   *)((char *)(& m->tip))),
         (size_t )4);
#line 177
