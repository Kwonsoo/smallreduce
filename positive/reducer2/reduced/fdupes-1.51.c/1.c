...
#line 140
    ...
    {
#line 142
    strcpy((char */* __restrict  */)*filename_ptr, (char const   */* __restrict  */)((char const   *)tmp));
    }
  }
#line 144
  return;
...
{ 
  ...
  {
#line 149
  tmp = stat((char const   */* __restrict  */)((char const   *)filename), (struct stat */* __restrict  */)(& s));
  }
#line 149
  if (tmp != 0) {
#line 149
...
#line 194
    ...
    {
#line 197
    strcpy((char */* __restrict  */)*(args + x), (char const   */* __restrict  */)((char const   *)*(argv + x)));
#line 189
    x ++;
    }
  }
...
#line 282
        ...
        {
#line 285
        strcpy((char */* __restrict  */)newfile->d_name, (char const   */* __restrict  */)((char const   *)dir));
#line 286
...
#line 288
        ...
        {
#line 289
        strcat((char */* __restrict  */)newfile->d_name, (char const   */* __restrict  */)((char const   *)(dirinfo->d_name)));
        }
#line 291
...
#line 305
        ...
        {
#line 308
        tmp___7 = stat((char const   */* __restrict  */)((char const   *)newfile->d_name),
                       (struct stat */* __restrict  */)(& info));
        }
#line 308
        if (tmp___7 == -1) {
          {
...
#line 311
        ...
        {
#line 314
        tmp___8 = lstat((char const   */* __restrict  */)((char const   *)newfile->d_name),
                        (struct stat */* __restrict  */)(& linfo));
        }
#line 314
        if (tmp___8 == -1) {
          {
...
#line 373
    ...
    {
#line 374
    tmp = fread((void */* __restrict  */)((void *)(chunk)), (size_t )toread, (size_t )1,
...
#line 517
      ...
      {
#line 519
      strcpy((char */* __restrict  */)(checktree->file)->crcpartial, (char const   */* __restrict  */)((char const   *)crcsignature));
      }
    }
#line 522
...
#line 532
      ...
      {
#line 534
      strcpy((char */* __restrict  */)file->crcpartial, (char const   */* __restrict  */)((char const   *)crcsignature));
      }
    }
    {
#line 537
...
#line 548
        ...
        {
#line 550
        strcpy((char */* __restrict  */)(checktree->file)->crcsignature, (char const   */* __restrict  */)((char const   *)crcsignature));
        }
      }
#line 553
...
#line 560
        ...
        {
#line 562
        strcpy((char */* __restrict  */)file->crcsignature, (char const   */* __restrict  */)((char const   *)crcsignature));
        }
      }
      {
#line 565
...
#line 608
  while (1) {
    ...
    {
#line 609
    r1 = fread((void */* __restrict  */)((void *)(c1)), (size_t )1, sizeof(c1), (FILE */* __restrict  */)file1);
#line 610
    r2 = fread((void */* __restrict  */)((void *)(c2)), (size_t )1, sizeof(c2), (FILE */* __restrict  */)file2);
    }
#line 612
    if (r1 != r2) {
#line 612
...
#line 853
            number = 0;
#line 854
            sscanf((char const   */* __restrict  */)((char const   *)token), (char const   */* __restrict  */)"%d",
                   & number);
            }
#line 855
            if (number > 0) {
...
#line 1147
    if ((unsigned long )match != (unsigned long )((void *)0)) {
      {
#line 1148
      file1 = fopen((char const   */* __restrict  */)((char const   *)curfile->d_name),
...
#line 1151
      ...
      {
#line 1154
      file2 = fopen((char const   */* __restrict  */)((char const   *)(*match)->d_name),
                    (char const   */* __restrict  */)"rb");
      }
#line 1155
      if (! file2) {
