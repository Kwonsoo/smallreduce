...
extern CV *( __attribute__((__nonnull__(3), __nonnull__(4))) Perl_newXS)(PerlInterpreter *my_perl  __attribute__((__unused__)) ,
                                                                         ...
                                                                         char const   *filename ) ;
#line 3781
extern SV **( __attribute__((__nonnull__(2), __nonnull__(3))) Perl_stack_grow)(PerlInterpreter *my_perl  __attribute__((__unused__)) ,
                                                                               SV **sp ,
                                                                               SV **p ,
                                                                               int n ) ;
#line 3825
...
#line 213
  if (items != 1) {
    {
#line 214
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj");
    }
  }
  {
#line 218
...
#line 239
  if (items != 2) {
    {
#line 240
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj, timeout");
    }
  }
  {
#line 243
...
#line 270
  if (items != 2) {
    {
#line 271
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj, ttl");
    }
  }
  {
#line 274
...
#line 301
  if (items != 2) {
    {
#line 302
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj, addr");
    }
  }
  {
#line 305
...
#line 332
  if (items != 2) {
    {
#line 333
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj, dev");
    }
  }
  {
#line 336
...
#line 367
  if (items != 2) {
    {
#line 368
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"obj, host");
    }
  }
  {
#line 371
...
#line 487
  if (items != 1) {
    {
#line 488
    Perl_croak_xs_usage((CV const   */* const  */)((CV const   *)cv), (char const   */* const  */)"iter");
    }
  }
  {
#line 493
...
#line 188
    tmp___24 = Perl_newSVpvn((PerlInterpreter *)tmp___23, (char const   */* const  */)((char const   *)buffer),
...
#line 514
      if (cmsg->cmsg_type == 29) {
        {
#line 515
        memcpy((void */* __restrict  */)((void *)(& pkt_now)), (void const   */* __restrict  */)((void const   *)(cmsg->__cmsg_data)),
               sizeof(pkt_now));
        }
      }
    } else
...
#line 523
      if (cmsg->cmsg_type == 1) {
        {
#line 525
        memcpy((void */* __restrict  */)((void *)(& recv_qos)), (void const   */* __restrict  */)((void const   *)(cmsg->__cmsg_data)),
               sizeof(recv_qos));
        }
      } else
#line 529
      if (cmsg->cmsg_type == 2) {
        {
#line 531
        memcpy((void */* __restrict  */)((void *)(& recv_ttl)), (void const   */* __restrict  */)((void const   *)(cmsg->__cmsg_data)),
               sizeof(recv_ttl));
        }
      }
    } else
...
#line 712
    ...
    {
#line 718
    status = select(max_fd + 1, (fd_set */* __restrict  */)(& read_fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 830
  strncpy((char */* __restrict  */)data, (char const   */* __restrict  */)((char const   *)ph->data),
          (size_t )buflen);
#line 831
...
#line 1255
  status = getaddrinfo((char const   */* __restrict  */)((char const   *)hostname),
                       (char const   */* __restrict  */)((char const   *)((void *)0)),
                       (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& ai_hints)),
...
#line 1413
  ...
  {
#line 1416
  ai_return = getaddrinfo((char const   */* __restrict  */)host, (char const   */* __restrict  */)((char const   *)((void *)0)),
                          (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& ai_hints)),
                          (struct addrinfo **/* __restrict  */)(& ai_list));
  }
#line 1416
...
#line 1537
    memcpy((void */* __restrict  */)((void *)ph->addr), (void const   */* __restrict  */)((void const   *)ai_ptr->ai_addr),
...
#line 1706
  ...
  {
#line 1710
  strncpy((char */* __restrict  */)((char *)buffer), (char const   */* __restrict  */)((char const   *)iter->username),
          orig_buffer_len);
#line 1711
  ret = 0;
  }
...
#line 1718
  ...
  {
#line 1722
  strncpy((char */* __restrict  */)((char *)buffer), (char const   */* __restrict  */)((char const   *)iter->hostname),
          orig_buffer_len);
#line 1723
  ret = 0;
  }
#line 1724
  ...
  {
#line 1727
  ret = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)iter->addr)),
...
#line 1799
  ...
  {
#line 1800
  strncpy((char */* __restrict  */)((char *)buffer), (char const   */* __restrict  */)((char const   *)iter->data),
          orig_buffer_len);
#line 1801
  ret = 0;
  }
...
#line 1818
  ...
  {
#line 1819
  memcpy((void */* __restrict  */)buffer, (void const   */* __restrict  */)((void const   *)(& iter->recv_qos)),
         *buffer_len);
#line 1820
  ret = 0;
  }
...
#line 593
    *tmp___0 = 0;
#line 594
    tmp = strtod((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr));
#line 595
    tmp___1 = __errno_location();
    }
#line 595
...
#line 1304
      ...
      {
#line 1306
      infile = fopen((char const   */* __restrict  */)((char const   *)opt_filename),
...
#line 1328
      ...
      {
#line 1331
      tmp___18 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
                        (char const   */* __restrict  */)"%s", host);
      }
#line 1331
      if (tmp___18 != 1) {
#line 1332
...
#line 1410
  tmp___32 = sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigint_action)),
