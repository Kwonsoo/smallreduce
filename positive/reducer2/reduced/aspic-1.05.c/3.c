...
#line 229
          gcss = 6 * gcaa;
#line 229
          airac_observe(utf8_table3, gcaa);
#line 229
...
#line 339
      t1 = (char *)(in_line + st);
#line 341
      longvalue = strtoul((char const   */* __restrict  */)((char const   *)t1), (char **/* __restrict  */)(& t2),
                          base);
#line 342
...
#line 127
  ...
  {
#line 129
  nf = fopen((char const   */* __restrict  */)((char const   *)((char *)(word))),
...
#line 618
  memcpy((void */* __restrict  */)((void *)newenv), (void const   */* __restrict  */)((void const   *)env),
         sizeof(environment ));
#line 619
  newenv->previous = env;
#line 620
...
#line 721
  mm = (macro *)tmp;
#line 723
  memcpy((void */* __restrict  */)((void *)mm), (void const   */* __restrict  */)((void const   *)m),
         sizeof(macro ));
#line 725
...
#line 471 "/home/june/collector/temp/aspic-1.05/src/aspic.h"
int outstyle ;
#line 472
BOOL started ;
#line 516
...
#line 152
  vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)((char *)error_messages[n])),
           ap);
#line 153
...
#line 225
  memcpy((void */* __restrict  */)((void *)(& local)), (void const   */* __restrict  */)((void const   *)tmp___0),
         sizeof(struct tm ));
#line 226
...
#line 236
  tmp___3 = strftime((char */* __restrict  */)((char *)timebuf), (size_t )size, (char const   */* __restrict  */)"%a, ",
                     (struct tm  const  */* __restrict  */)((struct tm  const  *)(& local)));
#line 236
  len = (int )tmp___3;
#line 237
...
#line 239
  tmp___5 = strftime((char */* __restrict  */)((char *)(timebuf + len)), (size_t )(size - len),
                     (char const   */* __restrict  */)"%b %Y %H:%M:%S", (struct tm  const  */* __restrict  */)((struct tm  const  *)(& local)));
#line 239
...
#line 354
      ...
      {
#line 358
      main_input = fopen((char const   */* __restrict  */)((char const   *)*(argv + firstarg)),
                         (char const   */* __restrict  */)"r");
      }
#line 358
...
#line 401
        ...
        {
#line 405
        out_file = fopen((char const   */* __restrict  */)((char const   *)*(argv + (firstarg + 1))),
