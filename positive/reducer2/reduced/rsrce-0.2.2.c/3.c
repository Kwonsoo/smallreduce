...
#line 38
  if (bsi) {
#line 38
    tmp = (int )((int const   )bse[bsi - (char *)(bsc)]);
  } else {
#line 38
    tmp = (int )((int const   )c);
  }
...
#line 123
    ...
    {
#line 125
    opts.cmdin = fopen((char const   */* __restrict  */)((char const   *)optarg),
...
{ 
  ...
  {
#line 31
  tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)data), (size_t )1,
...
{ 
  ...
  {
#line 54
  tmp___2 = fwrite((void const   */* __restrict  */)((void const   *)(data + 1)),
                   (size_t )1, (size_t )(len - 1), (FILE */* __restrict  */)f);
  }
#line 54
...
#line 105
    memcpy((void */* __restrict  */)(*data + *len), (void const   */* __restrict  */)((void const   *)sd),
           (size_t )sl);
#line 106
    *len += sl;
#line 103
...
#line 143
  *data = realloc(*data, (size_t )*len);
#line 144
  strcpy((char */* __restrict  */)((char *)*data), (char const   */* __restrict  */)((char const   *)(buf)));
  }
#line 145
  return (0);
}
...
#line 49
  memcpy((void */* __restrict  */)((void *)(cmd_res_type)), (void const   */* __restrict  */)((void const   *)spec),
...
#line 58
  ...
  {
#line 60
  cmd_res = res_lookup(cmd_rf, cmd_res_type, (int16_t )cmd_res_id);
  }
#line 61
  if (! cmd_res) {
    {
...
#line 78
    strcpy((char */* __restrict  */)cmd_ifname, (char const   */* __restrict  */)((char const   *)*(argv + 1)));
    }
  }
#line 80
  if (! cmd_ifname) {
...
#line 103
    strcpy((char */* __restrict  */)cmd_ofname, (char const   */* __restrict  */)((char const   *)*(argv + 1)));
    }
  }
#line 105
  if (cmd_ofname) {
...
#line 133
  ...
  {
#line 136
  cmd_res = res_new(cmd_rf, cmd_res_type, (int16_t )cmd_res_id);
  }
#line 137
  return (0);
}
...
#line 244
    ...
    {
#line 244
    tmp___4 = fopen((char const   */* __restrict  */)((char const   *)*(argv + 2)),
...
#line 81
    memcpy((void */* __restrict  */)((void *)((f->tt + ti)->type)), (void const   */* __restrict  */)((void const   *)type),
           sizeof(type));
#line 82
...
#line 123
    r->data = (char *)tmp;
#line 124
    memcpy((void */* __restrict  */)((void *)r->data), (void const   */* __restrict  */)((void const   *)p),
           (size_t )len);
    }
  } else {
#line 126
...
{ 
  ...
  {
#line 131
  memcpy((void */* __restrict  */)((void *)type), (void const   */* __restrict  */)((void const   *)(((r->f)->tt + r->ti)->type)),
         sizeof(type));
  }
#line 132
  return;
...
#line 139
  r->name = (char *)tmp___0;
#line 140
  memcpy((void */* __restrict  */)((void *)r->name), (void const   */* __restrict  */)((void const   *)name),
         (size_t )r->namelen);
#line 141
...
#line 207
    if (((int )r->attr << i) & 128) {
#line 207
      tmp = (int )((int const   )*(res_attrch + i));
    } else {
#line 207
      tmp = (int )((int const   )'-');
    }
...
#line 266
    c->buf = (char *)tmp;
#line 267
    tmp___0 = fread((void */* __restrict  */)((void *)(c->buf + c->len)), (size_t )1,
                    (size_t )4096, (FILE */* __restrict  */)stream);
#line 267
    n = (int )tmp___0;
#line 268
    c->len += n;
...
#line 293
    r = res_new(c->f, t->type, (int16_t )tmp___0);
#line 294
...
#line 373
  len = tmp;
#line 375
  tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)(& len)), sizeof(len),
...
#line 376
  ...
  {
#line 377
  tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)r->data), (size_t )1,
                   (size_t )r->datalen, (FILE */* __restrict  */)stream);
  }
#line 377
...
#line 425
  tmp = fwrite((void const   */* __restrict  */)((void const   *)(& rh)), sizeof(rh),
               (size_t )1, (FILE */* __restrict  */)stream);
  }
#line 425
  if (tmp != 1UL) {
...
#line 445
  tmp___2 = fwrite((void const   */* __restrict  */)((void const   *)(& mh)), sizeof(mh),
                   (size_t )1, (FILE */* __restrict  */)stream);
  }
#line 445
  if (tmp___2 != 1UL) {
...
#line 452
    ...
    {
#line 454
    memcpy((void */* __restrict  */)((void *)(type.type)), (void const   */* __restrict  */)((void const   *)(& (f->tt + ti)->type)),
           sizeof(restype_t ));
#line 455
...
#line 457
    tmp___3 = fwrite((void const   */* __restrict  */)((void const   *)(& type)),
                     sizeof(type), (size_t )1, (FILE */* __restrict  */)stream);
    }
#line 457
    if (tmp___3 != 1UL) {
#line 458
...
#line 472
      tmp___6 = fwrite((void const   */* __restrict  */)((void const   *)(& ref)),
                       sizeof(ref), (size_t )1, (FILE */* __restrict  */)stream);
      }
#line 472
      if (tmp___6 != 1UL) {
#line 473
...
#line 485
      ...
      {
#line 486
      tmp___9 = fwrite((void const   */* __restrict  */)((void const   *)r->name),
                       (size_t )1, (size_t )r->namelen, (FILE */* __restrict  */)stream);
      }
#line 486
