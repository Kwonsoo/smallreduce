...
#line 221
    ...
    {
#line 223
    strcpy((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)(i->name)));
#line 224
    strcat((char */* __restrict  */)tmp, (char const   */* __restrict  */)name);
#line 225
    result = fopen((char const   */* __restrict  */)((char const   *)tmp), (char const   */* __restrict  */)flags);
#line 226
    free((void *)tmp);
    }
#line 227
...
#line 303
    *tmp___0 = 0;
#line 304
    tmp___1 = fread((void */* __restrict  */)((void *)(buf)), (size_t )1, (size_t )300,
                    (FILE */* __restrict  */)tmp);
#line 304
    len = (int )tmp___1;
    }
...
#line 315
      clearerr(real);
#line 316
      tmp___5 = fwrite((void const   */* __restrict  */)((void const   *)(& buf[l])),
                       (size_t )1, (size_t )(len - l), (FILE */* __restrict  */)real);
#line 316
      size = (int )tmp___5;
      }
#line 317
...
#line 764
      ...
      {
#line 766
      strcpy((char */* __restrict  */)((tmp->dir)->name), (char const   */* __restrict  */)((char const   *)((stack[sp].dir)->name)));
      }
    } else {
#line 769
...
#line 1500
    ...
    {
#line 1502
    memcpy((void */* __restrict  */)((void *)buffer), (void const   */* __restrict  */)((void const   *)(short_buffer)),
           (size_t )301);
    }
    {
#line 1503
...
#line 1541
    ...
    {
#line 1543
    memcpy((void */* __restrict  */)((void *)(buffer + newpos)), (void const   */* __restrict  */)((void const   *)((stack[sp].macro_line)->line + pos)),
           (size_t )(arg->pos - pos));
#line 1545
    newpos += arg->pos - pos;
#line 1546
    strcpy((char */* __restrict  */)(buffer + newpos), (char const   */* __restrict  */)((char const   *)*(stack[sp].macro_args + arg->which)));
#line 1547
...
#line 1541
  ...
  {
#line 1550
  strcpy((char */* __restrict  */)(buffer + newpos), (char const   */* __restrict  */)((char const   *)((stack[sp].macro_line)->line + pos)));
#line 1551
...
#line 1590
    ...
    {
#line 1592
    memcpy((void */* __restrict  */)((void *)*(args + (numargs - 1U))), (void const   */* __restrict  */)((void const   *)c),
           (size_t )(*ptr - c));
#line 1593
...
#line 2525
      ...
      {
#line 2527
      strcpy((char */* __restrict  */)(name->name), (char const   */* __restrict  */)((char const   *)nm));
#line 2528
      free((void *)nm);
#line 2529
      sp ++;
...
#line 2564
      while (1) {
        ...
        {
#line 2567
        tmp___34 = fread((void */* __restrict  */)((void *)(filebuffer)), (size_t )1,
                         (size_t )4096, (FILE */* __restrict  */)incfile);
#line 2567
        num = tmp___34;
        }
#line 2568
...
#line 2569
        ...
        {
#line 2570
        tmp___37 = fwrite((void const   */* __restrict  */)((void const   *)(filebuffer)),
                          (size_t )1, num, (FILE */* __restrict  */)outfile);
        }
#line 2570
        if (num != tmp___37) {
          {
...
#line 2641
      ...
      {
#line 2643
      strcpy((char */* __restrict  */)m->name, (char const   */* __restrict  */)((char const   *)(lastlabel->name)));
      }
#line 2644
      if (lastlabel->prev) {
#line 2645
