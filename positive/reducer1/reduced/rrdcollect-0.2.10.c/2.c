...
#line 357
    memcpy((void */* __restrict  */)((void *)*(test___0->match + i)), (void const   */* __restrict  */)((void const   *)(& match)),
...
#line 438
  action.sa_flags = 0;
#line 439
  sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 440
  sigaction(3, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 441
  sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 442
  sigaction(1, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 443
  sigaction(10, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 444
  sigaction(12, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 447
...
#line 448
  action.sa_flags = 0;
#line 449
  sigaction(11, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 450
  sigaction(8, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 451
  sigaction(7, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 453
...
#line 455
  setitimer((__itimer_which_t )0, (struct itimerval  const  */* __restrict  */)((struct itimerval  const  *)(& period)),
...
#line 87
  memcpy((void */* __restrict  */)((void *)(*(test + i))->uri), (void const   */* __restrict  */)((void const   *)uri),
         sizeof(struct uri_t ));
#line 89
  (*(test + i))->count = 0;
#line 90
