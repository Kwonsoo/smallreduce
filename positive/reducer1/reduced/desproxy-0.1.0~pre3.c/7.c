...
#line 63
  if (connection == 9) {
    {
#line 65
    memcpy((void */* __restrict  */)((void *)(& buffer___0[2])), (void const   */* __restrict  */)((void const   *)(UDP_buffer)),
           (size_t )size);
#line 66
...
#line 66
    htons_size = (int )tmp;
#line 67
    memcpy((void */* __restrict  */)((void *)(buffer___0)), (void const   */* __restrict  */)((void const   *)(& htons_size)),
           (size_t )2);
#line 68
    debug_printf("UDP\n");
    }
    ...
    {
#line 72
    memcpy((void */* __restrict  */)((void *)(buffer___0)), (void const   */* __restrict  */)((void const   *)(requests[connection].buffer)),
           (size_t )(size + 2));
#line 73
    debug_printf("TCP\n");
    }
...
#line 177
    printf((char const   */* __restrict  */)((char const   *)tmp___2), tmp___1, (int )tmp___0);
    }
#line 179
...
#line 220
    nfound = select(maxfd + 1, (fd_set */* __restrict  */)(& rmask), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 253
            ...
            {
#line 256
            memcpy((void */* __restrict  */)((void *)(& requests[connection].buffer[requests[connection].bib])),
                   (void const   */* __restrict  */)((void const   *)(buffer)), (size_t )count);
#line 259
...
#line 282
    tmp___9 = recvfrom(client_socket[9], (void */* __restrict  */)((void *)(UDP_buffer)),
                       (size_t )512, 0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& client)),
                       (socklen_t */* __restrict  */)(& client_length));
#line 282
    count = (int )tmp___9;
    }
...
#line 126
  debug_printf(">EOC(%d)\n", connection);
#line 127
  airac_observe(connection_status, connection);
#line 127
...
#line 254
    if (count < 1500) {
      {
#line 256
      memcpy((void */* __restrict  */)((void *)(HTTP_return_code)), (void const   */* __restrict  */)((void const   *)(& buffer[count + 1])),
             (size_t )3);
#line 257
...
#line 377
  memcpy((void */* __restrict  */)((void *)(& proxy.sin_addr)), (void const   */* __restrict  */)((void const   *)*(proxy_hostent->h_addr_list + 0)),
...
#line 389
  strcat((char */* __restrict  */)(string), (char const   */* __restrict  */)((char const   *)remote_host___0));
#line 390
  strcat((char */* __restrict  */)(string), (char const   */* __restrict  */)":");
#line 391
  strcat((char */* __restrict  */)(string), (char const   */* __restrict  */)((char const   *)remote_port___0));
#line 392
...
#line 399
    strncpy((char */* __restrict  */)(User_Agent), (char const   */* __restrict  */)((char const   *)tmp___8),
            (size_t )255);
    }
  } else {
    {
#line 403
  ...
  {
#line 405
  strcat((char */* __restrict  */)(string), (char const   */* __restrict  */)((char const   *)(User_Agent)));
#line 406
...
#line 410
    strncpy((char */* __restrict  */)(proxy_user), (char const   */* __restrict  */)((char const   *)tmp___10),
            (size_t )255);
#line 411
...
#line 413
    strcat((char */* __restrict  */)(string), (char const   */* __restrict  */)((char const   *)(proxy_authorization_base64)));
#line 414
...
#line 644
    strcpy((char */* __restrict  */)(username), (char const   */* __restrict  */)((char const   *)tmp___0));
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 653
  strcpy((char */* __restrict  */)(password), (char const   */* __restrict  */)((char const   *)tmp___3));
#line 658
...
#line 239
      ...
      {
#line 241
      strncat((char */* __restrict  */)remote_host, (char const   */* __restrict  */)((char const   *)((char *)(buffer))),
              (size_t )1);
#line 233
