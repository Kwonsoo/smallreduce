...
#line 39
  ...
  {
#line 44
  strcpy((char */* __restrict  */)tmpbuf, (char const   */* __restrict  */)((char const   *)(buf + i)));
#line 45
  strcpy((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)tmpbuf));
#line 46
  free((void *)tmpbuf);
  }
#line 47
...
#line 87
    newbuf = (char *)tmp___2;
#line 88
    strcpy((char */* __restrict  */)newbuf, (char const   */* __restrict  */)((char const   *)*buffer));
#line 89
...
#line 188
  if (optdest) {
    {
#line 189
    strcpy((char */* __restrict  */)optdest, (char const   */* __restrict  */)((char const   *)tmpbuf));
    }
  } else {
    {
#line 191
    strcpy((char */* __restrict  */)text, (char const   */* __restrict  */)((char const   *)tmpbuf));
    }
  }
  {
#line 192
...
#line 215
    ...
    {
#line 223
    memcpy((void */* __restrict  */)((void *)(dest + outpos)), (void const   */* __restrict  */)((void const   *)(outbytes)),
           (size_t )towrite);
#line 224
    outpos += towrite;
#line 225
...
#line 241
    ...
    {
#line 243
    memcpy((void */* __restrict  */)((void *)(inthree)), (void const   */* __restrict  */)((void const   *)(input + 3 * i)),
           (size_t )3);
#line 244
...
#line 252
    memcpy((void */* __restrict  */)((void *)(output + 4 * i)), (void const   */* __restrict  */)((void const   *)(outfour)),
           (size_t )4);
#line 241
    i ++;
    }
...
#line 277
  ...
  {
#line 279
  memcpy((void */* __restrict  */)((void *)(output + 4 * i)), (void const   */* __restrict  */)((void const   *)"\000"),
         (size_t )1);
  }
#line 280
  return;
...
#line 325
      if (tmp == 0) {
        {
#line 326
        strncpy((char */* __restrict  */)(messageid), (char const   */* __restrict  */)((char const   *)(linebuf)),
...
#line 337
    if (tmp___7 == 0) {
      {
#line 337
      tmp___8 = sscanf((char const   */* __restrict  */)((char const   *)(linebuf)),
                       (char const   */* __restrict  */)((char const   *)(uuscanspec)),
...
#line 456
    if (configuration.search_zip == 2) {
      {
#line 461
      strncpy((char */* __restrict  */)(textbuf), (char const   */* __restrict  */)((char const   *)(linebuf)),
              sizeof(textbuf));
#line 462
...
#line 474
            inzip.within = 1;
#line 475
            strncpy((char */* __restrict  */)(inzip.ct_fname.name), (char const   */* __restrict  */)((char const   *)(zipstate.filename)),
...
#line 505
    ...
    {
#line 509
    tmp___20 = fputs((char const   */* __restrict  */)((char const   *)(linebuf)),
                     (FILE */* __restrict  */)dest);
    }
#line 509
    if (tmp___20 == -1) {
#line 510
...
#line 636
    ...
    {
#line 639
    tmp___13 = fputs((char const   */* __restrict  */)((char const   *)(linebuf)),
                     (FILE */* __restrict  */)dest);
    }
#line 639
    if (tmp___13 == -1) {
...
#line 694
      tmp___6 = sscanf((char const   */* __restrict  */)((line + sizeof("Content-Type:")) - 1),
                       (char const   */* __restrict  */)((char const   *)(scanspec)),
                       m_attachment->content_type);
      }
#line 694
      if (tmp___6 == 1) {
        {
...
#line 710
          tmp___7 = sscanf((char const   */* __restrict  */)((line + sizeof("Content-Transfer-Encoding:")) - 1),
                           (char const   */* __restrict  */)((char const   *)(scanspec___0)),
                           m_attachment->content_enc);
          }
#line 710
          if (tmp___7 == 1) {
...
#line 721
            tmp___8 = sscanf((char const   */* __restrict  */)((line + sizeof("Content-ID:")) - 1),
                             (char const   */* __restrict  */)((char const   *)(scanspec___1)),
                             m_attachment->content_id);
            }
#line 721
            if (tmp___8 == 1) {
...
#line 750
      sprintf((char */* __restrict  */)(scanspec4), (char const   */* __restrict  */)"%%*[ =]%%%d[^\r\n\";]",
              511);
#line 751
      tmp___20 = sscanf((char const   */* __restrict  */)((char const   *)((nameloc + sizeof("name")) - 1)),
                        (char const   */* __restrict  */)((char const   *)(scanspec1)),
                        parsed);
      }
#line 751
      if (tmp___20 == 1) {
#line 751
        ...
        {
#line 751
        tmp___21 = sscanf((char const   */* __restrict  */)((char const   *)((nameloc + sizeof("name")) - 1)),
                          (char const   */* __restrict  */)((char const   *)(scanspec2)),
                          parsed);
        }
#line 751
        if (tmp___21 == 1) {
#line 751
          ...
          {
#line 751
          tmp___22 = sscanf((char const   */* __restrict  */)((char const   *)((nameloc + sizeof("name")) - 1)),
                            (char const   */* __restrict  */)((char const   *)(scanspec3)),
                            parsed);
          }
#line 751
          if (tmp___22 == 1) {
#line 751
            ...
            {
#line 751
            tmp___23 = sscanf((char const   */* __restrict  */)((char const   *)((nameloc + sizeof("name")) - 1)),
                              (char const   */* __restrict  */)((char const   *)(scanspec4)),
                              parsed);
            }
#line 751
            if (tmp___23 == 1) {
...
#line 769
              strncat((char */* __restrict  */)((m_attachment->curspec)->name), (char const   */* __restrict  */)((char const   *)(parsed)),
                      (size_t )remaining);
              }
            }
          }
...
#line 780
          sprintf((char */* __restrict  */)(scanspec___2), (char const   */* __restrict  */)"%%*[\t ]%%%d[^\r\n\"]",
                  511);
#line 781
          tmp___25 = sscanf((char const   */* __restrict  */)orgline, (char const   */* __restrict  */)((char const   *)(scanspec___2)),
                            parsed___0);
          }
#line 781
          if (tmp___25 == 1) {
...
#line 784
              strncat((char */* __restrict  */)((m_attachment->curspec)->name), (char const   */* __restrict  */)((char const   *)(parsed___0)),
...
#line 825
  ...
  {
#line 829
  strcpy((char */* __restrict  */)((m_attach->curspec)->oldname), (char const   */* __restrict  */)((char const   *)((m_attach->curspec)->name)));
  }
#line 831
...
#line 862
      strcat((char */* __restrict  */)((m_attach->curspec)->name), (char const   */* __restrict  */)((char const   *)(configuration.new_extension)));
      }
    }
  }
  {
#line 866
  strcpy((char */* __restrict  */)(m_attach->content_type), (char const   */* __restrict  */)((char const   *)(configuration.new_mime_type)));
  }
#line 867
  return (1);
}
...
#line 891
      strcpy((char */* __restrict  */)listcopy, (char const   */* __restrict  */)((char const   *)configuration.banned_files));
#line 892
...
#line 942
  strncpy((char */* __restrict  */)(extension), (char const   */* __restrict  */)((char const   *)(lastdot + 1)),
...
#line 952
    strcpy((char */* __restrict  */)listcopy, (char const   */* __restrict  */)((char const   *)configuration.badlist));
#line 953
    token = strtok((char */* __restrict  */)listcopy, (char const   */* __restrict  */)"\t, \n");
    }
    {
...
#line 1004
    strcpy((char */* __restrict  */)listcopy, (char const   */* __restrict  */)((char const   *)configuration.goodlist));
#line 1005
    token = strtok((char */* __restrict  */)listcopy, (char const   */* __restrict  */)"\t, \n");
    }
    {
...
#line 1118
    ...
    {
#line 1059
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(field + pos)),
                     (char const   */* __restrict  */)((char const   *)(scanspec)),
                     fieldspec->charenc);
    }
#line 1059
...
#line 1064
      ...
      {
#line 1059
      tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(field + pos)),
                       (char const   */* __restrict  */)((char const   *)(scanspec + 1)),
                       fieldspec->charenc);
      }
#line 1059
      if (tmp___3 == 1) {
...
#line 1127
    ...
    {
#line 1131
    strcpy((char */* __restrict  */)field, (char const   */* __restrict  */)((char const   *)result));
#line 1132
    free((void *)result);
    }
#line 1133
...
#line 1300
  strcpy((char */* __restrict  */)(taglist), (char const   */* __restrict  */)((char const   *)(configuration.htmlwarn_pos)));
#line 1301
...
#line 1315
        ...
        {
#line 1316
        tag = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\t, \n");
        }
      }
    }
    {
...
#line 1329
    ...
    {
#line 1330
    tmp___5 = fread((void */* __restrict  */)((void *)dump_buf), (size_t )dump_size,
                    (size_t )1, (FILE */* __restrict  */)source);
    }
#line 1330
    if (tmp___5 < 1UL) {
#line 1331
...
#line 83
  ...
  {
#line 86
  config = fopen((char const   */* __restrict  */)((char const   *)options->config_file),
...
#line 102
    ...
    {
#line 103
    tmp___24 = sscanf((char const   */* __restrict  */)((char const   *)(confline)),
...
#line 125
                  if (tmp___17 == 0) {
                    {
#line 126
                    strcpy((char */* __restrict  */)(options->generic_name), (char const   */* __restrict  */)((char const   *)(parameter)));
                    }
                  } else {
                    {
#line 127
...
#line 127
                    if (tmp___16 == 0) {
                      {
#line 128
                      strcpy((char */* __restrict  */)(options->new_extension), (char const   */* __restrict  */)((char const   *)(parameter)));
                      }
                    } else {
                      {
#line 129
...
#line 130
                        strcpy((char */* __restrict  */)(options->new_mime_type),
                               (char const   */* __restrict  */)((char const   *)(parameter)));
                        }
                      } else {
                        {
#line 131
