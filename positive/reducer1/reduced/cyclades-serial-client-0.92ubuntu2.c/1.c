...
#line 110
    ...
    {
#line 112
    tmp___0 = stat((char const   */* __restrict  */)((char const   *)cyclades_devices[i]),
                   (struct stat */* __restrict  */)(& device_stat));
    }
#line 112
    if (! tmp___0) {
#line 114
...
#line 134
  tmp___0 = sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& act)),
...
#line 145
    if (! no_ign_pipe) {
      {
#line 147
      tmp___1 = sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& oldact)),
...
#line 159
  tmp___4 = select(socket_fd + 1, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 162
    if (! no_ign_pipe) {
      {
#line 164
      tmp___3 = sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& oldact)),
                          (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
      }
#line 164
      if (tmp___3) {
...
#line 171
  if (! no_ign_pipe) {
    {
#line 173
    tmp___6 = sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& oldact)),
                        (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
    }
#line 173
    if (tmp___6) {
...
#line 372
  if (tmp___9) {
    {
#line 374
    memcpy((void */* __restrict  */)((void *)(& term.c_cc)), (void const   */* __restrict  */)((void const   *)(& termios_p->c_cc)),
           sizeof(term.c_cc));
#line 375
    a_success ++;
    }
...
#line 152
    ...
    {
#line 152
    memcpy((void */* __restrict  */)((void *)bp->b_ins), (void const   */* __restrict  */)((void const   *)(Comibuf)),
           (size_t )ret);
#line 152
    bp->b_ins += ret;
#line 152
...
#line 266
      ...
      {
#line 267
      memcpy((void */* __restrict  */)((void *)(Comobuf)), (void const   */* __restrict  */)((void const   *)bp->b_rem),
             (size_t )size);
#line 267
      bp->b_rem += size;
#line 267
...
#line 652
        ...
        {
#line 652
        memcpy((void */* __restrict  */)memptr, (void const   */* __restrict  */)((void const   *)(& notify)),
               sizeof(int ));
#line 652
        evp->ev_param = memptr;
#line 652
...
#line 656
        ...
        {
#line 656
        memcpy((void */* __restrict  */)memptr___0, (void const   */* __restrict  */)((void const   *)(& notify)),
               sizeof(int ));
#line 656
...
#line 671
          ...
          {
#line 671
          memcpy((void */* __restrict  */)memptr___1, (void const   */* __restrict  */)((void const   *)(& notify)),
                 sizeof(int ));
#line 671
...
#line 675
          ...
          {
#line 675
          memcpy((void */* __restrict  */)memptr___2, (void const   */* __restrict  */)((void const   *)(& notify)),
                 sizeof(int ));
#line 675
...
#line 755
    ...
    {
#line 757
    strcat((char */* __restrict  */)(Debugbuf), (char const   */* __restrict  */)((char const   *)(msgbuf)));
    }
  }
#line 759
  return;
...
#line 884
    ...
    {
#line 886
    strcat((char */* __restrict  */)(Debugbuf), (char const   */* __restrict  */)((char const   *)(linestates)));
    }
  }
#line 888
  return;
...
#line 920
    ...
    {
#line 923
    strcat((char */* __restrict  */)(Debugbuf), (char const   */* __restrict  */)((char const   *)(modemstates)));
    }
  }
#line 925
  return;
...
#line 932
    sprintf((char */* __restrict  */)(buf), (char const   */* __restrict  */)"Speed: %d bps ",
            speed);
#line 933
    strcat((char */* __restrict  */)(Debugbuf), (char const   */* __restrict  */)((char const   *)(buf)));
    }
  }
#line 935
  return;
...
#line 72
  setbuf((FILE */* __restrict  */)stderr, (char */* __restrict  */)((char *)((void *)0)));
#line 74
  sig = 1;
  }
  {
...
#line 117
  fd = -1;
#line 131
  tmp___2 = lstat((char const   */* __restrict  */)((char const   *)dname), (struct stat */* __restrict  */)(& statb));
  }
#line 131
  if (tmp___2 >= 0) {
#line 133
...
#line 216
  ...
  {
#line 222
  tmp___9 = lstat((char const   */* __restrict  */)((char const   *)(stty)), (struct stat */* __restrict  */)(& statb));
  }
#line 222
  if (tmp___9 == -1) {
    {
...
#line 242
  P_mfd = fd;
#line 243
  strcpy((char */* __restrict  */)(P_sname), (char const   */* __restrict  */)((char const   *)(stty)));
#line 244
  strcpy((char */* __restrict  */)(P_devname), (char const   */* __restrict  */)((char const   *)dname));
  }
#line 246
  return (0);
}
...
#line 445
      strcat((char */* __restrict  */)(debbuf), (char const   */* __restrict  */)((char const   *)(oct)));
#line 443
      i ++;
      }
    }
...
#line 502
      ...
      {
#line 502
      memcpy((void */* __restrict  */)((void *)bp->b_ins), (void const   */* __restrict  */)((void const   *)buf),
             (size_t )size);
#line 502
      bp->b_ins += size;
#line 502
...
#line 582
        ...
        {
#line 582
        memcpy((void */* __restrict  */)memptr, (void const   */* __restrict  */)((void const   *)((void *)(& flushmode))),
               sizeof(int ));
#line 582
        evp->ev_param = memptr;
#line 582
...
#line 689
      close(procfd);
#line 690
      tmp___6 = sscanf((char const   */* __restrict  */)((char const   *)(procbuf)),
                       (char const   */* __restrict  */)"%d %s %c %d %d %d %d %u %s",
...
#line 107
      ...
      {
#line 110
      P_contr[i] = accept(P_contr_listen, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
...
#line 211
          select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 55
  if ((unsigned long )hp != (unsigned long )((struct hostent *)((void *)0))) {
    {
#line 56
    memcpy((void */* __restrict  */)((void *)((char *)(& sp->sin_addr))), (void const   */* __restrict  */)((void const   *)*(hp->h_addr_list + 0)),
           (size_t )hp->h_length);
#line 57
...
#line 78
  act.__sigaction_handler.sa_handler = (void (*)(int  ))1;
#line 79
  tmp = sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& act)),
                  (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 79
  if (tmp) {
...
#line 202
    tmp___2 = stat((char const   */* __restrict  */)((char const   *)(P_contrname)),
...
#line 205
    ...
    {
#line 207
    strcpy((char */* __restrict  */)(control_addr.sun_path), (char const   */* __restrict  */)((char const   *)(P_contrname)));
#line 208
