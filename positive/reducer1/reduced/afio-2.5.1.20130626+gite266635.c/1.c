...
#line 32
  ...
  {
#line 34
  infile = fopen((char const   */* __restrict  */)((char const   *)compextsfile),
...
#line 493
    ...
    {
#line 495
    logfile = fopen((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"a");
    }
#line 495
...
#line 701
    optind ++;
#line 701
    arname = strcpy((char */* __restrict  */)(arspec), (char const   */* __restrict  */)((char const   *)*(av + tmp___16)));
#line 702
...
#line 769
          ...
          {
#line 770
          tmp___32 = stat((char const   */* __restrict  */)((char const   *)(firstfilename)),
                          (struct stat */* __restrict  */)(& tmpstat.sb_stat));
          }
#line 770
          if (tmp___32 < 0) {
            {
...
#line 997
  len = (int )(last - name);
#line 998
  tmp___1 = strncpy((char */* __restrict  */)(dir), (char const   */* __restrict  */)((char const   *)name),
                    (size_t )len);
#line 998
...
#line 1003
  ...
  {
#line 1004
  strcpy((char */* __restrict  */)(pwd), (char const   */* __restrict  */)((char const   *)(dir)));
  }
#line 1005
  return (0);
}
...
#line 1290
    if (vflag) {
      {
#line 1291
      strcpy((char */* __restrict  */)(local), (char const   */* __restrict  */)((char const   *)(name)));
#line 1292
...
#line 1353
  header[70] = (char )'\000';
#line 1355
  tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(header)), (char const   */* __restrict  */)"%6lo%6lo%6lo%6lo%6lo%6lo%6lo%11lo%6o%11lo",
...
#line 1400
  header[75] = (char )'\000';
#line 1401
  tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(header)), (char const   */* __restrict  */)"%6lo%11lo%6lo%6lo%6lo%6lo%6lo%11lo%6o%11lo",
                   & pasb.PSt_dev, & pasb.PSt_ino, & pasb.PSt_mode, & pasb.PSt_uid,
                   & pasb.PSt_gid, & pasb.PSt_nlink, & pasb.PSt_rdev, & pasb.PSt_mtime,
                   & namelen, & pasb.PSt_size);
  }
...
#line 1451
  header[110] = (char )'\000';
#line 1452
  tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(header)), (char const   */* __restrict  */)"%8lX%16llXm%6lo%8lX%8lX%8lX%8llX%16llXn%4X%4X%4Xs%16llX:",
                   & pasb.PSt_dev, & pasb.PSt_ino, & pasb.PSt_mode, & pasb.PSt_uid,
                   & pasb.PSt_gid, & pasb.PSt_nlink, & pasb.PSt_rdev, & pasb.PSt_mtime,
...
#line 1518
  ...
  {
#line 1519
  memcpy((void */* __restrict  */)((void *)((char *)(& binary))), (void const   */* __restrict  */)((void const   *)(magic + sizeof(unsigned short ))),
...
#line 2015
      ...
      {
#line 2017
      memcpy((void */* __restrict  */)((void *)(magic)), (void const   */* __restrict  */)((void const   *)(magic + 1)),
             sizeof(magic) - 1UL);
#line 2018
...
#line 2083
    ...
    {
#line 2084
    memcpy((void */* __restrict  */)((void *)dst), (void const   */* __restrict  */)((void const   *)bufidx),
           (size_t )have);
#line 2085
    bufidx += have;
#line 2086
...
#line 2446
  if (mem) {
    {
#line 2447
    strcpy((char */* __restrict  */)mem, (char const   */* __restrict  */)((char const   *)str));
    }
  }
#line 2448
  return (mem);
...
#line 2650
            strcat((char */* __restrict  */)msg___0, (char const   */* __restrict  */)((char const   *)myname));
#line 2651
...
#line 2826
    if ((int )firstfilename[0] != 0) {
      {
#line 2829
      strcpy((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)(firstfilename)));
#line 2830
...
#line 2839
    if (tmp___3 == 0) {
      {
#line 2841
      strcpy((char */* __restrict  */)(local), (char const   */* __restrict  */)((char const   *)(name + 4)));
#line 2843
...
#line 2853
      sprintf((char */* __restrict  */)name, (char const   */* __restrict  */)"%s/%s",
              "CONTROL_FILE", label);
#line 2859
      tmp___1 = stat((char const   */* __restrict  */)((char const   *)(local)), (struct stat */* __restrict  */)(& asb->sb_stat));
      }
#line 2859
      if (tmp___1 < 0) {
        {
...
#line 2900
    if (fsname) {
      {
#line 2900
      strcpy((char */* __restrict  */)fsname, (char const   */* __restrict  */)((char const   *)(local)));
      }
    }
#line 2902
    if (hflag) {
      {
#line 2902
      tmp___10 = stat((char const   */* __restrict  */)((char const   *)(local)),
                      (struct stat */* __restrict  */)(& asb->sb_stat));
#line 2902
      tmp___12 = tmp___10;
      }
    } else {
      {
#line 2902
      tmp___11 = lstat((char const   */* __restrict  */)((char const   *)(local)),
                       (struct stat */* __restrict  */)(& asb->sb_stat));
#line 2902
      tmp___12 = tmp___11;
      }
...
#line 2927
    ...
    {
#line 2930
    tmp___14 = readlink((char const   */* __restrict  */)((char const   *)(local)),
                        (char */* __restrict  */)(asb->sb_link), sizeof(asb->sb_link) - 1UL);
#line 2930
...
#line 2997
              *namedot = (char )'\000';
#line 2998
              strcpy((char */* __restrict  */)(uncompto), (char const   */* __restrict  */)((char const   *)name));
#line 2999
              *comp = 1;
              }
            } else {
...
#line 3022
  ...
  {
#line 3024
  strcpy((char */* __restrict  */)(archlink), (char const   */* __restrict  */)((char const   *)(asb->sb_link)));
#line 3026
  tmp___3 = readlink((char const   */* __restrict  */)((char const   *)(local)), (char */* __restrict  */)(asb->sb_link),
...
#line 3045
  if (aflag) {
    {
#line 3047
    tmp___5 = stat((char const   */* __restrict  */)((char const   *)(local)), (struct stat */* __restrict  */)(& atime_sb.sb_stat));
    }
#line 3047
    if (! (tmp___5 < 0)) {
#line 3053
...
#line 3070
      if (asb->sb_stat.st_nlink == 1UL) {
        {
#line 3072
        tmp___7 = stat((char const   */* __restrict  */)((char const   *)(local)),
                       (struct stat */* __restrict  */)(& atime_sb.sb_stat));
        }
#line 3072
        if (tmp___7 >= 0) {
#line 3074
...
#line 3222
  ...
  {
#line 3223
  tmp___8 = lstat((char const   */* __restrict  */)((char const   *)name), (struct stat */* __restrict  */)(& osb.sb_stat));
#line 3223
  exists = tmp___8 == 0;
  }
#line 3223
...
#line 3360
  if (exists) {
    {
#line 3362
    tmp___73 = readlink((char const   */* __restrict  */)((char const   *)name), (char */* __restrict  */)(sname),
                        sizeof(sname));
#line 3362
    ssize = (int )tmp___73;
    }
...
#line 3754
      if (arfd != 1) {
        {
#line 3760
        strncpy((char */* __restrict  */)(toc_name), (char const   */* __restrict  */)((char const   *)(name)),
                (size_t )1024);
#line 3761
        memcpy((void */* __restrict  */)((void *)(& toc_sb)), (void const   */* __restrict  */)((void const   *)(& sb___0)),
               sizeof(Stat ));
#line 3762
...
#line 3792
      if (hflag) {
        {
#line 3792
        tmp___8 = stat((char const   */* __restrict  */)((char const   *)(fsname)),
...
#line 3792
        ...
        {
#line 3792
        tmp___9 = lstat((char const   */* __restrict  */)((char const   *)(fsname)),
                        (struct stat */* __restrict  */)(& st));
#line 3792
        tmp___10 = tmp___9;
        }
...
#line 4215
    ...
    {
#line 4216
    memcpy((void */* __restrict  */)((void *)bufidx), (void const   */* __restrict  */)((void const   *)idx),
           (size_t )have);
#line 4217
    bufidx += have;
#line 4218
...
#line 4240
    ...
    {
#line 4241
    tmp___0 = stat((char const   */* __restrict  */)((char const   *)*avx), (struct stat */* __restrict  */)(& sb___0.sb_stat));
    }
#line 4241
    if (tmp___0 < 0) {
      {
...
#line 4318
    dir ++;
#line 4318
    tmp___0 = strcpy((char */* __restrict  */)(to), (char const   */* __restrict  */)((char const   *)*tmp));
#line 4318
    tmp___1 = strcat((char */* __restrict  */)tmp___0, (char const   */* __restrict  */)"/");
#line 4318
    tmp___2 = strcat((char */* __restrict  */)tmp___1, (char const   */* __restrict  */)((char const   *)from));
#line 4318
...
#line 4352
  if (! sflagused) {
    {
#line 4354
    strcpy((char */* __restrict  */)dptr, (char const   */* __restrict  */)((char const   *)sptr));
    }
#line 4355
    return;
  }
...
{ 
  ...
  {
#line 100
  infile = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
  }
#line 101
  if ((unsigned long )infile == (unsigned long )((FILE *)0)) {
#line 101
...
#line 181
  ...
  {
#line 183
  strcpy((char */* __restrict  */)(namec), (char const   */* __restrict  */)((char const   *)name));
#line 184
...
#line 128
  ...
  {
#line 132
  memcpy((void */* __restrict  */)((void *)(membank + memsize)), (void const   */* __restrict  */)((void const   *)buf),
         (size_t )count);
#line 133
...
#line 146
  ...
  {
#line 147
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(membank + membytesread)),
         (size_t )count);
#line 148
