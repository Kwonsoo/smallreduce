...
#line 676
  ...
  {
#line 680
  strcat((char */* __restrict  */)location, (char const   */* __restrict  */)((char const   *)(tail)));
  }
#line 681
  return;
}
...
#line 751
  if ((unsigned long )lun != (unsigned long )((void *)0)) {
    {
#line 752
    memcpy((void */* __restrict  */)((void *)(& cmd->LUN_info)), (void const   */* __restrict  */)((void const   *)lun),
           (size_t )8);
    }
  }
#line 753
...
#line 758
  memcpy((void */* __restrict  */)((void *)(cmd->Request.CDB)), (void const   */* __restrict  */)((void const   *)cdb),
         (size_t )cdblen);
#line 759
...
#line 803
  memcpy((void */* __restrict  */)((void *)(& cdb[6])), (void const   */* __restrict  */)((void const   *)(& bufsize)),
         (size_t )4);
#line 805
...
#line 812
  ...
  {
#line 817
  memcpy((void */* __restrict  */)((void *)(& becount)), (void const   */* __restrict  */)((void const   *)lun),
         sizeof(becount));
#line 818
...
#line 883
  memcpy((void */* __restrict  */)((void *)(& cmd.LUN_info)), (void const   */* __restrict  */)((void const   *)controller_lun),
         sizeof(cmd.LUN_info));
#line 884
...
#line 1168
  ...
  {
#line 1171
  strncpy((char */* __restrict  */)(enclosure_name), (char const   */* __restrict  */)((char const   *)((char *)(bus_param->inquiry.product_id))),
          (size_t )16);
#line 1172
...
#line 1179
  ...
  {
#line 1182
  strncpy((char */* __restrict  */)(enclosure_name), (char const   */* __restrict  */)((char const   *)(enclosure_name + i)),
          (size_t )(16 - i));
#line 1187
  strncpy((char */* __restrict  */)(enclosure_sn), (char const   */* __restrict  */)((char const   *)(bus_param->chassis_sn)),
          (size_t )40);
#line 1188
...
#line 1195
  ...
  {
#line 1198
  strncpy((char */* __restrict  */)(enclosure_sn), (char const   */* __restrict  */)((char const   *)(enclosure_sn + i)),
          (size_t )(40 - i));
#line 1201
...
#line 1447
  memcpy((void */* __restrict  */)((void *)(serial_no_map[i].serial_no)), (void const   */* __restrict  */)((void const   *)serial_no),
         (size_t )16);
#line 1448
...
#line 1449
  strcpy((char */* __restrict  */)serial_no_map[i].device_node, (char const   */* __restrict  */)((char const   *)device_node));
  }
#line 1450
  return;
}
...
#line 1495
    strcpy((char */* __restrict  */)*scsi_device_node, (char const   */* __restrict  */)((char const   *)device_node));
    }
#line 1496
    return;
  }
...
#line 1515
        strcpy((char */* __restrict  */)*scsi_device_node, (char const   */* __restrict  */)((char const   *)(filename)));
        }
#line 1516
        goto while_break;
      } else {
...
#line 1751
    ...
    {
#line 1752
    memcpy((void */* __restrict  */)((void *)(cciss_to_bmic.addr[i].logical_lun)),
           (void const   */* __restrict  */)((void const   *)(& lunlist[i + 1])),
           (size_t )8);
    }
#line 1754
    if (debug) {
...
#line 1770
    ...
    {
#line 1772
    memcpy((void */* __restrict  */)((void *)(& cciss_to_bmic.addr[i].inq_pg_0x83_data[0])),
           (void const   */* __restrict  */)((void const   *)(& buf[8])), (size_t )16);
    }
    __Cont: 
#line 1751
    i ++;
...
#line 1826
    ...
    {
#line 1830
    memcpy((void */* __restrict  */)((void *)(controller_lun_list[num_controllers])),
           (void const   */* __restrict  */)((void const   *)this_lun_data), (size_t )8);
#line 1832
...
#line 1926
          memcpy((void */* __restrict  */)((void *)(cciss_to_bmic.addr[k].controller_lun)),
                 (void const   */* __restrict  */)((void const   *)this_lun_data),
                 (size_t )8);
#line 1928
          memcpy((void */* __restrict  */)((void *)(cciss_to_bmic.addr[k].bmic_id_ctlr_data)),
                 (void const   */* __restrict  */)((void const   *)(id_logical_drive_data.unique_volume_id)),
                 (size_t )16);
#line 1930
...
#line 1938
        ...
        {
#line 1939
        memcpy((void */* __restrict  */)((void *)(missed_drive[nmissed].controller_lun)),
               (void const   */* __restrict  */)((void const   *)this_lun_data), (size_t )8);
#line 1941
...
#line 1963
        memcpy((void */* __restrict  */)((void *)(cciss_to_bmic.addr[k].controller_lun)),
               (void const   */* __restrict  */)((void const   *)(missed_drive[m].controller_lun)),
               (size_t )8);
#line 1965
...
#line 2017
  memcpy((void */* __restrict  */)((void *)(& c->LUN_info)), (void const   */* __restrict  */)((void const   *)lunaddr),
         (size_t )8);
#line 2018
...
#line 2404
  memset((void *)(& ldstatus), 0, sizeof(ldstatus));
#line 2405
  memcpy((void */* __restrict  */)((void *)(& c.LUN_info)), (void const   */* __restrict  */)((void const   *)(cciss_to_bmic.addr[volume_number].controller_lun)),
         (size_t )8);
#line 2407
  c.Request.CDBLen = (__u8 )10;
#line 2408
