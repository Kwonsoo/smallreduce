...
#line 75
    ...
    {
#line 77
    strcpy((char */* __restrict  */)(script_name), (char const   */* __restrict  */)((char const   *)(new_name)));
    }
  }
  {
#line 83
  sfp = fopen((char const   */* __restrict  */)((char const   *)(script_name)), (char const   */* __restrict  */)"r+t");
  }
#line 83
...
#line 92
    ...
    {
#line 83
    sfp = fopen((char const   */* __restrict  */)((char const   *)(script_name)),
                (char const   */* __restrict  */)"w+t");
    }
#line 83
    if ((unsigned long )sfp != (unsigned long )((void *)0)) {
      {
...
#line 294
  if (tmp) {
    {
#line 296
    strcpy((char */* __restrict  */)(command_name), (char const   */* __restrict  */)((char const   *)(new_name)));
#line 298
    rfp = fopen((char const   */* __restrict  */)((char const   *)(new_name)), (char const   */* __restrict  */)"wt");
    }
#line 298
...
#line 420
    strcpy((char */* __restrict  */)(command_name), (char const   */* __restrict  */)((char const   *)(new_name)));
#line 422
    pfp = fopen((char const   */* __restrict  */)((char const   *)(new_name)), (char const   */* __restrict  */)"rt");
    }
#line 422
...
#line 210
      value = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
    }
  } else
#line 213
  if ((int )type & 1) {
...
#line 506
    addr = (zword )((int )h_globals + 2 * ((int )variable - 16));
#line 507
    *(zmp + (int )addr) = (zbyte )((int )value >> 8);
#line 507
...
#line 130
    if ((int )zargs[3] & 128) {
#line 134
      wvalue = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 136
...
#line 120
  val = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 122
  return (val);
}
}
...
#line 258
  ...
  {
#line 262
  tmp___0 = fread((void */* __restrict  */)((void *)zmp), (size_t )1, (size_t )64,
...
#line 367
    pcp = zmp + size;
#line 369
    tmp___2 = fread((void */* __restrict  */)((void *)pcp), (size_t )1, (size_t )n,
                    (FILE */* __restrict  */)story_fp);
    }
#line 369
    if (tmp___2 != (size_t )n) {
...
#line 407
    memcpy((void */* __restrict  */)((void *)prev_zmp), (void const   */* __restrict  */)((void const   *)zmp),
...
#line 537
    fseek(story_fp, 0L, 0);
#line 539
    tmp = fread((void */* __restrict  */)((void *)zmp), (size_t )1, (size_t )h_dynamic_size,
                (FILE */* __restrict  */)story_fp);
    }
#line 539
...
#line 597
    ...
    {
#line 599
    strcpy((char */* __restrict  */)default_name, (char const   */* __restrict  */)((char const   *)(auxilary_name)));
    }
  }
#line 601
  return;
...
#line 627
    ...
    {
#line 629
    strcpy((char */* __restrict  */)(auxilary_name), (char const   */* __restrict  */)((char const   *)(default_name)));
#line 633
    gfp = fopen((char const   */* __restrict  */)((char const   *)(new_name)), (char const   */* __restrict  */)"rb");
    }
#line 633
...
#line 634
    ...
    {
#line 638
    tmp___1 = fread((void */* __restrict  */)((void *)(zmp + (int )zargs[0])), (size_t )1,
                    (size_t )zargs[1], (FILE */* __restrict  */)gfp);
#line 638
...
#line 654
    ...
    {
#line 656
    strcpy((char */* __restrict  */)(save_name), (char const   */* __restrict  */)((char const   *)(new_name)));
#line 660
    gfp = fopen((char const   */* __restrict  */)((char const   *)(new_name)), (char const   */* __restrict  */)"rb");
    }
#line 660
...
#line 700
            *(zmp + (int )tmp___15) = (zbyte )tmp___16;
#line 699
            i ++;
            }
          }
...
#line 858
  ...
  {
#line 862
  memcpy((void */* __restrict  */)((void *)zmp), (void const   */* __restrict  */)((void const   *)prev_zmp),
         (size_t )h_dynamic_size);
#line 863
...
#line 868
  memcpy((void */* __restrict  */)((void *)sp), (void const   */* __restrict  */)((void const   *)((zbyte *)(curr_undo + 1) + curr_undo->diff_size)),
...
#line 919
    strcpy((char */* __restrict  */)(auxilary_name), (char const   */* __restrict  */)((char const   *)(default_name)));
#line 923
    gfp = fopen((char const   */* __restrict  */)((char const   *)(new_name)), (char const   */* __restrict  */)"wb");
    }
#line 923
    if ((unsigned long )gfp == (unsigned long )((void *)0)) {
#line 924
    ...
    {
#line 928
    tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)(zmp + (int )zargs[0])),
                     (size_t )zargs[1], (size_t )1, (FILE */* __restrict  */)gfp);
#line 928
    success = (zword )tmp___1;
#line 932
    fclose(gfp);
...
#line 986
        if ((int )*(zmp + (int )addr) != tmp___3) {
          {
#line 987
          fputc(skip, gfp);
#line 988
          fputc((int )*(zmp + (int )addr), gfp);
#line 989
          skip = 0;
          }
        } else
...
#line 1061
  memcpy((void */* __restrict  */)((void *)(p + 1)), (void const   */* __restrict  */)((void const   *)undo_diff),
         (size_t )diff_size);
#line 1062
  memcpy((void */* __restrict  */)((void *)((zbyte *)(p + 1) + diff_size)), (void const   */* __restrict  */)((void const   *)sp),
...
#line 83
  size = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 84
...
#line 1102
  tmp = winarg0();
#line 1102
  store(*((zword *)(wp + (int )tmp) + (int )zargs[1]));
  }
#line 1104
  return;
}
...
#line 1279
  tmp = winarg0();
#line 1279
  *((zword *)(wp + (int )tmp) + (int )zargs[1]) = zargs[2];
  }
#line 1281
  return;
}
...
#line 1595
  addr = h_globals;
#line 1596
  global0 = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 1597
  addr = (zword )((int )addr + 2);
#line 1598
  global1 = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 1599
  addr = (zword )((int )addr + 2);
#line 1600
  global2 = (zword )(((int )((zword )*(zmp + (int )addr)) << 8) | (int )*(zmp + ((int )addr + 1)));
#line 1605
  set_window((zword )7);
#line 1607
  print_char((zchar )1);
...
#line 88
  name_addr = (zword )(((int )((zword )*(zmp + (int )obj_addr)) << 8) | (int )*(zmp + ((int )obj_addr + 1)));
#line 90
  return (name_addr);
}
}
...
#line 190
    ...
    {
#line 195
    *(zmp + (int )obj_addr) = zero;
#line 196
    obj_addr = (zword )((int )obj_addr + 1);
#line 197
    older_sibling = *(zmp + (int )obj_addr);
#line 198
    *(zmp + (int )obj_addr) = zero;
#line 202
...
#line 203
    younger_sibling = *(zmp + (int )parent_addr);
    }
#line 207
    if ((int )younger_sibling == (int )object) {
#line 208
      *(zmp + (int )parent_addr) = older_sibling;
    } else {
      {
#line 210
      while (1) {
...
#line 212
        younger_sibling = *(zmp + (int )sibling_addr);
        }
#line 210
        if (! ((int )younger_sibling != (int )object)) {
#line 210
      ...
      while_break: 
#line 214
      *(zmp + (int )sibling_addr) = older_sibling;
    }
  } else {
#line 222
    zero___0 = (zword )0;
...
#line 227
    parent___0 = (zword )(((int )((zword )*(zmp + (int )obj_addr)) << 8) | (int )*(zmp + ((int )obj_addr + 1)));
#line 228
    if (! parent___0) {
#line 229
      return;
    ...
    {
#line 234
    *(zmp + (int )obj_addr) = (zbyte )((int )zero___0 >> 8);
#line 234
    *(zmp + ((int )obj_addr + 1)) = (zbyte )((int )zero___0 & 255);
#line 235
    obj_addr = (zword )((int )obj_addr + 2);
#line 236
    older_sibling___0 = (zword )(((int )((zword )*(zmp + (int )obj_addr)) << 8) | (int )*(zmp + ((int )obj_addr + 1)));
#line 237
    *(zmp + (int )obj_addr) = (zbyte )((int )zero___0 >> 8);
#line 237
    *(zmp + ((int )obj_addr + 1)) = (zbyte )((int )zero___0 & 255);
...
#line 242
    younger_sibling___0 = (zword )(((int )((zword )*(zmp + (int )parent_addr)) << 8) | (int )*(zmp + ((int )parent_addr + 1)));
    }
#line 246
    if ((int )younger_sibling___0 == (int )object) {
#line 247
      *(zmp + (int )parent_addr) = (zbyte )((int )older_sibling___0 >> 8);
#line 247
...
#line 251
        younger_sibling___0 = (zword )(((int )((zword )*(zmp + (int )sibling_addr)) << 8) | (int )*(zmp + ((int )sibling_addr + 1)));
        }
#line 249
        if (! ((int )younger_sibling___0 != (int )object)) {
#line 249
      ...
      while_break___0: 
#line 253
      *(zmp + (int )sibling_addr) = (zbyte )((int )older_sibling___0 >> 8);
#line 253
...
#line 302
  value = *(zmp + (int )obj_addr);
#line 303
  value = (zbyte )((int )value & ~ (128 >> ((int )zargs[1] & 7)));
#line 304
  *(zmp + (int )obj_addr) = value;
  }
#line 306
  return;
}
...
#line 419
    child___0 = (zword )(((int )((zword )*(zmp + (int )obj_addr)) << 8) | (int )*(zmp + ((int )obj_addr + 1)));
#line 423
    store(child___0);
#line 424
...
#line 589
        wprop_val = (zword )(((int )((zword )*(zmp + (int )prop_addr)) << 8) | (int )*(zmp + ((int )prop_addr + 1)));
      }
    } else {
#line 589
      wprop_val = (zword )(((int )((zword )*(zmp + (int )prop_addr)) << 8) | (int )*(zmp + ((int )prop_addr + 1)));
...
#line 737
    sibling___0 = (zword )(((int )((zword )*(zmp + (int )obj_addr)) << 8) | (int )*(zmp + ((int )obj_addr + 1)));
#line 741
    store(sibling___0);
#line 742
...
#line 800
    *(zmp + (int )obj1_addr) = (zbyte )obj2;
#line 801
    obj2_addr = (zword )((int )obj2_addr + 6);
#line 802
    child = *(zmp + (int )obj2_addr);
#line 803
    *(zmp + (int )obj2_addr) = (zbyte )obj1;
#line 804
    obj1_addr = (zword )((int )obj1_addr + 1);
#line 805
    *(zmp + (int )obj1_addr) = child;
  } else {
#line 811
    obj1_addr = (zword )((int )obj1_addr + 6);
#line 812
    *(zmp + (int )obj1_addr) = (zbyte )((int )obj2 >> 8);
#line 812
    *(zmp + ((int )obj1_addr + 1)) = (zbyte )((int )obj2 & 255);
#line 813
    obj2_addr = (zword )((int )obj2_addr + 10);
#line 814
    child___0 = (zword )(((int )((zword )*(zmp + (int )obj2_addr)) << 8) | (int )*(zmp + ((int )obj2_addr + 1)));
#line 815
    *(zmp + (int )obj2_addr) = (zbyte )((int )obj1 >> 8);
#line 815
    *(zmp + ((int )obj2_addr + 1)) = (zbyte )((int )obj1 & 255);
#line 816
    obj1_addr = (zword )((int )obj1_addr + 2);
#line 817
    *(zmp + (int )obj1_addr) = (zbyte )((int )child___0 >> 8);
#line 817
...
#line 873
      v___0 = zargs[2];
#line 874
      *(zmp + (int )prop_addr) = (zbyte )((int )v___0 >> 8);
#line 874
...
#line 379
      if (currlen == (zlong )h_dynamic_size) {
        {
#line 381
        tmp___12 = fread((void */* __restrict  */)((void *)zmp), currlen, (size_t )1,
                         (FILE */* __restrict  */)svf);
        }
#line 381
        if (tmp___12 == 1UL) {
...
#line 437
    ...
    {
#line 438
    tmp___21 = fputc((int )*(zmp + (int )i), svf);
    }
#line 438
    if (! (tmp___21 != -1)) {
#line 438
