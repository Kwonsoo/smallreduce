...
#line 80
    aufile->toStdio = 0;
#line 81
    aufile->sndfile = fopen((char const   */* __restrict  */)((char const   *)infile),
...
#line 200
  tmp___45 = fwrite((void const   */* __restrict  */)((void const   *)(header)), sizeof(header),
                    (size_t )1, (FILE */* __restrict  */)aufile->sndfile);
  }
#line 200
  return ((int )tmp___45);
}
...
#line 299
  tmp___83 = fwrite((void const   */* __restrict  */)((void const   *)(header)), sizeof(header),
                    (size_t )1, (FILE */* __restrict  */)aufile->sndfile);
  }
#line 299
  return ((int )tmp___83);
...
#line 332
  ...
  {
#line 338
  tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)data), (size_t )samples,
                   (size_t )(aufile->bits_per_sample / 8U), (FILE */* __restrict  */)aufile->sndfile);
#line 338
  ret = (int )tmp___0;
  }
#line 340
...
#line 464
  ...
  {
#line 495
  tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)data), (size_t )samples,
                   (size_t )(aufile->bits_per_sample / 8U), (FILE */* __restrict  */)aufile->sndfile);
#line 495
  ret = (int )tmp___1;
  }
...
#line 243
    ...
    {
#line 245
    memcpy((void */* __restrict  */)((void *)*ppBuf), (void const   */* __restrict  */)((void const   *)(f->track[track])->decoderConfig),
...
{ 
  ...
  {
#line 13
  memcpy((void */* __restrict  */)((void *)(data)), (void const   */* __restrict  */)((void const   *)(& src)),
         sizeof(src));
#line 14
  a = (uint32_t )((uint8_t )data[0]);
#line 15
...
#line 71
  if (ptr) {
    {
#line 71
    memcpy((void */* __restrict  */)((void *)((char *)buf->data + buf->written)),
           (void const   */* __restrict  */)ptr, (size_t )bytes);
    }
  }
#line 72
  buf->written += bytes;
...
#line 324
    ...
    {
#line 326
    tag = (mp4ff_tag_t *)(data->tags + metaptr);
#line 327
...
#line 376
    if (! *(mask + metaptr)) {
      {
#line 378
      tag___0 = (mp4ff_tag_t *)(data->tags + metaptr);
#line 379
...
#line 595
    p_out += 4;
#line 597
    memcpy((void */* __restrict  */)((void *)p_out), (void const   */* __restrict  */)((void const   *)new_ilst_buffer),
...
#line 459
  if (adts_out) {
    {
#line 461
    adtsFile = fopen((char const   */* __restrict  */)((char const   *)adts_fn), (char const   */* __restrict  */)"wb");
    }
#line 462
...
#line 471
    ...
    {
#line 478
    b.infile = fopen((char const   */* __restrict  */)((char const   *)aacfile), (char const   */* __restrict  */)"rb");
    }
#line 479
...
#line 510
  tmp___2 = fread((void */* __restrict  */)((void *)b.buffer), (size_t )1, (size_t )4608,
...
#line 570
        tmp___6 = fread((void */* __restrict  */)((void *)b.buffer), (size_t )1, (size_t )4608,
                        (FILE */* __restrict  */)b.infile);
#line 570
        bread = (int )tmp___6;
        }
...
#line 655
      fwrite((void const   */* __restrict  */)((void const   *)adtsData), (size_t )1,
             (size_t )adtsDataSize, (FILE */* __restrict  */)adtsFile);
      }
#line 658
      if ((int )frameInfo.header_type == 2) {
        {
#line 659
        fwrite((void const   */* __restrict  */)((void const   *)(b.buffer + skip)),
               (size_t )1, frameInfo.bytesconsumed - (unsigned long )skip, (FILE */* __restrict  */)adtsFile);
        }
      } else {
        {
#line 661
        fwrite((void const   */* __restrict  */)((void const   *)b.buffer), (size_t )1,
               frameInfo.bytesconsumed, (FILE */* __restrict  */)adtsFile);
        }
      }
    }
    {
...
{ 
  ...
  {
#line 753
  tmp = mp4ff_total_tracks((mp4ff_t const   *)((mp4ff_t___0 const   *)infile));
#line 753
  numTracks = tmp;
#line 755
  i = 0;
...
#line 758
    buff_size = 0;
#line 761
    mp4ff_get_decoder_config((mp4ff_t const   *)((mp4ff_t___0 const   *)infile), (int const   )i,
                             & buff, (unsigned int *)(& buff_size));
    }
#line 763
    if (buff) {
      {
...
#line 828
  ...
  {
#line 831
  mp4File = fopen((char const   */* __restrict  */)((char const   *)mp4file), (char const   */* __restrict  */)"rb");
#line 832
...
#line 852
  ...
  {
#line 856
  tmp___16 = mp4ff_open_read(mp4cb);
#line 856
  infile = (mp4ff_t___0 *)tmp___16;
  }
#line 857
  if (! infile) {
    {
...
#line 875
  buffer_size = 0;
#line 876
  mp4ff_get_decoder_config((mp4ff_t const   *)((mp4ff_t___0 const   *)infile), (int const   )track,
...
#line 887
  ...
  {
#line 890
  tmp___4 = mp4ff_time_scale((mp4ff_t const   *)((mp4ff_t___0 const   *)infile), (int const   )track);
#line 890
...
#line 909
  ot[5] = (char *)"HE AAC";
#line 910
  tmp___6 = mp4ff_num_samples((mp4ff_t const   *)((mp4ff_t___0 const   *)infile),
                              (int const   )track);
#line 910
...
#line 926
  j = mp4ff_meta_get_num_items((mp4ff_t const   *)((mp4ff_t___0 const   *)infile));
#line 927
  k = 0;
  }
  {
...
#line 927
    ...
    {
#line 929
    tmp___8 = mp4ff_meta_get_by_index((mp4ff_t const   *)((mp4ff_t___0 const   *)infile),
                                      (unsigned int )k, & item, & tag);
    }
#line 929
    if (tmp___8) {
#line 931
...
#line 949
  ...
  {
#line 952
  tmp___9 = mp4ff_num_samples((mp4ff_t const   *)((mp4ff_t___0 const   *)infile),
                              (int const   )track);
#line 952
...
#line 963
    buffer_size = 0;
#line 965
    tmp___10 = mp4ff_get_sample_duration((mp4ff_t const   *)((mp4ff_t___0 const   *)infile),
                                         (int32_t const   )track, (int32_t const   )sampleId);
#line 965
    dur = (long )tmp___10;
#line 966
    rc = mp4ff_read_sample((mp4ff_t *)infile, (int const   )track, (int const   )sampleId,
                           & buffer, (unsigned int *)(& buffer_size));
    }
#line 967
    if (rc == 0) {
...
#line 1164
      ...
      {
#line 1166
      strcpy((char */* __restrict  */)audioFileName, (char const   */* __restrict  */)((char const   *)optarg));
      }
    }
#line 1168
    goto switch_break;
...
#line 1177
      ...
      {
#line 1179
      strcpy((char */* __restrict  */)adtsFileName, (char const   */* __restrict  */)((char const   *)optarg));
      }
    }
#line 1181
    goto switch_break;
...
#line 1194
    if (optarg) {
      {
#line 1197
      tmp___5 = sscanf((char const   */* __restrict  */)((char const   *)optarg),
                       (char const   */* __restrict  */)"%s", dr___0);
      }
#line 1197
      if (tmp___5 < 1) {
#line 1199
...
#line 1208
    if (optarg) {
      {
#line 1211
      tmp___6 = sscanf((char const   */* __restrict  */)((char const   *)optarg),
                       (char const   */* __restrict  */)"%s", dr___1);
      }
#line 1211
      if (tmp___6 < 1) {
#line 1213
...
#line 1222
    if (optarg) {
      {
#line 1225
      tmp___7 = sscanf((char const   */* __restrict  */)((char const   *)optarg),
                       (char const   */* __restrict  */)"%s", dr___2);
      }
#line 1225
      if (tmp___7 < 1) {
#line 1227
...
#line 1303
  ...
  {
#line 1305
  strcpy((char */* __restrict  */)aacFileName, (char const   */* __restrict  */)((char const   *)*(argv + optind)));
#line 1310
  begin = clock();
  }
#line 1316
...
#line 1322
      ...
      {
#line 1324
      strcpy((char */* __restrict  */)audioFileName, (char const   */* __restrict  */)((char const   *)aacFileName));
#line 1326
...
#line 1345
    mp4file = 0;
#line 1346
    hMP4File = fopen((char const   */* __restrict  */)((char const   *)aacFileName),
...
#line 1350
  ...
  {
#line 1354
  fread((void */* __restrict  */)((void *)(header)), (size_t )1, (size_t )8, (FILE */* __restrict  */)hMP4File);
  }
#line 1356
  if (! readFromStdin) {
    {
