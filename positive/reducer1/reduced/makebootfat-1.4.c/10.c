...
#line 439
    tmp___7 = le_uint16_read((void const   *)(& boot->bit.fat32.BPB_BkBootSec));
#line 439
    memcpy((void */* __restrict  */)((void *)(format->bootraw + 512U * tmp___7)),
           (void const   */* __restrict  */)((void const   *)(format->bootraw)), (size_t )1024);
    }
  }
  {
#line 442
...
#line 556
  memcpy((void */* __restrict  */)((void *)(fat->table + (format.fatraw_pos - fat->info.fat_pos) * 512U)),
         (void const   */* __restrict  */)((void const   *)(format.fatraw)), (size_t )(format.fatraw_size * 512U));
#line 559
...
#line 634
    ...
    {
#line 636
    memcpy((void */* __restrict  */)((void *)(entry->DE_Name)), (void const   */* __restrict  */)((void const   *)file_name),
           (size_t )l);
#line 638
    dot ++;
#line 640
...
#line 646
    ...
    {
#line 649
    memcpy((void */* __restrict  */)((void *)(entry->DE_Name + 8)), (void const   */* __restrict  */)((void const   *)dot),
           (size_t )l);
    }
  } else {
    {
...
#line 699
  n = (l + 12U) / 13U;
#line 701
  memcpy((void */* __restrict  */)((void *)(entry + n)), (void const   */* __restrict  */)((void const   *)entry),
         (size_t )32);
#line 703
...
#line 794
    ...
    {
#line 797
    tmp___1 = fread((void */* __restrict  */)((void *)(fat->tmp)), (size_t )run, (size_t )1,
                    (FILE */* __restrict  */)f);
    }
#line 797
    if (tmp___1 != 1UL) {
...
#line 1154
  ...
  {
#line 1157
  memcpy((void */* __restrict  */)((void *)(entry + i)), (void const   */* __restrict  */)((void const   *)(longentry)),
         (size_t )(n * 32U));
#line 1159
...
#line 1197
  ...
  {
#line 1201
  memcpy((void */* __restrict  */)((void *)boot), (void const   */* __restrict  */)((void const   *)code),
         (size_t )3);
#line 1202
  memcpy((void */* __restrict  */)((void *)(boot + code_start)), (void const   */* __restrict  */)((void const   *)(code + code_start)),
...
#line 130
  if (bit == 32U) {
    {
#line 131
    memcpy((void */* __restrict  */)((void *)(mbr + 3)), (void const   */* __restrict  */)((void const   *)(boot + 3)),
           (size_t )87);
    }
  } else {
    {
...
#line 427
  s = fread((void */* __restrict  */)((void *)sector), (size_t )1, (size_t )512, (FILE */* __restrict  */)f);
  }
#line 428
  if (s == 0UL) {
    {
...
#line 536
    ...
    {
#line 538
    tmp___1 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)0),
                      0);
#line 538
...
#line 539
    ...
    {
#line 541
    tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)0),
                      0);
#line 541
    drive = (int )tmp___2;
    }
...
#line 787
    count ++;
#line 788
    strcpy((char */* __restrict  */)(device), (char const   */* __restrict  */)((char const   *)(buf)));
    }
    __Cont: 
#line 770
    i ++;
...
#line 890
  ...
  {
#line 893
  memcpy((void */* __restrict  */)((void *)c->data), (void const   */* __restrict  */)data,
         (size_t )(size * 512U));
  }
#line 895
  return (c);
...
#line 920
    ...
    {
#line 923
    memcpy((void */* __restrict  */)((void *)(buf + (c->pos - h->cache_begin) * 512U)),
           (void const   */* __restrict  */)((void const   *)c->data), (size_t )(c->size * 512U));
#line 925
    n = c->next;
#line 926
    cache_free(c);
