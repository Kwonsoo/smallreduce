...
#line 71
  if (len >= rest) {
    {
#line 73
    memcpy((void */* __restrict  */)((void *)(rbuf->buf + rbuf->idx)), (void const   */* __restrict  */)data,
           (size_t )rest);
#line 74
    rbuf->idx = 0;
#line 75
...
#line 100
  if (part1_len > 0) {
    {
#line 101
    memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)((void const   *)((rbuf->buf + rbuf->cap) - part1_len)),
           (size_t )part1_len);
#line 102
    buf += part1_len;
#line 103
    memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)((void const   *)rbuf->buf),
           (size_t )rbuf->idx);
    }
  } else {
    {
#line 105
    memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)((void const   *)((rbuf->buf + rbuf->idx) - ret_len)),
           (size_t )ret_len);
    }
  }
#line 107
...
#line 148
      ...
      {
#line 150
      tmp___4 = lstat((char const   */* __restrict  */)((char const   *)(path)), (struct stat */* __restrict  */)(& st));
      }
#line 150
      if (tmp___4 == -1) {
        {
...
#line 674
    sfp = fopen((char const   */* __restrict  */)((char const   *)srcfile), (char const   */* __restrict  */)"r");
    }
#line 675
...
#line 1127
        if ((unsigned long )(r - q) < sizeof(leave_dir)) {
          {
#line 1128
          memcpy((void */* __restrict  */)((void *)(leave_dir)), (void const   */* __restrict  */)((void const   *)q),
                 (size_t )(r - q));
#line 1129
...
#line 1706
  airac_observe(cur_branch, cur_nest);
#line 1706
...
#line 2203
        ...
        {
#line 2205
        tmp = lstat((char const   */* __restrict  */)((char const   *)((char *)tmp_list->data)),
