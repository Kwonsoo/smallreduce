...
#line 302
    memcpy((void */* __restrict  */)((void *)cfg___0->dict), (void const   */* __restrict  */)((void const   *)last),
...
#line 296
    sprintf((char */* __restrict  */)HTTPBasicAuthString, (char const   */* __restrict  */)((char const   *)PROXY_HEADER),
            HTTPAuthHash);
#line 297
...
#line 384
      SrcSockFD = accept(SockFD, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& cli_addr)),
                         (socklen_t */* __restrict  */)((socklen_t *)(& clien)));
      }
#line 386
      if (SrcSockFD < 0) {
        {
...
#line 523
    retval = select(nsock, (fd_set */* __restrict  */)(& in), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 560
    if (he) {
      {
#line 561
      memcpy((void */* __restrict  */)((void *)(& res)), (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + 0)),
             (size_t )he->h_length);
      }
    }
  }
...
{ 
  ...
  {
#line 634
  f = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"w");
  }
#line 634
  if ((unsigned long )f == (unsigned long )((void *)0)) {
    {
...
#line 945
  ...
  {
#line 946
  n = strtol((char const   */* __restrict  */)((char const   *)s), (char **/* __restrict  */)(& s),
             10);
  }
#line 946
  if (n != 200L) {
...
#line 1002
    if (isDaemon) {
      {
#line 1007
      vsnprintf((char */* __restrict  */)(buffer), (size_t )8192, (char const   */* __restrict  */)((char const   *)format),
                ap);
#line 1019
...
#line 1178
    tmp___5 = getpeername(fd, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& peer_addr)),
                          (socklen_t */* __restrict  */)((socklen_t *)(& peer_addr_len)));
    }
#line 1178
    if (tmp___5 == 0) {
      {
