...
#line 307
      fwrite((void const   */* __restrict  */)((void const   *)(& l)), (size_t )4,
...
#line 314
      fwrite((void const   */* __restrict  */)((void const   *)(& i)), (size_t )2,
             (size_t )1, (FILE */* __restrict  */)f);
#line 315
...
#line 335
    if (sect <= track->stopsect) {
      {
#line 335
      tmp___38 = fread((void */* __restrict  */)((void *)(buf)), (size_t )2352, (size_t )1,
                       (FILE */* __restrict  */)bf);
      }
#line 335
      if (! (tmp___38 > 0UL)) {
...
#line 346
    ...
    {
#line 350
    tmp___36 = fwrite((void const   */* __restrict  */)((void const   *)(& buf[track->bstart])),
                      (size_t )track->bsize, (size_t )1, (FILE */* __restrict  */)f);
    }
#line 350
    if (tmp___36 < 1UL) {
      {
...
#line 402
  binf = fopen((char const   */* __restrict  */)((char const   *)binfile), (char const   */* __restrict  */)"r");
  }
#line 402
  if (! binf) {
    {
...
#line 404
  ...
  {
#line 407
  cuef = fopen((char const   */* __restrict  */)((char const   *)cuefile), (char const   */* __restrict  */)"r");
  }
#line 407
  if (! cuef) {
    {
