...
#line 109
  snprintf((char */* __restrict  */)(printbuf), sizeof(printbuf), (char const   */* __restrict  */)"/proc/self/fd/%i",
           data->fd);
#line 110
  len = readlink((char const   */* __restrict  */)((char const   *)(printbuf)), (char */* __restrict  */)(pathname),
                 sizeof(pathname));
  }
#line 111
  if (len < 0L) {
...
#line 124
    strftime((char */* __restrict  */)(printbuf), sizeof(printbuf), (char const   */* __restrict  */)"%H:%M:%S",
             (struct tm  const  */* __restrict  */)((struct tm  const  *)tmp___2));
#line 125
...
#line 243
    ...
    {
#line 246
    option_timeout = strtol((char const   */* __restrict  */)((char const   *)optarg),
...
#line 251
    ...
    {
#line 254
    pid = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr),
                 10);
    }
#line 255
    if ((int )*endptr != 0) {
...
#line 371
  sa.sa_flags = 0;
#line 372
  tmp___4 = sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
...
#line 381
    sa.sa_flags = 0;
#line 382
    tmp___5 = sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
                        (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
    }
#line 382
    if (tmp___5 < 0) {
