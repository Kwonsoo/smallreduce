...
#line 319
  list_free(& sdl->list, (void (*/* const  */)(void * ))((void (*)(void * ))(& free)));
#line 320
  free((void *)sdl);
  }
#line 321
...
#line 1022
    ptr ++;
#line 1023
    sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%21lu",
           & count);
#line 1024
...
#line 1027
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)ptr), (char const   */* __restrict  */)"%10d %63s %127s (%127[^)])",
                     & pid, task, func, timer);
    }
#line 1027
    if (tmp___2 != 4) {
...
#line 1044
      snprintf((char */* __restrict  */)(tmp___4), sizeof(tmp___4), (char const   */* __restrict  */)"[%s]",
               task);
#line 1045
      strcpy((char */* __restrict  */)(task), (char const   */* __restrict  */)((char const   *)(tmp___4)));
      }
    }
    {
#line 1048
...
#line 1124
    ...
    {
#line 1126
    tmp___1 = strtoull((char const   */* __restrict  */)((char const   *)optarg),
...
#line 1226
    ret = select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                 (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv2));
    }
#line 1227
    if (ret < 0) {
      {
