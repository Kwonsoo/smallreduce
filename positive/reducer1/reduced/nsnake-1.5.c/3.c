...
#line 39 "/home/wheatley/newnew/temp/nsnake-1.5/src/hscores.h"
...
#line 87
  tmp___0 = getenv("HOME");
#line 87
  strncpy((char */* __restrict  */)(SCORE_DIR), (char const   */* __restrict  */)((char const   *)tmp___0),
          (size_t )254);
#line 88
  strncat((char */* __restrict  */)(SCORE_DIR), (char const   */* __restrict  */)"/.nsnake",
          (size_t )254);
#line 89
  strncpy((char */* __restrict  */)(SCORE_PATH), (char const   */* __restrict  */)((char const   *)(SCORE_DIR)),
          (size_t )254);
#line 90
...
{ 
  ...
  {
#line 102
  tmp = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& s));
#line 102
  err = tmp;
  }
#line 103
...
{ 
  ...
  {
#line 154
  tmp = fopen((char const   */* __restrict  */)((char const   *)path), (char const   */* __restrict  */)"wb");
#line 154
  file = tmp;
  }
#line 155
...
#line 204
  tmp = fopen((char const   */* __restrict  */)((char const   *)(SCORE_PATH)), (char const   */* __restrict  */)"wb");
#line 204
  file = tmp;
  }
#line 205
...
#line 206
  ...
  {
#line 208
  fwrite((void const   */* __restrict  */)((void const   *)(& HIGH_SCORE_BORDERS)),
         sizeof(int ), (size_t )1, (FILE */* __restrict  */)file);
#line 209
  fwrite((void const   */* __restrict  */)((void const   *)(& HIGH_SCORE_BORDERS_OFF)),
         sizeof(int ), (size_t )1, (FILE */* __restrict  */)file);
#line 210
  fclose(file);
  }
...
#line 231
  ...
  {
#line 234
  tmp___0 = fopen((char const   */* __restrict  */)((char const   *)(SCORE_PATH)),
...
#line 241
    ...
    {
#line 244
    file = fopen((char const   */* __restrict  */)((char const   *)(SCORE_PATH)),
                 (char const   */* __restrict  */)"rb");
    }
#line 245
    if (! file) {
...
#line 248
  ...
  {
#line 253
  tmp___1 = fread((void */* __restrict  */)((void *)(& HIGH_SCORE_BORDERS)), sizeof(int ),
...
#line 255
  ...
  {
#line 258
  tmp___2 = fread((void */* __restrict  */)((void *)(& HIGH_SCORE_BORDERS_OFF)), sizeof(int ),
                  (size_t )1, (FILE */* __restrict  */)file);
#line 258
...
#line 71 "/home/wheatley/newnew/temp/nsnake-1.5/src/nsnake.h"
...
#line 74 "/home/wheatley/newnew/temp/nsnake-1.5/src/player.h"
