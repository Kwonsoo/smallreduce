...
#line 35
  if (head->num >= 1000) {
    ...
    {
#line 36
    tmp___0 = alloc((unsigned int )sizeof(struct cdb_hplist ));
#line 36
...
#line 104
  ...
  {
#line 106
  tmp___2 = alloc((unsigned int )((unsigned long )memsize * sizeof(struct cdb_hp )));
#line 106
...
#line 39
    ...
    {
#line 40
    byte_copy(s->x + s->p, n, (char *)buf___0);
#line 40
    s->p += n;
#line 40
    buf___0 += n;
...
#line 41
  ...
  {
#line 44
  byte_copy(s->x + s->p, len, (char *)buf___0);
#line 45
  s->p += len;
  }
#line 46
...
#line 78
    ...
    {
#line 79
    tmp___1 = byte_diff(buf___0, (unsigned int )n, key);
    }
#line 79
    if (tmp___1) {
#line 79
...
#line 36
  if (s->n > 0U) {
    {
#line 36
    byte_copyr(s->x + s->n, (unsigned int )r, s->x);
    }
  }
#line 37
  return (r);
