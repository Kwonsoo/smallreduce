...
extern char *dcngettext(char const   *__domainname , char const   *__msgid1 , char const   *__msgid2 ,
                        unsigned long __n , int __category )  __attribute__((__format_arg__(2),
__format_arg__(3))) ;
...
#line 400
  ...
  {
#line 401
  memcpy((void */* __restrict  */)((void *)(b___0->b + b___0->length)), (void const   */* __restrict  */)((void const   *)p),
         n);
#line 402
  b___0->length += n;
  }
...
#line 224
      if (mbclen == 1) {
#line 226
        ch = (int )*(pstr->trans + (int const   )*(pstr->raw_mbs + (pstr->raw_mbs_idx + byte_idx)));
#line 227
...
#line 281
        ...
        {
#line 283
        memcpy((void */* __restrict  */)((void *)(pstr->mbs + byte_idx)), (void const   */* __restrict  */)((void const   *)((pstr->raw_mbs + pstr->raw_mbs_idx) + byte_idx)),
               (size_t )mbclen);
        }
      }
      {
...
#line 627
    ...
    {
#line 629
    memcpy((void */* __restrict  */)((void *)dest->elems), (void const   */* __restrict  */)((void const   *)src->elems),
...
#line 722
  if (i1 < (int )src1->nelem) {
    {
#line 724
    memcpy((void */* __restrict  */)((void *)(dest->elems + id)), (void const   */* __restrict  */)((void const   *)(src1->elems + i1)),
...
#line 728
  if (i2 < (int )src2->nelem) {
    {
#line 730
    memcpy((void */* __restrict  */)((void *)(dest->elems + id)), (void const   */* __restrict  */)((void const   *)(src2->elems + i2)),
...
#line 791
    memcpy((void */* __restrict  */)((void *)(dest->elems + di)), (void const   */* __restrict  */)((void const   *)(src->elems + cp_from)),
...
#line 799
  if (si < (int )src->nelem) {
    {
#line 801
    memcpy((void */* __restrict  */)((void *)(dest->elems + di)), (void const   */* __restrict  */)((void const   *)(src->elems + si)),
...
#line 848
    if (idx > 0) {
      {
#line 849
      memcpy((void */* __restrict  */)((void *)new_array), (void const   */* __restrict  */)((void const   *)set->elems),
...
#line 851
    if (set->nelem - idx > 0) {
      {
#line 852
      memcpy((void */* __restrict  */)((void *)((new_array + idx) + 1)), (void const   */* __restrict  */)((void const   *)(set->elems + idx)),
...
#line 509
      *((char *)tmp___2) = (char )'\000';
      ...
      {
#line 516
      memcpy((void */* __restrict  */)((void *)errbuf), (void const   */* __restrict  */)((void const   *)msg),
             msg_size);
      }
    }
  }
...
#line 3301
                              ch___10 = tmp___36;
#line 3301
                              airac_observe(sbcset, (unsigned long )ch___10 / (sizeof(unsigned int ) * 8UL));
#line 3301
...
#line 338
      ...
      {
#line 339
      memcpy((void */* __restrict  */)((void *)s), (void const   */* __restrict  */)((void const   *)string1),
             (size_t )length1);
#line 340
      memcpy((void */* __restrict  */)((void *)(s + length1)), (void const   */* __restrict  */)((void const   *)string2),
             (size_t )length2);
#line 341
      str = (char const   *)s;
#line 342
...
#line 1231
  memcpy((void */* __restrict  */)((void *)(fs->stack + num)->regs), (void const   */* __restrict  */)((void const   *)regs___0),
...
#line 1246
  memcpy((void */* __restrict  */)((void *)regs___0), (void const   */* __restrict  */)((void const   *)(fs->stack + num)->regs),
         (size_t )(sizeof(regmatch_t ) * (unsigned long )nregs));
#line 1247
...
#line 3261
    ...
    {
#line 3263
    bitset_merge(acceptable, (unsigned int */* const  */)(*(dests_ch + i)));
#line 3207
    i ++;
    }
  }
...
#line 3357
    if ((unsigned int )type == 21U) {
      {
#line 3359
      bitset_merge(accepts, (unsigned int */* const  */)node->opr.sbcset);
      }
    } else
#line 3361
    if ((unsigned int )type == 25U) {
...
#line 3429
      if (not_subset) {
        {
#line 3431
        memcpy((void */* __restrict  */)((void *)(*(dests_ch + ndests))), (void const   */* __restrict  */)((void const   *)(remains)),
               (size_t )(sizeof(unsigned int ) * (((256UL + sizeof(unsigned int ) * 8UL) - 1UL) / (sizeof(unsigned int ) * 8UL))));
#line 3432
        memcpy((void */* __restrict  */)((void *)(*(dests_ch + j))), (void const   */* __restrict  */)((void const   *)(intersec)),
               (size_t )(sizeof(unsigned int ) * (((256UL + sizeof(unsigned int ) * 8UL) - 1UL) / (sizeof(unsigned int ) * 8UL))));
#line 3433
...
#line 3449
    if (j == ndests) {
      {
#line 3451
      memcpy((void */* __restrict  */)((void *)(*(dests_ch + ndests))), (void const   */* __restrict  */)((void const   *)(accepts)),
             (size_t )(sizeof(unsigned int ) * (((256UL + sizeof(unsigned int ) * 8UL) - 1UL) / (sizeof(unsigned int ) * 8UL))));
#line 3452
...
#line 383
  tmp___1 = __ctype_b_loc();
#line 383
  w->punct = (flagT )(((int const   )*(*tmp___1 + (int )*finish) & 4) != 0);
  }
  {
#line 384
  while (1) {
...
#line 145
      tmp___6 = dcgettext((char const   *)((void *)0), "Invalid reference \\%d on `s\' command\'s RHS",
                          5);
#line 145
      sprintf((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)tmp___6),
              needed_sub);
#line 147
...
#line 223
  ...
  {
#line 224
  memcpy((void */* __restrict  */)((void *)(to->active + to->length)), (void const   */* __restrict  */)((void const   *)string),
         length);
#line 225
...
#line 314
  memcpy((void */* __restrict  */)((void *)to->active), (void const   */* __restrict  */)((void const   *)from->active),
         from->length);
  }
#line 315
  return;
...
{ 
  ...
  {
#line 338
  memcpy((void */* __restrict  */)((void *)(& t)), (void const   */* __restrict  */)((void const   *)a),
         (size_t )sizeof(struct line ));
#line 339
  memcpy((void */* __restrict  */)((void *)a), (void const   */* __restrict  */)((void const   *)b___0),
         (size_t )sizeof(struct line ));
#line 340
  memcpy((void */* __restrict  */)((void *)b___0), (void const   */* __restrict  */)((void const   *)(& t)),
         (size_t )sizeof(struct line ));
  }
#line 341
  return;
...
#line 484
    ...
    {
#line 488
    memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)old_asterisk),
...
#line 484
  ...
  {
#line 495
  strcpy((char */* __restrict  */)p, (char const   */* __restrict  */)((char const   *)old_asterisk));
  }
#line 496
  return (backup);
}
...
#line 674
  return ((enum __anonenum_flagT_27 )0);
}
}
#line 672
...
#line 1357
          ...
          {
#line 1360
          tmp___19 = mbrlen((char const   */* __restrict  */)((char const   *)(line.active + idx)),
...
#line 1408
              ...
              {
#line 1410
              strncpy((char */* __restrict  */)(line.active + prev_idx), (char const   */* __restrict  */)((char const   *)*(trans + (2 * i + 1))),
                      (size_t )trans_len);
              }
#line 1412
              goto while_break___2;
...
#line 667
  if (err_info) {
    {
#line 668
    memcpy((void */* __restrict  */)((void *)(& ret->err_info)), (void const   */* __restrict  */)((void const   *)err_info),
...
#line 1252
        ...
        {
#line 1254
        mbclen = mbrlen((char const   */* __restrict  */)((char const   *)(src_buf + i)),
                        (size_t )(len___0 - i), (mbstate_t */* __restrict  */)(& cur_stat));
        }
#line 1257
...
#line 1285
        strncpy((char */* __restrict  */)*(trans_pairs + 2 * i), (char const   */* __restrict  */)((char const   *)src_buf),
                *(src_lens + i));
#line 1286
...
#line 1287
        src_buf += *(src_lens + i);
#line 1290
        mbclen = mbrlen((char const   */* __restrict  */)((char const   *)(dest_buf + idx)),
                        (size_t )(len___0 - idx), (mbstate_t */* __restrict  */)(& cur_stat));
        }
#line 1293
        if (mbclen == 4294967295U) {
#line 1295
...
#line 1299
        strncpy((char */* __restrict  */)*(trans_pairs + (2 * i + 1)), (char const   */* __restrict  */)((char const   *)(dest_buf + idx)),
                mbclen);
#line 1300
...
#line 1324
        ustring ++;
#line 1324
        *(cur_cmd->x.translate + (int )*tmp___52) = (unsigned char )ch;
#line 1313
        len --;
      }
      while_break___12: /* CIL Label */ ;
...
#line 1536
  if (blocks) {
    {
#line 1539
    memcpy((void */* __restrict  */)((void *)(& cur_input)), (void const   */* __restrict  */)((void const   *)(& blocks->err_info)),
...
#line 192
  if (p) {
    {
#line 194
    tmp___1 = strtoul((char const   */* __restrict  */)p, (char **/* __restrict  */)((char **)((void *)0)),
                      0);
#line 194
    t = tmp___1;
    }
...
#line 223
        strcpy((char */* __restrict  */)(in_place_extension + 1), (char const   */* __restrict  */)((char const   *)optarg));
        }
      } else {
        {
#line 226
...
#line 227
    ...
    {
#line 230
    lcmd_out_line_len = strtoul((char const   */* __restrict  */)((char const   *)optarg),
...
#line 259
    fprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)((char const   *)tmp___7),
            "4.0.8");
#line 261
    tmp___8 = dcgettext((char const   *)((void *)0), "%s\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE,\nto the extent permitted by law.\n",
                        5);
#line 261
    fprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)((char const   *)tmp___8),
