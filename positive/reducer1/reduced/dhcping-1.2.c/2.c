...
{ 
  ...
  {
#line 49
  memcpy((void */* __restrict  */)((void *)(pktbuf + offset)), (void const   */* __restrict  */)((void const   *)msgbuf),
         (size_t )size);
#line 50
  offset += size;
  }
...
#line 144
    tmp___2 = select(dhcp_socket + 1, (fd_set */* __restrict  */)(& read___0), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
{ 
  ...
  {
#line 244
  sscanf((char const   */* __restrict  */)((char const   *)ipaddr), (char const   */* __restrict  */)"%d.%d.%d.%d",
         & ip[0], & ip[1], & ip[2], & ip[3]);
#line 245
  sscanf((char const   */* __restrict  */)((char const   *)gwaddr), (char const   */* __restrict  */)"%d.%d.%d.%d",
         & gw[0], & gw[1], & gw[2], & gw[3]);
  }
#line 246
  if (opt50) {
    {
#line 247
    sscanf((char const   */* __restrict  */)((char const   *)opt50), (char const   */* __restrict  */)"%d.%d.%d.%d",
...
#line 249
  hwcount = sscanf((char const   */* __restrict  */)((char const   *)hardware), (char const   */* __restrict  */)"%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x",
...
#line 256
  sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"\001\001%c%c",
          hwcount, 0);
#line 257
...
#line 263
  ...
  {
#line 264
  memcpy((void */* __restrict  */)((void *)(msgbuf)), (void const   */* __restrict  */)((void const   *)(& l)),
         (size_t )4);
#line 265
  addpacket((char *)(pktbuf), (char *)(msgbuf), 4);
#line 268
...
#line 275
  memset((void *)(msgbuf), 0, (size_t )4);
#line 276
  sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"%c%c%c%c",
          ip[0], ip[1], ip[2], ip[3]);
#line 277
  addpacket((char *)(pktbuf), (char *)(msgbuf), 4);
#line 280
...
#line 289
  addpacket((char *)(pktbuf), (char *)(msgbuf), 4);
#line 292
  sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",
...
#line 309
  addpacket((char *)(pktbuf), (char *)(msgbuf), 4);
#line 312
  sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"%c%c%c",
          53, 1, type);
#line 313
...
#line 318
    if (opt50) {
      {
#line 319
      sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"%c%c%c%c%c%c",
...
#line 340
  ...
  {
#line 344
  sprintf((char */* __restrict  */)((char *)(msgbuf)), (char const   */* __restrict  */)"%c",
          255);
#line 345
...
#line 363
  tmp = recvfrom(dhcp_socket, (void */* __restrict  */)((void *)(msgbuf)), (size_t )65536,
                 0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& fromsock)),
...
#line 460
    ...
    {
#line 462
    memcpy((void */* __restrict  */)((void *)(serveridentifier)), (void const   */* __restrict  */)((void const   *)((buffer + j) + 2)),
           (size_t )4);
#line 463
