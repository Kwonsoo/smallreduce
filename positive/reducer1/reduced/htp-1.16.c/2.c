...
#line 166
  ...
  {
#line 170
  imageFile->file = fopen((char const   */* __restrict  */)((char const   *)imageFile->name),
...
#line 25
  ...
  {
#line 29
  tmp___0 = fread((void */* __restrict  */)((void *)(header)), (size_t )1, (size_t )8,
...
#line 41
    ...
    {
#line 44
    tmp___2 = fread((void */* __restrict  */)((void *)(header)), (size_t )1, (size_t )4,
                    (FILE */* __restrict  */)file);
    }
#line 44
    if (tmp___2 != 4UL) {
...
#line 73
  ...
  {
#line 79
  tmp___0 = fread((void */* __restrict  */)((void *)(buff)), (size_t )1, (size_t )8,
                  (FILE */* __restrict  */)file);
  }
#line 79
  if (tmp___0 != 8UL) {
...
#line 38
  textFile->file = fopen((char const   */* __restrict  */)((char const   *)os_filename),
                         (char const   */* __restrict  */)openFlags);
#line 39
...
#line 259
  ...
  {
#line 263
  tmp___1 = memcpy((void */* __restrict  */)((void *)new), (void const   */* __restrict  */)((void const   *)src),
                   (size_t )size);
  }
#line 263
  return ((char *)tmp___1);
...
#line 282
  ...
  {
#line 286
  memcpy((void */* __restrict  */)((void *)new), (void const   */* __restrict  */)((void const   *)src),
         (size_t )len);
#line 287
  *(new + len) = (char)0;
  }
...
#line 125
        strftime((char */* __restrict  */)*newPlaintext, (size_t )128, (char const   */* __restrict  */)value,
                 (struct tm  const  */* __restrict  */)((struct tm  const  *)fileTime));
        }
      } else {
        {
#line 129
...
#line 141
        if ((unsigned long )attrib->value != (unsigned long )((void *)0)) {
          {
#line 143
          strftime((char */* __restrict  */)*newPlaintext, (size_t )128, (char const   */* __restrict  */)((char const   *)attrib->value),
                   (struct tm  const  */* __restrict  */)((struct tm  const  *)fileTime));
          }
        } else {
          {
...
#line 359
    strcpy((char */* __restrict  */)(defResp), (char const   */* __restrict  */)((char const   *)(newDirectory)));
#line 360
...
#line 407
  while (1) {
    ...
    {
#line 409
    numread = GetStreamBlock(& respfile, textline, (uint )sizeof(textline), nl_bitmap);
    }
#line 411
    if (numread == 0U) {
#line 414
...
#line 23
  ...
  {
#line 27
  tmp___0 = fread((void */* __restrict  */)((void *)(header)), (size_t )1, (size_t )6,
                  (FILE */* __restrict  */)file);
  }
#line 27
  if (tmp___0 != 6UL) {
...
#line 51
  ...
  {
#line 55
  tmp___0 = fread((void */* __restrict  */)((void *)(buff)), (size_t )1, (size_t )4,
                  (FILE */* __restrict  */)file);
  }
#line 55
  if (tmp___0 != 4UL) {
...
#line 140
      if (destAlloced) {
        {
#line 141
        memcpy((void */* __restrict  */)((void *)destText), (void const   */* __restrict  */)((void const   *)text),
               (size_t )len);
        }
      }
#line 143
...
#line 283
      ...
      {
#line 286
      memcpy((void */* __restrict  */)((void *)destText), (void const   */* __restrict  */)((void const   *)*newText),
             (size_t )copiedSoFar);
      }
#line 287
      if (destAlloced) {
...
#line 293
    ...
    {
#line 297
    memcpy((void */* __restrict  */)((void *)destText), (void const   */* __restrict  */)((void const   *)expansion),
...
#line 545
          ...
          {
#line 546
          ptr = stpcpy((char */* __restrict  */)ptr, (char const   */* __restrict  */)((char const   *)attrib->name));
#line 547
          tmp___9 = ptr;
#line 547
          ptr ++;
...
#line 551
          ...
          {
#line 552
          ptr = stpcpy((char */* __restrict  */)ptr, (char const   */* __restrict  */)((char const   *)attrib->value));
          }
#line 553
          if (attrib->quotes == 1) {
#line 554
...
#line 110
  ...
  {
#line 114
  tmp___1 = fread((void */* __restrict  */)((void *)(buff)), (size_t )1, (size_t )2,
                  (FILE */* __restrict  */)file);
  }
#line 114
  if (tmp___1 != 2UL) {
...
#line 144
  ...
  {
#line 150
  tmp___1 = fread((void */* __restrict  */)((void *)(signature)), (size_t )1, (size_t )5,
                  (FILE */* __restrict  */)file);
  }
#line 150
  if (tmp___1 != 5UL) {
...
#line 212
    ...
    {
#line 200
    tmp___0 = fread((void */* __restrict  */)((void *)(buff)), (size_t )1, (size_t )5,
                    (FILE */* __restrict  */)file);
    }
#line 200
    if (tmp___0 != 5UL) {
...
#line 458
  ...
  {
#line 462
  bufferPtr = stpcpy((char */* __restrict  */)buffer, (char const   */* __restrict  */)((char const   *)htmlMarkup->tag));
  }
#line 464
  if ((unsigned long )htmlMarkup->whitespace == (unsigned long )((void *)0)) {
#line 464
...
#line 469
    ...
    {
#line 472
    bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)htmlMarkup->whitespace));
    }
  }
#line 475
  htmlAttribute = htmlMarkup->attrib;
...
#line 491
    ...
    {
#line 494
    bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)htmlAttribute->name));
    }
#line 496
    if ((unsigned long )htmlAttribute->value != (unsigned long )((void *)0)) {
      {
#line 498
      bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)"=");
#line 499
      bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)quotes___0));
#line 500
      bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)htmlAttribute->value));
#line 501
      bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)quotes___0));
      }
    }
...
#line 509
      ...
      {
#line 512
      bufferPtr = stpcpy((char */* __restrict  */)bufferPtr, (char const   */* __restrict  */)((char const   *)htmlAttribute->whitespace));
      }
    }
#line 515
    htmlAttribute = htmlAttribute->next;
...
{ 
  ...
  {
#line 96
  memcpy((void */* __restrict  */)((void *)(localOptions)), (void const   */* __restrict  */)((void const   *)(globalOptions)),
...
#line 162
      strncat((char */* __restrict  */)(buff), (char const   */* __restrict  */)"=",
              sizeof(buff) - 1UL);
#line 163
      strncat((char */* __restrict  */)(buff), (char const   */* __restrict  */)((char const   *)attrib->value),
              sizeof(buff) - 1UL);
#line 164
      token = buff;
      }
...
#line 61
  str = (char *)tmp;
#line 62
  memcpy((void */* __restrict  */)((void *)str), (void const   */* __restrict  */)((void const   *)stream->u.buffer.buffer),
         stream->u.buffer.offset);
#line 63
  airac_observe(str, stream->u.buffer.offset);
#line 63
...
#line 260
    ...
    {
#line 262
    memcpy((void */* __restrict  */)((void *)(stream->u.buffer.buffer + stream->u.buffer.offset)),
           (void const   */* __restrict  */)((void const   *)str), len);
#line 263
...
#line 82
  ...
  {
#line 86
  tmp = stat((char const   */* __restrict  */)((char const   *)dependName), (struct stat */* __restrict  */)(& dependStat));
  }
#line 86
  if (tmp != 0) {
    {
...
#line 92
  ...
  {
#line 96
  tmp___0 = stat((char const   */* __restrict  */)((char const   *)targetName), (struct stat */* __restrict  */)(& targetStat));
  }
#line 96
  if (tmp___0 != 0) {
    {
...
#line 243
  while (1) {
    ...
    {
#line 245
    numread = GetStreamBlock(infile, markupBuffer, markupSize, open_markup);
    }
#line 247
    if (numread == 0U) {
#line 252
...
#line 280
  while (1) {
    ...
    {
#line 282
    numread = GetStreamBlock(infile, markupBuffer + ctr, markupSize - ctr, tag_specials);
    }
#line 284
    if (numread == 0U) {
      {
