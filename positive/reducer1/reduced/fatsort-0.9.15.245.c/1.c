...
#line 77
  ...
  {
#line 79
  strcpy((char */* __restrict  */)tmp->sname, (char const   */* __restrict  */)((char const   *)sname));
#line 80
...
#line 82
  ...
  {
#line 84
  strcpy((char */* __restrict  */)tmp->lname, (char const   */* __restrict  */)((char const   *)lname));
#line 86
...
#line 88
  ...
  {
#line 90
  memcpy((void */* __restrict  */)((void *)tmp->sde), (void const   */* __restrict  */)((void const   *)sde),
         (size_t )32);
#line 91
  tmp->ldel = ldel;
#line 92
...
#line 113
  ...
  {
#line 115
  memcpy((void */* __restrict  */)((void *)new->lde), (void const   */* __restrict  */)((void const   *)lde),
         (size_t )32);
#line 116
...
#line 146
    if (tmp___1 == 0) {
      {
#line 147
      strncpy((char */* __restrict  */)new, (char const   */* __restrict  */)((char const   *)(old + len)),
              (size_t )(len_old - len));
#line 148
...
#line 107
  fd = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
  }
#line 107
...
{ 
  ...
  {
#line 44
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& blocked_signals_set)),
...
{ 
  ...
  {
#line 51
  sigprocmask(1, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& blocked_signals_set)),
              (sigset_t */* __restrict  */)((sigset_t *)((void *)0)));
  }
#line 52
  return;
...
#line 67
  strncat((char */* __restrict  */)newStr, (char const   */* __restrict  */)((char const   *)str),
          (size_t )len);
#line 68
...
#line 165
    ...
    {
#line 167
    tmp = addDirPathToStringList(OPT_INCL_DIRS, optarg);
    }
#line 167
    if (tmp) {
      {
...
#line 171
    ...
    {
#line 173
    tmp___0 = addDirPathToStringList(OPT_INCL_DIRS_REC, optarg);
    }
#line 173
    if (tmp___0) {
      {
...
#line 177
    ...
    {
#line 179
    tmp___1 = addDirPathToStringList(OPT_EXCL_DIRS, optarg);
    }
#line 179
    if (tmp___1) {
      {
...
#line 183
    ...
    {
#line 185
    tmp___2 = addDirPathToStringList(OPT_EXCL_DIRS_REC, optarg);
    }
#line 185
    if (tmp___2) {
      {
...
#line 69
  ...
  {
#line 73
  tmp___1 = realpath((char const   */* __restrict  */)((char const   *)filename),
                     (char */* __restrict  */)(rp_filename));
  }
#line 73
  if ((unsigned long )tmp___1 == (unsigned long )((void *)0)) {
    {
...
#line 78
    ...
    {
#line 79
    tmp___3 = realpath((char const   */* __restrict  */)((char const   *)mnt->mnt_fsname),
                       (char */* __restrict  */)(rp_mnt_fsname));
    }
#line 79
...
#line 148
  *(str + 0) = (char )'\000';
#line 150
  memcpy((void */* __restrict  */)((void *)(utf16str)), (void const   */* __restrict  */)((void const   *)(& lde->LDIR_Ord + 1)),
         (size_t )10);
#line 151
  memcpy((void */* __restrict  */)((void *)(utf16str + 10)), (void const   */* __restrict  */)((void const   *)(& lde->LDIR_Ord + 14)),
         (size_t )12);
#line 152
  memcpy((void */* __restrict  */)((void *)(utf16str + 22)), (void const   */* __restrict  */)((void const   *)(& lde->LDIR_Ord + 28)),
         (size_t )4);
#line 153
...
#line 186
  ...
  {
#line 189
  strncpy((char */* __restrict  */)str, (char const   */* __restrict  */)((char const   *)(sde->DIR_Name)),
          (size_t )8);
#line 190
  *(str + 8) = (char )'\000';
#line 191
...
#line 195
    strncat((char */* __restrict  */)str, (char const   */* __restrict  */)((char const   *)(sde->DIR_Name + 8)),
            (size_t )3);
#line 196
    *(str + 12) = (char )'\000';
    }
...
#line 244
        ...
        {
#line 247
        strncpy((char */* __restrict  */)(dummy), (char const   */* __restrict  */)((char const   *)(tmp)),
                (size_t )512);
#line 248
        dummy[512] = (char )'\000';
#line 249
...
#line 249
        strncat((char */* __restrict  */)(dummy), (char const   */* __restrict  */)((char const   *)(lname)),
                512UL - tmp___1);
#line 250
        dummy[512] = (char )'\000';
#line 251
        strncpy((char */* __restrict  */)(lname), (char const   */* __restrict  */)((char const   *)(dummy)),
                (size_t )512);
#line 252
        dummy[512] = (char )'\000';
        }
...
#line 556
    ...
    {
#line 556
    fd = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)tmp___1);
    }
#line 556
    if ((unsigned long )fd == (unsigned long )((void *)0)) {
      {
...
#line 693
              strncpy((char */* __restrict  */)(newpath), (char const   */* __restrict  */)((char const   *)path),
                      512UL - tmp___8);
#line 694
...
#line 696
                  strncat((char */* __restrict  */)(newpath), (char const   */* __restrict  */)((char const   *)p->lname),
                          512UL - tmp___9);
#line 697
                  newpath[512] = (char )'\000';
#line 698
...
#line 701
                strncat((char */* __restrict  */)(newpath), (char const   */* __restrict  */)((char const   *)p->sname),
                        512UL - tmp___11);
#line 702
                newpath[512] = (char )'\000';
#line 703
...
#line 38
    __builtin_va_start(argptr, str);
#line 39
    vprintf((char const   */* __restrict  */)((char const   *)str), argptr);
#line 40
    __builtin_va_end(argptr);
    }
  }
...
#line 78
  ...
  {
#line 81
  strncpy((char */* __restrict  */)(stringList->next)->str, (char const   */* __restrict  */)((char const   *)str),
          (size_t )len);
#line 82
