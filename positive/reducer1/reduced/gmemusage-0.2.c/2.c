...
#line 138
    strcpy((char */* __restrict  */)(progname), (char const   */* __restrict  */)((char const   *)(tmp + 1)));
    }
  } else {
    {
#line 142
    strcpy((char */* __restrict  */)(progname), (char const   */* __restrict  */)((char const   *)*(argv + 0)));
    }
  }
  {
#line 148
...
#line 64
    if (! tmp___1) {
      {
#line 67
      sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*s %d %*d %d %*d %d",
...
#line 149
    sprintf((char */* __restrict  */)(buf), (char const   */* __restrict  */)"/proc/%s/status",
            procdir->d_name);
#line 150
    StatusFile = fopen((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"r");
    }
#line 150
...
#line 192
                  sscanf((char const   */* __restrict  */)((char const   *)(buf)),
                         (char const   */* __restrict  */)"%*s %d", & procExe);
                  }
                }
              } else {
                {
#line 187
                sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%*s %d",
                       & procStk);
                }
              }
            } else {
...
#line 40
    ...
    {
#line 42
    tmp = strcmp((char const   *)(pi___0->procname), (char const   *)name);
    }
#line 42
    if (! tmp) {
#line 44
...
#line 73
    thisproc = nextproc;
#line 74
    strcpy((char */* __restrict  */)(thisproc->procname), (char const   */* __restrict  */)procname);
#line 75
...
#line 189
  ...
  {
#line 191
  strncpy((char */* __restrict  */)(buffer), (char const   */* __restrict  */)((char const   *)string),
          sizeof(buffer));
#line 192
...
#line 203
  ...
  {
#line 205
  strncpy((char */* __restrict  */)s, (char const   */* __restrict  */)((char const   *)string),
          (size_t )len);
#line 206
  *(s + len) = (char )'\000';
#line 207
